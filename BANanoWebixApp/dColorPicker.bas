...
Sub BuildBag(Page As WixPage, Bag As WixProperty)
	...
	'
	Bag.Clear
	Bag.AddTextBox("id", "ID","colopicker1")
	...
	Bag.AddCombo("view","View", "colorpicker", Page.views)
	Bag.AddLabel("Details")
	Bag.AddTextBox("value", "Value","")
	Bag.AddCheckBox("stringResult","StringResult", "")
	...
	'
	Bag.AddLabel("Label")
	Bag.AddTextBox("label","Text","Color Picker 1")
