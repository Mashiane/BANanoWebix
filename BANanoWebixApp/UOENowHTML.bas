...
'add drawer menu
Sub AddDrawerMenu(menuID As String, drawerID As String)
	Dim dm As UOENowHTML = BANanoMiniCSSCode.CreateDrawerMenu(menuID, drawerID)
	AddElement(dm)
End Sub

'add the drawer
Sub AddDrawer(drw As MiniCSSDrawer)
	AddElement(drw.Drawer)
	AddElement(drw.Nav)
End Sub
