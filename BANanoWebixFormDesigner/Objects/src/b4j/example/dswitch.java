...
public class dswitch extends Object{
public static dswitch mostCurrent = new dswitch();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dswitch", null);
		ba.loadHtSubs(dswitch.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dswitch", ba);
		}
	}
    public static Class<?> getObject() {
		return dswitch.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"switch1\")";
_bag._addtextbox /*String*/ ("id","ID","switch1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"switch1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","switch1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"switch\", Page.views)";
_bag._addcombo /*String*/ ("view","View","switch",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 23;BA.debugLine="Bag.AddLabel(\"Details\")";
_bag._addlabel /*String*/ ("Details");
 //BA.debugLineNum = 24;BA.debugLine="Bag.AddTextBox(\"value\", \"Value\",\"1\")";
_bag._addtextbox /*String*/ ("value","Value","1");
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Switch\")";
_bag._addtextbox /*String*/ ("label","Text","Switch");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddTextBox(\"labelRight\",\"Right Text\",\"\")";
_bag._addtextbox /*String*/ ("labelRight","Right Text","");
...
_bag._addcombo /*String*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddLabel(\"Options\")";
_bag._addlabel /*String*/ ("Options");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"onLabel\",\"On Label\", \"On\")";
_bag._addtextbox /*String*/ ("onLabel","On Label","On");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddTextBox(\"offLabel\",\"Off Label\", \"Off\")";
...
_bag._addlabel /*String*/ ("Size");
 //BA.debugLineNum = 41;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"200\")";
