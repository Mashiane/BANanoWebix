...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","switch1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","switch",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("value","Value","1");
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","Switch");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddTextBox(\"labelRight\",\"Right Text\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelRight","Right Text","");
