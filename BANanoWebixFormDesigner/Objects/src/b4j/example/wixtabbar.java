...
anywheresoftware.b4a.objects.collections.Map _opt = null;
 //BA.debugLineNum = 65;BA.debugLine="Sub AddItem(iID As String, iText As String, iIcon";
 //BA.debugLineNum = 66;BA.debugLine="iID = iID.tolowercase";
_iid = _iid.toLowerCase();
 //BA.debugLineNum = 68;BA.debugLine="Dim icon As UOENowHTML";
_icon = new b4j.example.uoenowhtml();
 //BA.debugLineNum = 69;BA.debugLine="icon.Initialize(\"\",\"span\")";
_icon._initialize /*b4j.example.uoenowhtml*/ (ba,"","span");
 //BA.debugLineNum = 70;BA.debugLine="icon.AddClass(\"webix_icon\")";
_icon._addclass /*b4j.example.uoenowhtml*/ ("webix_icon");
 //BA.debugLineNum = 71;BA.debugLine="icon.AddClass(iIcon)";
_icon._addclass /*b4j.example.uoenowhtml*/ (_iicon);
 //BA.debugLineNum = 73;BA.debugLine="Dim text As UOENowHTML";
_text = new b4j.example.uoenowhtml();
 //BA.debugLineNum = 74;BA.debugLine="text.Initialize(\"\",\"span\")";
_text._initialize /*b4j.example.uoenowhtml*/ (ba,"","span");
 //BA.debugLineNum = 75;BA.debugLine="text.SetStyle(\"padding-left\", \"4px\")";
_text._setstyle /*b4j.example.uoenowhtml*/ ("padding-left","4px");
 //BA.debugLineNum = 76;BA.debugLine="text.AddContent(iText)";
...
_sb.Initialize();
 //BA.debugLineNum = 80;BA.debugLine="sb.Append(icon.HTML)";
_sb.Append(_icon._html /*String*/ ());
 //BA.debugLineNum = 81;BA.debugLine="sb.Append(text.HTML)";
_sb.Append(_text._html /*String*/ ());
 //BA.debugLineNum = 83;BA.debugLine="Dim opt As Map = CreateMap()";
_opt = new anywheresoftware.b4a.objects.collections.Map();
_opt = __c.createMap(new Object[] {});
 //BA.debugLineNum = 84;BA.debugLine="opt.Put(\"id\", iID)";
_opt.Put((Object)("id"),(Object)(_iid));
 //BA.debugLineNum = 85;BA.debugLine="opt.Put(\"value\", sb.ToString)";
_opt.Put((Object)("value"),(Object)(_sb.ToString()));
 //BA.debugLineNum = 86;BA.debugLine="options.Add(opt)";
_options.Add((Object)(_opt.getObject()));
 //BA.debugLineNum = 87;BA.debugLine="End Sub";
return "";
}
public String  _addtocolumns(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Sub AddToColumns(P As WixElement)";
 //BA.debugLineNum = 159;BA.debugLine="P.AddColumns(Item)";
_p._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 160;BA.debugLine="End Sub";
return "";
}
public String  _addtoelements(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Sub AddToElements(P As WixElement)";
 //BA.debugLineNum = 164;BA.debugLine="P.AddElements(Item)";
_p._addelements /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 165;BA.debugLine="End Sub";
return "";
}
public String  _addtorows(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 153;BA.debugLine="Sub AddToRows(P As WixElement)";
 //BA.debugLineNum = 154;BA.debugLine="P.AddRows(Item)";
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 ...
 //BA.debugLineNum = 118;BA.debugLine="TabBar.SetAttr(\"options\", options)";
_tabbar._setattr /*b4j.example.wixelement*/ ("options",(Object)(_options.getObject()));
 //BA.debugLineNum = 119;BA.debugLine="Return TabBar.item";
...
public b4j.example.wixtabbar  _setanimate(boolean _b) throws Exception{
 //BA.debugLineNum = 135;BA.debugLine="Sub SetAnimate(b As Boolean) As WixTabBar";
 //BA.debugLineNum = 136;BA.debugLine="TabBar.SetAttr(\"animate\", b)";
...
public b4j.example.wixtabbar  _setfitbiggest(boolean _b) throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Sub SetFitBiggest(b As Boolean) As WixTabBar";
 //BA.debugLineNum = 130;BA.debugLine="TabBar.SetAttr(\"fitBiggest\", b)";
...
public b4j.example.wixtabbar  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 98;BA.debugLine="Sub SetHeight(h As Object) As WixTabBar";
 //BA.debugLineNum = 99;BA.debugLine="TabBar.SetAttr(\"height\", h)";
...
public b4j.example.wixtabbar  _setkeepviews(boolean _b) throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Sub SetkeepViews(b As Boolean) As WixTabBar";
 //BA.debugLineNum = 142;BA.debugLine="TabBar.SetAttr(\"keepViews\", b)";
...
public b4j.example.wixtabbar  _setminheight(int _h) throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Sub SetMinHeight(h As Int) As WixTabBar";
 //BA.debugLineNum = 60;BA.debugLine="TabBar.SetMinHeight(h)";
...
public b4j.example.wixtabbar  _setminwidth(int _w) throws Exception{
 //BA.debugLineNum = 53;BA.debugLine="Sub SetMinWidth(w As Int) As WixTabBar";
 //BA.debugLineNum = 54;BA.debugLine="TabBar.SetMinWidth(w)";
...
public b4j.example.wixtabbar  _setmultiview(boolean _b) throws Exception{
 //BA.debugLineNum = 123;BA.debugLine="Sub SetMultiView(b As Boolean) As WixTabBar";
 //BA.debugLineNum = 124;BA.debugLine="TabBar.SetAttr(\"multiview\", b)";
...
public b4j.example.wixtabbar  _setname(String _n) throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub SetName(n As String) As WixTabBar";
 //BA.debugLineNum = 35;BA.debugLine="TabBar.SetName(n)";
...
public b4j.example.wixtabbar  _setresponsive(Object _b) throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Sub SetResponsive(b As Object) As WixTabBar";
 //BA.debugLineNum = 41;BA.debugLine="TabBar.SetResponsive(b)";
...
public b4j.example.wixtabbar  _setresponsivecell(Object _b) throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Sub SetResponsiveCell(b As Object) As WixTabBar";
 //BA.debugLineNum = 47;BA.debugLine="TabBar.SetResponsiveCell(b)";
...
String _os = "";
 //BA.debugLineNum = 27;BA.debugLine="Sub SetTemplateHTML(h As UOENowHTML) As WixTabBar";
 //BA.debugLineNum = 28;BA.debugLine="Dim os As String = h.HTML";
_os = _h._html /*String*/ ();
 //BA.debugLineNum = 29;BA.debugLine="TabBar.SetTemplate(os)";
...
public b4j.example.wixtabbar  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 91;BA.debugLine="Sub SetTooltip(tt As String) As WixTabBar";
 //BA.debugLineNum = 92;BA.debugLine="TabBar.SetTooltip(tt)";
...
public b4j.example.wixtabbar  _settypebottom(boolean _b) throws Exception{
 //BA.debugLineNum = 111;BA.debugLine="Sub SetTypeBottom(b As Boolean) As WixTabBar   'ig";
 //BA.debugLineNum = 112;BA.debugLine="TabBar.SetType(\"bottom\")";
...
public b4j.example.wixtabbar  _setvalue(Object _v) throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Sub SetValue(v As Object) As WixTabBar";
 //BA.debugLineNum = 148;BA.debugLine="TabBar.SetAttr(\"value\", v)";
...
public b4j.example.wixtabbar  _setwidth(Object _w) throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub SetWidth(w As Object) As WixTabBar";
 //BA.debugLineNum = 105;BA.debugLine="TabBar.SetAttr(\"width\", w)";
