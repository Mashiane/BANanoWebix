...
_banano.Header.AddJavascriptFile("hint.js");
 //BA.debugLineNum = 37;BA.debugLine="BANano.TranspilerOptions.UseServiceWorker = False";
_banano.TranspilerOptions.setUseServiceWorker(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 40;BA.debugLine="BANano.PHP_NAME = \"bananowebixfd.php\"";
_banano.PHP_NAME = "bananowebixfd.php";
 //BA.debugLineNum = 41;BA.debugLine="BANano.PHPHost = $\"http://localhost/${AppName}/\"$";
...
_banano.Build(_publish);
 //BA.debugLineNum = 46;BA.debugLine="BP.Initialize";
_bp._initialize(ba);
 //BA.debugLineNum = 47;BA.debugLine="BP.PublishPath = Publish";
_bp._publishpath = _publish;
 //BA.debugLineNum = 48;BA.debugLine="BP.ShortName = AppName";
_bp._shortname = _appname;
 //BA.debugLineNum = 49;BA.debugLine="BP.AssetsPath = BANano.ASSETS_FOLDER";
_bp._assetspath = _banano.ASSETS_FOLDER;
 //BA.debugLineNum = 50;BA.debugLine="BP.ScriptsPath = BANano.SCRIPTS_FOLDER";
_bp._scriptspath = _banano.SCRIPTS_FOLDER;
 //BA.debugLineNum = 51;BA.debugLine="BP.StylesPath = BANano.STYLES_FOLDER";
_bp._stylespath = _banano.STYLES_FOLDER;
 //BA.debugLineNum = 52;BA.debugLine="BP.ScriptFile = BANano.JAVASCRIPT_NAME";
_bp._scriptfile = _banano.JAVASCRIPT_NAME;
 //BA.debugLineNum = 53;BA.debugLine="BP.UnzipFonts";
_bp._unzipfonts();
 //BA.debugLineNum = 54;BA.debugLine="BP.UnzipFile(\"extras.zip\")";
_bp._unzipfile("extras.zip");
 //BA.debugLineNum = 55;BA.debugLine="BP.Open(True)";
...
anywheresoftware.b4a.objects.collections.Map _els = null;
 //BA.debugLineNum = 64;BA.debugLine="Sub BANano_Ready()";
 //BA.debugLineNum = 65;BA.debugLine="Dim sqlite As BANanoSQLite";
_sqlite = new b4j.example.bananosqlite();
 //BA.debugLineNum = 66;BA.debugLine="sqlite.Initialize";
_sqlite._initialize /*b4j.example.bananosqlite*/ (ba);
 //BA.debugLineNum = 67;BA.debugLine="dbName = $\"${AppName}.db\"$";
_dbname = (""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_appname))+".db");
 //BA.debugLineNum = 69;BA.debugLine="Dim tbl As Map = CreateMap()";
_tbl = new anywheresoftware.b4a.objects.collections.Map();
_tbl = anywheresoftware.b4a.keywords.Common.createMap(new Object[] {});
 //BA.debugLineNum = 70;BA.debugLine="tbl.Put(\"id\", sqlite.DB_STRING)";
_tbl.Put((Object)("id"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 71;BA.debugLine="tbl.Put(\"json\", sqlite.DB_STRING)";
_tbl.Put((Object)("json"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 72;BA.debugLine="tbl.put(\"parentid\", sqlite.DB_STRING)";
_tbl.Put((Object)("parentid"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 73;BA.debugLine="Dim qry As String = sqlite.CreateTable(\"forms\", t";
_qry = _sqlite._createtable /*String*/ ("forms",_tbl,"id");
 //BA.debugLineNum = 74;BA.debugLine="Dim res As String = BANano.CallInlinePHPWait(\"BAN";
_res = BA.ObjectToString(_banano.CallInlinePHPWait("BANanoSQLite",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("dbname"),(Object)(_dbname),(Object)("data"),(Object)(_qry)})));
 //BA.debugLineNum = 75;BA.debugLine="Dim rs As SQLiteResultSet = sqlite.GetResultSet(q";
_rs = _sqlite._getresultset /*b4j.example.bananosqlite._sqliteresultset*/ (_qry,_res);
 //BA.debugLineNum = 77;BA.debugLine="sqlite.Initialize";
_sqlite._initialize /*b4j.example.bananosqlite*/ (ba);
 //BA.debugLineNum = 78;BA.debugLine="Dim c As Map = CreateMap()";
_c = new anywheresoftware.b4a.objects.collections.Map();
_c = anywheresoftware.b4a.keywords.Common.createMap(new Object[] {});
 //BA.debugLineNum = 79;BA.debugLine="c.Put(\"id\", sqlite.DB_STRING)";
_c.Put((Object)("id"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 80;BA.debugLine="c.Put(\"json\", sqlite.DB_STRING)";
_c.Put((Object)("json"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 81;BA.debugLine="Dim qry As String = sqlite.CreateTable(\"connect\",";
...
_c = new anywheresoftware.b4a.objects.collections.Map();
_c = anywheresoftware.b4a.keywords.Common.createMap(new Object[] {});
 //BA.debugLineNum = 87;BA.debugLine="c.Put(\"key\", sqlite.DB_STRING)";
_c.Put((Object)("key"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 88;BA.debugLine="c.Put(\"id\", sqlite.DB_STRING)";
_c.Put((Object)("id"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 89;BA.debugLine="c.Put(\"value\", sqlite.DB_STRING)";
_c.Put((Object)("value"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 90;BA.debugLine="c.Put(\"json\", sqlite.DB_STRING)";
_c.Put((Object)("json"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 91;BA.debugLine="Dim qry As String = sqlite.CreateTable(\"tables\",";
_qry = _sqlite._createtable /*String*/ ("tables",_c,"key");
 //BA.debugLineNum = 92;BA.debugLine="Dim res As String = BANano.CallInlinePHPWait(\"BAN";
_res = BA.ObjectToString(_banano.CallInlinePHPWait("BANanoSQLite",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("dbname"),(Object)(_dbname),(Object)("data"),(Object)(_qry)})));
 //BA.debugLineNum = 93;BA.debugLine="Dim rs As SQLiteResultSet = sqlite.GetResultSet(q";
_rs = _sqlite._getresultset /*b4j.example.bananosqlite._sqliteresultset*/ (_qry,_res);
 //BA.debugLineNum = 96;BA.debugLine="sqlite.Initialize";
_sqlite._initialize /*b4j.example.bananosqlite*/ (ba);
 //BA.debugLineNum = 97;BA.debugLine="Dim f As Map = CreateMap()";
_f = new anywheresoftware.b4a.objects.collections.Map();
_f = anywheresoftware.b4a.keywords.Common.createMap(new Object[] {});
 //BA.debugLineNum = 98;BA.debugLine="f.Put(\"key\", sqlite.DB_STRING)";
_f.Put((Object)("key"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 99;BA.debugLine="f.Put(\"id\", sqlite.DB_STRING)";
_f.Put((Object)("id"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 100;BA.debugLine="f.Put(\"tablename\", sqlite.DB_STRING)";
_f.Put((Object)("tablename"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 101;BA.debugLine="f.Put(\"value\", sqlite.DB_STRING)";
_f.Put((Object)("value"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 102;BA.debugLine="f.Put(\"json\", sqlite.DB_STRING)";
_f.Put((Object)("json"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 103;BA.debugLine="Dim qry As String = sqlite.CreateTable(\"fields\",";
_qry = _sqlite._createtable /*String*/ ("fields",_f,"key");
 //BA.debugLineNum = 104;BA.debugLine="Dim res As String = BANano.CallInlinePHPWait(\"BAN";
_res = BA.ObjectToString(_banano.CallInlinePHPWait("BANanoSQLite",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("dbname"),(Object)(_dbname),(Object)("data"),(Object)(_qry)})));
 //BA.debugLineNum = 105;BA.debugLine="Dim rs As SQLiteResultSet = sqlite.GetResultSet(q";
_rs = _sqlite._getresultset /*b4j.example.bananosqlite._sqliteresultset*/ (_qry,_res);
 //BA.debugLineNum = 108;BA.debugLine="sqlite.Initialize";
_sqlite._initialize /*b4j.example.bananosqlite*/ (ba);
 //BA.debugLineNum = 109;BA.debugLine="Dim els As Map = CreateMap()";
_els = new anywheresoftware.b4a.objects.collections.Map();
_els = anywheresoftware.b4a.keywords.Common.createMap(new Object[] {});
 //BA.debugLineNum = 110;BA.debugLine="els.Put(\"id\", sqlite.DB_STRING)";
_els.Put((Object)("id"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 111;BA.debugLine="els.Put(\"json\", sqlite.DB_STRING)";
_els.Put((Object)("json"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 112;BA.debugLine="els.Put(\"tabindex\", sqlite.DB_STRING)";
_els.Put((Object)("tabindex"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 113;BA.debugLine="els.put(\"parentid\", sqlite.DB_STRING)";
_els.Put((Object)("parentid"),(Object)(_sqlite._db_string /*String*/ ));
 //BA.debugLineNum = 114;BA.debugLine="Dim qry As String = sqlite.CreateTable(\"items\", e";
_qry = _sqlite._createtable /*String*/ ("items",_els,"id");
 //BA.debugLineNum = 115;BA.debugLine="Dim res As String = BANano.CallInlinePHPWait(\"BAN";
_res = BA.ObjectToString(_banano.CallInlinePHPWait("BANanoSQLite",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("dbname"),(Object)(_dbname),(Object)("data"),(Object)(_qry)})));
 //BA.debugLineNum = 116;BA.debugLine="Dim rs As SQLiteResultSet = sqlite.GetResultSet(q";
_rs = _sqlite._getresultset /*b4j.example.bananosqlite._sqliteresultset*/ (_qry,_res);
 //BA.debugLineNum = 117;BA.debugLine="pgFormDesigner.init";
...
_banano = new com.ab.banano.BANano();
 //BA.debugLineNum = 6;BA.debugLine="Public AppName As String = \"BANanoWebixFormDesign";
_appname = "BANanoWebixFormDesigner";
