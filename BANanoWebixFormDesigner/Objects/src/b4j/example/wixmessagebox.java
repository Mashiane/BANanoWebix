...
public b4j.example.wixmessagebox  _addbutton(String _btntext) throws Exception{
 //BA.debugLineNum = 116;BA.debugLine="Sub AddButton(btnText As String) As WixMessageBox";
 //BA.debugLineNum = 117;BA.debugLine="buttons.Add(btnText)";
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 ...
 //BA.debugLineNum = 88;BA.debugLine="If buttons.Size > 0 Then";
if (_buttons.getSize()>0) { 
 //BA.debugLineNum = 89;BA.debugLine="MessageBox.SetAttr(\"buttons\", buttons)";
_messagebox._setattr /*b4j.example.wixelement*/ ("buttons",(Object)(_buttons.getObject()));
 };
 //BA.debugLineNum = 91;BA.debugLine="Return MessageBox.item";
...
public b4j.example.wixmessagebox  _setcssjson(String _json) throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub SetCSSJSON(json As String) As WixMessageBox";
 //BA.debugLineNum = 82;BA.debugLine="MessageBox.SetCSSJSON(json)";
_messagebox._setcssjson /*b4j.example.wixelement*/ (_json);
...
public b4j.example.wixmessagebox  _settypealerterror(boolean _b) throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub SetTypeAlertError(b As Boolean) As WixMessageB";
 //BA.debugLineNum = 105;BA.debugLine="MessageBox.SetType(\"alert-error\")";
...
public b4j.example.wixmessagebox  _settypealertwarning(boolean _b) throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Sub SetTypeAlertWarning(b As Boolean) As WixMessag";
 //BA.debugLineNum = 111;BA.debugLine="MessageBox.SetType(\"alert-warning\")";
...
public b4j.example.wixmessagebox  _settypeconfirmerror(boolean _b) throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub SetTypeConfirmError(b As Boolean) As WixMessag";
 //BA.debugLineNum = 100;BA.debugLine="MessageBox.SetType(\"confirm-error\")";
...
public b4j.example.wixmessagebox  _settypeconfirmwarning(boolean _b) throws Exception{
 //BA.debugLineNum = 94;BA.debugLine="Sub SetTypeConfirmWarning(b As Boolean) As WixMess";
 //BA.debugLineNum = 95;BA.debugLine="MessageBox.SetType(\"confirm-warning\")";
