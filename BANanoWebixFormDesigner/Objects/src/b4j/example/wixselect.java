...
public String  _addtocolumns(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Sub AddToColumns(P As WixElement)";
 //BA.debugLineNum = 162;BA.debugLine="P.AddColumns(Item)";
_p._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 163;BA.debugLine="End Sub";
return "";
}
public String  _addtoelements(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub AddToElements(P As WixElement)";
 //BA.debugLineNum = 167;BA.debugLine="P.AddElements(Item)";
...
public String  _addtorows(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Sub AddToRows(P As WixElement)";
 //BA.debugLineNum = 157;BA.debugLine="P.AddRows(Item)";
...
public b4j.example.wixselect  _setaligncenter(String _r) throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub SetAlignCenter(r As String) As WixSelect 'igno";
 //BA.debugLineNum = 144;BA.debugLine="DropDown.setAligncenter(\"\")";
...
public b4j.example.wixselect  _setalignleft(String _r) throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Sub SetAlignLeft(r As String) As WixSelect 'ignore";
 //BA.debugLineNum = 150;BA.debugLine="DropDown.SetAlignleft(\"\")";
...
public b4j.example.wixselect  _setalignright(String _r) throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Sub SetAlignRight(r As String) As WixSelect 'ignor";
 //BA.debugLineNum = 138;BA.debugLine="DropDown.setAlignright(\"\")";
...
public b4j.example.wixselect  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 107;BA.debugLine="Sub SetLabel(l As String) As WixSelect";
 //BA.debugLineNum = 108;BA.debugLine="DropDown.SetLabel(l)";
...
public b4j.example.wixselect  _setlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 119;BA.debugLine="Sub SetLabelAlign(a As String) As WixSelect";
 //BA.debugLineNum = 120;BA.debugLine="DropDown.SetLabelAlign(a)";
...
public b4j.example.wixselect  _setlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Sub SetLabelPosition(p As String) As WixSelect";
 //BA.debugLineNum = 126;BA.debugLine="DropDown.SetLabelPosition(p)";
...
public b4j.example.wixselect  _setlabelwidth(int _w) throws Exception{
 //BA.debugLineNum = 131;BA.debugLine="Sub SetLabelWidth(w As Int) As WixSelect";
 //BA.debugLineNum = 132;BA.debugLine="DropDown.SetLabelWidth(w)";
...
public b4j.example.wixselect  _setrequired(boolean _b) throws Exception{
 //BA.debugLineNum = 113;BA.debugLine="Sub SetRequired(b As Boolean) As WixSelect";
 //BA.debugLineNum = 114;BA.debugLine="DropDown.SetRequired(b)";
...
public b4j.example.wixselect  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 101;BA.debugLine="Sub SetValue(v As String) As WixSelect";
 //BA.debugLineNum = 102;BA.debugLine="DropDown.SetValue(v)";
