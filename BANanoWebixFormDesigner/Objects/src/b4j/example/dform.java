...
_bag._addtextbox /*String*/ ("id","ID","form");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"form\")";
_bag._addtextbox /*String*/ ("localId","Local ID","form");
 //BA.debugLineNum = 17;BA.debugLine="Bag.AddLabel(\"Parent\")";
_bag._addlabel /*String*/ ("Parent");
 //BA.debugLineNum = 18;BA.debugLine="Bag.AddTextBox(\"parentid\",\"Parent\", \"pg\")";
_bag._addtextbox /*String*/ ("parentid","Parent","pg");
...
_bag._addcombo /*String*/ ("addingmethod","Adding Method","AddRows",_pgformdesigner._addingmethod /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 20;BA.debugLine="Bag.AddLabel(\"View\")";
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 21;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"form\", Page.views)";
_bag._addcombo /*String*/ ("view","View","form",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddTextBox(\"name\",\"Name\", \"form\")";
_bag._addtextbox /*String*/ ("name","Name","form");
 //BA.debugLineNum = 23;BA.debugLine="Bag.AddCheckBox(\"complexData\", \"Complex Data\", Fa";
_bag._addcheckbox /*String*/ ("complexData","Complex Data",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False));
 //BA.debugLineNum = 24;BA.debugLine="Bag.AddLabel(\"Defaults\")";
_bag._addlabel /*String*/ ("Defaults");
 //BA.debugLineNum = 25;BA.debugLine="Bag.AddCombo(\"DefaultView\",\"View\",\"\", Page.views)";
_bag._addcombo /*String*/ ("DefaultView","View","",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddTextBox(\"DefaultType\",\"Type\",\"\")";
_bag._addtextbox /*String*/ ("DefaultType","Type","");
 //BA.debugLineNum = 27;BA.debugLine="Bag.AddCombo(\"DefaultLabelAlign\", \"Label Align\",";
_bag._addcombo /*String*/ ("DefaultLabelAlign","Label Align","",_align);
 //BA.debugLineNum = 28;BA.debugLine="Bag.AddTextBox(\"DefaultLabelWidth\", \"Label Width\"";
_bag._addtextbox /*String*/ ("DefaultLabelWidth","Label Width","");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddCombo(\"DefaultLabelPosition\", \"Label Posit";
_bag._addcombo /*String*/ ("DefaultLabelPosition","Label Position","",_pos);
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddCombo(\"DefaultAlign\", \"Align\", \"\",align)";
_bag._addcombo /*String*/ ("DefaultAlign","Align","",_align);
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddTextBox(\"DefaultWidth\",\"Width\",\"\")";
_bag._addtextbox /*String*/ ("DefaultWidth","Width","");
 //BA.debugLineNum = 32;BA.debugLine="Bag.AddTextBox(\"DefaultHeight\",\"Height\",\"\")";
_bag._addtextbox /*String*/ ("DefaultHeight","Height","");
 //BA.debugLineNum = 33;BA.debugLine="Bag.AddTextBox(\"DefaultBottomPadding\",\"Bottom Pad";
_bag._addtextbox /*String*/ ("DefaultBottomPadding","Bottom Padding","");
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddLabel(\"Details\")";
_bag._addlabel /*String*/ ("Details");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddCheckBox(\"scroll\",\"Scroll\",\"\")";
_bag._addcheckbox /*String*/ ("scroll","Scroll","");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddCheckBox(\"scrollX\", \"Scroll X\", \"\")";
_bag._addcheckbox /*String*/ ("scrollX","Scroll X","");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddCheckBox(\"scrollY\", \"Scroll Y\",\"\")";
_bag._addcheckbox /*String*/ ("scrollY","Scroll Y","");
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*String*/ ("Size");
 //BA.debugLineNum = 40;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"\")";
_bag._addtextbox /*String*/ ("width","Width","");
 //BA.debugLineNum = 41;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
_bag._addtextbox /*String*/ ("height","Height","");
 //BA.debugLineNum = 42;BA.debugLine="Bag.AddLabel(\"Style\")";
_bag._addlabel /*String*/ ("Style");
 //BA.debugLineNum = 43;BA.debugLine="Bag.AddTextBox(\"padding\",\"Padding\",\"\")";
_bag._addtextbox /*String*/ ("padding","Padding","");
 //BA.debugLineNum = 44;BA.debugLine="Bag.AddTextBox(\"margin\",\"Margin\",\"\")";
_bag._addtextbox /*String*/ ("margin","Margin","");
 //BA.debugLineNum = 45;BA.debugLine="Bag.Refresh(Page)";
