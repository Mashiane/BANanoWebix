...
b4j.example.wixelement _pel = null;
b4j.example.wixelement _cel = null;
 //BA.debugLineNum = 6;BA.debugLine="Sub getCenter As WixRow";
 //BA.debugLineNum = 7;BA.debugLine="Dim formHolder As WixRow";
_formholder = new b4j.example.wixrow();
 //BA.debugLineNum = 8;BA.debugLine="formHolder.Initialize(\"formholder\")";
...
_acc = new b4j.example.wixaccordion();
 //BA.debugLineNum = 11;BA.debugLine="acc.Initialize(\"va\").SetTypeLine(True).SetMulti(T";
_acc._initialize /*b4j.example.wixaccordion*/ (ba,"va")._settypeline /*b4j.example.wixaccordion*/ (anywheresoftware.b4a.keywords.Common.True)._setmulti /*b4j.example.wixaccordion*/ ((Object)(anywheresoftware.b4a.keywords.Common.True))._setresponsive /*b4j.example.wixaccordion*/ ((Object)(anywheresoftware.b4a.keywords.Common.True));
 //BA.debugLineNum = 13;BA.debugLine="Dim div As UOENowHTML";
_div = new b4j.example.uoenowhtml();
 //BA.debugLineNum = 14;BA.debugLine="div.Initialize(\"previewit\",\"div\").SetStyle(\"width";
_div._initialize /*b4j.example.uoenowhtml*/ (ba,"previewit","div")._setstyle /*b4j.example.uoenowhtml*/ ("width","100%")._setstyle /*b4j.example.uoenowhtml*/ ("height","100%");
 //BA.debugLineNum = 16;BA.debugLine="Dim pel As WixElement";
_pel = new b4j.example.wixelement();
 //BA.debugLineNum = 17;BA.debugLine="pel.Initialize(\"prex\").SetTemplateHTML(div).SetSc";
_pel._initialize /*b4j.example.wixelement*/ (ba,"prex")._settemplatehtml /*b4j.example.wixelement*/ (_div)._setscroll /*b4j.example.wixelement*/ ((Object)("y"));
 //BA.debugLineNum = 19;BA.debugLine="Dim cel As WixElement";
_cel = new b4j.example.wixelement();
 //BA.debugLineNum = 20;BA.debugLine="cel.Initialize(\"codeit\").SetTemplate(\"Code\").SetS";
_cel._initialize /*b4j.example.wixelement*/ (ba,"codeit")._settemplate /*b4j.example.wixelement*/ ((Object)("Code"))._setscroll /*b4j.example.wixelement*/ ((Object)("y"));
 //BA.debugLineNum = 22;BA.debugLine="acc.AddItem(\"preview\",\"Preview\",div.html,False,Fa";
_acc._additem /*b4j.example.wixaccordion*/ ("preview",(Object)("Preview"),(Object)(_div._html /*String*/ ()),anywheresoftware.b4a.keywords.Common.False,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 23;BA.debugLine="acc.AddItem(\"code\",\"Source Code\",cel.item,False,F";
_acc._additem /*b4j.example.wixaccordion*/ ("code",(Object)("Source Code"),(Object)(_cel._item /*anywheresoftware.b4a.objects.collections.Map*/ ().getObject()),anywheresoftware.b4a.keywords.Common.False,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 25;BA.debugLine="formHolder.AddRows(acc.Item)";
_formholder._addrows /*b4j.example.wixrow*/ (_acc._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 26;BA.debugLine="Return formHolder";
