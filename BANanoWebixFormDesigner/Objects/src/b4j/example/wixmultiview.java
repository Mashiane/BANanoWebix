...
public String  _addtocolumns(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub AddToColumns(P As WixElement)";
 //BA.debugLineNum = 100;BA.debugLine="P.AddColumns(Item)";
_p._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 101;BA.debugLine="End Sub";
return "";
}
public String  _addtoelements(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub AddToElements(P As WixElement)";
 //BA.debugLineNum = 105;BA.debugLine="P.AddElements(Item)";
_p._addelements /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 106;BA.debugLine="End Sub";
return "";
}
public String  _addtorows(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 94;BA.debugLine="Sub AddToRows(P As WixElement)";
 //BA.debugLineNum = 95;BA.debugLine="P.AddRows(Item)";
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 ...
 //BA.debugLineNum = 71;BA.debugLine="Return MultiView.item";
...
public b4j.example.wixmultiview  _setanimate(boolean _b) throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub SetAnimate(b As Boolean) As WixMultiView";
 //BA.debugLineNum = 82;BA.debugLine="MultiView.SetAttr(\"animate\", b)";
...
public b4j.example.wixmultiview  _setfitbiggest(boolean _b) throws Exception{
 //BA.debugLineNum = 75;BA.debugLine="Sub SetFitBiggest(b As Boolean) As WixMultiView";
 //BA.debugLineNum = 76;BA.debugLine="MultiView.SetAttr(\"fitBiggest\", b)";
...
public b4j.example.wixmultiview  _setkeepviews(boolean _b) throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Sub SetkeepViews(b As Boolean) As WixMultiView";
 //BA.debugLineNum = 88;BA.debugLine="MultiView.SetAttr(\"keepViews\", b)";
...
String _strkey = "";
String _strval = "";
 //BA.debugLineNum = 16;BA.debugLine="Sub SetMap(m As Map) As WixMultiView";
...
_strval = BA.ObjectToString(_m.Get((Object)(_strkey)));
 //BA.debugLineNum = 19;BA.debugLine="MultiView.SetAttr(strKey,	strVal)";
...
public b4j.example.wixmultiview  _setminheight(int _h) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub SetMinHeight(h As Int) As WixMultiView";
 //BA.debugLineNum = 58;BA.debugLine="MultiView.SetMinHeight(h)";
...
public b4j.example.wixmultiview  _setminwidth(int _w) throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub SetMinWidth(w As Int) As WixMultiView";
 //BA.debugLineNum = 52;BA.debugLine="MultiView.SetMinWidth(w)";
...
public b4j.example.wixmultiview  _setname(String _n) throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Sub SetName(n As String) As WixMultiView";
 //BA.debugLineNum = 33;BA.debugLine="MultiView.SetName(n)";
...
public b4j.example.wixmultiview  _setresponsive(Object _b) throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Sub SetResponsive(b As Object) As WixMultiView";
 //BA.debugLineNum = 39;BA.debugLine="MultiView.SetResponsive(b)";
...
public b4j.example.wixmultiview  _setresponsivecell(Object _b) throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub SetResponsiveCell(b As Object) As WixMultiView";
 //BA.debugLineNum = 45;BA.debugLine="MultiView.SetResponsiveCell(b)";
...
String _os = "";
 //BA.debugLineNum = 25;BA.debugLine="Sub SetTemplateHTML(h As UOENowHTML) As WixMultiVi";
 //BA.debugLineNum = 26;BA.debugLine="Dim os As String = h.HTML";
_os = _h._html /*String*/ ();
 //BA.debugLineNum = 27;BA.debugLine="MultiView.SetTemplate(os)";
...
public b4j.example.wixmultiview  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub SetTooltip(tt As String) As WixMultiView";
 //BA.debugLineNum = 64;BA.debugLine="MultiView.SetTooltip(tt)";
