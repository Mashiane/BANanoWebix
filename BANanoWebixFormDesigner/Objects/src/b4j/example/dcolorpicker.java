...
public class dcolorpicker extends Object{
public static dcolorpicker mostCurrent = new dcolorpicker();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dcolorpicker", null);
		ba.loadHtSubs(dcolorpicker.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dcolorpicker", ba);
		}
	}
    public static Class<?> getObject() {
		return dcolorpicker.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"colopicker1\")";
_bag._addtextbox /*String*/ ("id","ID","colopicker1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"colorpicke";
_bag._addtextbox /*String*/ ("localId","Local ID","colorpicker1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"colorpicker\", Page.v";
_bag._addcombo /*String*/ ("view","View","colorpicker",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Color Picker 1\")";
_bag._addtextbox /*String*/ ("label","Text","Color Picker 1");
...
_bag._addcombo /*String*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*String*/ ("Size");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"\")";
_bag._addtextbox /*String*/ ("width","Width","");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
