...
_bag._addtextbox /*String*/ ("id","ID","pager1");
 //BA.debugLineNum = 19;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"pager1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","pager1");
...
_bag._addcombo /*String*/ ("view","View","pager",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
