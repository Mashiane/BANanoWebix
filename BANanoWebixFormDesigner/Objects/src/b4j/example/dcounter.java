...
public class dcounter extends Object{
public static dcounter mostCurrent = new dcounter();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dcounter", null);
		ba.loadHtSubs(dcounter.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dcounter", ba);
		}
	}
    public static Class<?> getObject() {
		return dcounter.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"counter1\")";
_bag._addtextbox /*String*/ ("id","ID","counter1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"counter1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","counter1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"counter\", Page.views";
_bag._addcombo /*String*/ ("view","View","counter",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Counter 1\")";
_bag._addtextbox /*String*/ ("label","Text","Counter 1");
...
_bag._addcombo /*String*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddTextBox(\"min\",\"Min\", \"0\")";
_bag._addtextbox /*String*/ ("min","Min","0");
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddTextBox(\"max\",\"Max\", \"100\")";
_bag._addtextbox /*String*/ ("max","Max","100");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"step\",\"Step\", \"1\")";
_bag._addtextbox /*String*/ ("step","Step","1");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*String*/ ("Size");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"200\")";
...
_bag._addtextbox /*String*/ ("height","Height","");
 //BA.debugLineNum = 40;BA.debugLine="Bag.AddLabel(\"Options\")";
