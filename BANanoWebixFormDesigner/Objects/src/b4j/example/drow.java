...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","r1");
 //BA.debugLineNum = 8;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"\")";
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","row",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("template","Template","r1");
...
_bag._addcolor /*b4j.example.wixproperty*/ ("style.color","Color","");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddColor(\"style.background\", \"Background\",\"\")";
