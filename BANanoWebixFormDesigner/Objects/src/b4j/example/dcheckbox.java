...
public class dcheckbox extends Object{
public static dcheckbox mostCurrent = new dcheckbox();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dcheckbox", null);
		ba.loadHtSubs(dcheckbox.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dcheckbox", ba);
		}
	}
    public static Class<?> getObject() {
		return dcheckbox.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"check1\")";
_bag._addtextbox /*String*/ ("id","ID","check1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"check1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","check1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"CheckBox\", Page.view";
_bag._addcombo /*String*/ ("view","View","CheckBox",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"CheckBox 1\")";
_bag._addtextbox /*String*/ ("label","Text","CheckBox 1");
