...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","check1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","CheckBox",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","CheckBox 1");
