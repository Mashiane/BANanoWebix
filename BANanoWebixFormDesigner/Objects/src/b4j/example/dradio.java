...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","radio1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","radio",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addcheckbox /*b4j.example.wixproperty*/ ("vertical","Vertical",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False));
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","Radio 1");
