...
public class dradio extends Object{
public static dradio mostCurrent = new dradio();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dradio", null);
		ba.loadHtSubs(dradio.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dradio", ba);
		}
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"radio1\")";
_bag._addtextbox /*String*/ ("id","ID","radio1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"radio1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","radio1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"radio\", Page.views)";
_bag._addcombo /*String*/ ("view","View","radio",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*String*/ ("batch","Batch","");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddCheckBox(\"vertical\", \"Vertical\", False)";
_bag._addcheckbox /*String*/ ("vertical","Vertical",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False));
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddLabel(\"Label\")";
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Radio 1\")";
_bag._addtextbox /*String*/ ("label","Text","Radio 1");
...
_bag._addlabel /*String*/ ("Options");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddTextBox(\"optionsid\",\"IDs\", \"1,2,3\")";
_bag._addtextbox /*String*/ ("optionsid","IDs","1,2,3");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"optionstext\",\"Values\", \"One,Two,T";
...
_bag._addtextbox /*String*/ ("height","Height","");
 //BA.debugLineNum = 46;BA.debugLine="Bag.Refresh(Page)";
