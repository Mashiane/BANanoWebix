...
public class ddbllist extends Object{
public static ddbllist mostCurrent = new ddbllist();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.ddbllist", null);
		ba.loadHtSubs(ddbllist.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.ddbllist", ba);
		}
	}
    public static Class<?> getObject() {
		return ddbllist.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"dbllist1\")";
_bag._addtextbox /*String*/ ("id","ID","dbllist1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"dbllist1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","dbllist1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"dbllist\", Page.views";
_bag._addcombo /*String*/ ("view","View","dbllist",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"DBLList 1\")";
_bag._addtextbox /*String*/ ("label","Text","DBLList 1");
...
_bag._addcombo /*String*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddLabel(\"Options\")";
_bag._addlabel /*String*/ ("Options");
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddTextBox(\"optionsid\",\"IDs\", \"1,2,3\")";
_bag._addtextbox /*String*/ ("optionsid","IDs","1,2,3");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"optionstext\",\"Values\", \"One,Two,T";
_bag._addtextbox /*String*/ ("optionstext","Values","One,Two,Three");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*String*/ ("Size");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"\")";
_bag._addtextbox /*String*/ ("width","Width","");
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
_bag._addtextbox /*String*/ ("height","Height","");
 //BA.debugLineNum = 43;BA.debugLine="Bag.Refresh(Page)";
