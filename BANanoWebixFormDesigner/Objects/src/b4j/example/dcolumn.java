...
_bag._addtextbox /*String*/ ("id","ID","r1c1");
 //BA.debugLineNum = 9;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"r1c1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","r1c1");
...
_bag._addtextbox /*String*/ ("parentid","Parent","r1");
 //BA.debugLineNum = 12;BA.debugLine="Bag.AddCombo(\"addingmethod\",\"Adding Method\",\"AddR";
...
_bag._addcombo /*String*/ ("view","View","column",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*String*/ ("gravity","Gravity","");
 //BA.debugLineNum = 21;BA.debugLine="Bag.AddTextBox(\"template\",\"Template\",\"r1c1\")";
_bag._addtextbox /*String*/ ("template","Template","r1c1");
...
_bag._addcolor /*String*/ ("style.color","Color","");
 //BA.debugLineNum = 28;BA.debugLine="Bag.AddColor(\"style.background\", \"Background\",\"#F";
_bag._addcolor /*String*/ ("style.background","Background","#FF9ECE");
