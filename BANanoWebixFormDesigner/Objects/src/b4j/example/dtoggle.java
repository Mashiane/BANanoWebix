...
public class dtoggle extends Object{
public static dtoggle mostCurrent = new dtoggle();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dtoggle", null);
		ba.loadHtSubs(dtoggle.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dtoggle", ba);
		}
	}
    public static Class<?> getObject() {
		return dtoggle.class;
	}
...
_btype.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(""),(Object)("icon"),(Object)("iconTop"),(Object)("image"),(Object)("imageTop")}));
 //BA.debugLineNum = 18;BA.debugLine="Bag.Clear";
_bag._clear /*b4j.example.wixproperty*/ ();
 //BA.debugLineNum = 19;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"toggle1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","toggle1");
 //BA.debugLineNum = 20;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("localId","Local ID","");
 //BA.debugLineNum = 21;BA.debugLine="Bag.AddLabel(\"Parent\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Parent");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddTextBox(\"parentid\",\"Parent\", \"form\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("parentid","Parent","form");
 //BA.debugLineNum = 23;BA.debugLine="Bag.AddCombo(\"addingmethod\",\"Adding Method\",\"AddR";
_bag._addcombo /*b4j.example.wixproperty*/ ("addingmethod","Adding Method","AddRows",_pgformdesigner._addingmethod /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 24;BA.debugLine="Bag.AddTextBox(\"tabindex\", \"Tab Index\", \"0\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("tabindex","Tab Index","0");
 //BA.debugLineNum = 25;BA.debugLine="Bag.AddLabel(\"View\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("View");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"toggle\", Page.views)";
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","toggle",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 27;BA.debugLine="Bag.AddCombo(\"type\",\"Type\",\"icon\", bType)";
_bag._addcombo /*b4j.example.wixproperty*/ ("type","Type","icon",_btype);
 //BA.debugLineNum = 28;BA.debugLine="Bag.AddLabel(\"Details\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Details");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"value\", \"Value\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("value","Value","");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddTextBox(\"name\", \"Name\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("name","Name","");
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddTextBox(\"tooltip\", \"Tooltip\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("tooltip","Tooltip","");
 //BA.debugLineNum = 32;BA.debugLine="Bag.AddTextBox(\"icon\", \"Icon\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("icon","Icon","");
 //BA.debugLineNum = 33;BA.debugLine="Bag.AddTextBox(\"image\", \"Image\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("image","Image","");
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddTextBox(\"batch\", \"Batch\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("batch","Batch","");
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddLabel(\"Label\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Label");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Toggle 1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","Toggle 1");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddTextBox(\"labelWidth\",\"Width\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelWidth","Width","");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"labelHeight\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelHeight","Height","");
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddCombo(\"labelAlign\",\"Align\",\"\",align)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelAlign","Align","",_align);
 //BA.debugLineNum = 40;BA.debugLine="Bag.AddCombo(\"labelPosition\",\"Position\",\"\",pos)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 41;BA.debugLine="Bag.AddLabel(\"Options\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Options");
 //BA.debugLineNum = 42;BA.debugLine="Bag.AddTextBox(\"onLabel\",\"On Label\", \"ON\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("onLabel","On Label","ON");
 //BA.debugLineNum = 43;BA.debugLine="Bag.addtextbox(\"offLabel\", \"Off Label\", \"OFF\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("offLabel","Off Label","OFF");
 //BA.debugLineNum = 44;BA.debugLine="Bag.AddTextBox(\"onIcon\",\"On Icon\",\"mdi mdi-play\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("onIcon","On Icon","mdi mdi-play");
 //BA.debugLineNum = 45;BA.debugLine="Bag.AddTextBox(\"offIcon\",\"Off Icon\",\"mdi mdi-paus";
_bag._addtextbox /*b4j.example.wixproperty*/ ("offIcon","Off Icon","mdi mdi-pause");
 //BA.debugLineNum = 47;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Size");
 //BA.debugLineNum = 48;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"100\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("width","Width","100");
 //BA.debugLineNum = 49;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("height","Height","");
 //BA.debugLineNum = 51;BA.debugLine="Bag.Refresh(Page)";
