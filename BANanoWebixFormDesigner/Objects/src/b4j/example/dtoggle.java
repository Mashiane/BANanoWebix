...
_bag._addtextbox /*String*/ ("id","ID","toggle1");
 //BA.debugLineNum = 20;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"toggle1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","toggle1");
...
_bag._addcombo /*String*/ ("view","View","toggle",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 27;BA.debugLine="Bag.AddCombo(\"type\",\"Type\",\"icon\", bType)";
_bag._addcombo /*String*/ ("type","Type","icon",_btype);
...
_bag._addtextbox /*String*/ ("label","Text","Toggle 1");
