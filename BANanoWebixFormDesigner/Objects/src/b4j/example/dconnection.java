...
_bag._addtextbox /*String*/ ("id","ID","connection");
 //BA.debugLineNum = 8;BA.debugLine="Bag.AddCombo(\"dbtype\",\"Database Type\",\"BANanoSQL\"";
_bag._addcombo /*String*/ ("dbtype","Database Type","BANanoSQL",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(""),(Object)("BANanoSQL"),(Object)("BANanoSQLite"),(Object)("BANanoMySQL")}));
 //BA.debugLineNum = 9;BA.debugLine="Bag.AddTextBox(\"dbname\",\"Database Name\", \"db\")";
_bag._addtextbox /*String*/ ("dbname","Database Name","db");
 //BA.debugLineNum = 10;BA.debugLine="Bag.AddTextBox(\"host\", \"Host\", \"localhost\")";
_bag._addtextbox /*String*/ ("host","Host","localhost");
 //BA.debugLineNum = 11;BA.debugLine="Bag.AddTextBox(\"port\", \"Server Port\", \"3306\")";
_bag._addtextbox /*String*/ ("port","Server Port","3306");
 //BA.debugLineNum = 12;BA.debugLine="Bag.AddLabel(\"Credentials\")";
_bag._addlabel /*String*/ ("Credentials");
 //BA.debugLineNum = 13;BA.debugLine="Bag.AddTextBox(\"username\",\"User Name\",\"root\")";
_bag._addtextbox /*String*/ ("username","User Name","root");
 //BA.debugLineNum = 14;BA.debugLine="Bag.AddPassword(\"password\", \"Password\",\"\")";
_bag._addpassword /*String*/ ("password","Password","");
...
_host = BA.ObjectToString(_cm.Get((Object)("host")));
 //BA.debugLineNum = 26;BA.debugLine="Dim sb As StringBuilder";
_sb = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 27;BA.debugLine="sb.Initialize";
_sb.Initialize();
 //BA.debugLineNum = 28;BA.debugLine="Select Case dbtype";
switch (BA.switchObjectToInt(_dbtype,"BANanoSQL","BANanoSQLite","BANanoMySQL")) {
case 0: {
 //BA.debugLineNum = 30;BA.debugLine="sb.append(\"'STEP 1: Copy and paste the followin";
_sb.Append("'STEP 1: Copy and paste the following code in Process_Globals of each module you will access the Database including Main\\r\\n\\r\\n");
 //BA.debugLineNum = 31;BA.debugLine="sb.Append($\"Private ${dbname} As BANanoSQL\\r\\n\\";
_sb.Append(("Private "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_dbname))+" As BANanoSQL\\r\\n\\r\\n"));
 //BA.debugLineNum = 32;BA.debugLine="sb.append(\"'STEP 2: On the Initialize sub for y";
_sb.Append("'STEP 2: On the Initialize sub for your code module, copy and paste the following code before everything else\\r\\n\\r\\n");
 //BA.debugLineNum = 33;BA.debugLine="sb.Append($\"${dbname}.OpenWait(\"${dbname}\", \"${";
_sb.Append((""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_dbname))+".OpenWait(\""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_dbname))+"\", \""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_dbname))+"\")\\r\\n\\r\\n"));
 //BA.debugLineNum = 34;BA.debugLine="sb.append(\"'STEP 3: On Main.BANano_Ready, copy";
_sb.Append("'STEP 3: On Main.BANano_Ready, copy and paste the following code before everything else\\r\\n\\r\\n");
 //BA.debugLineNum = 35;BA.debugLine="sb.Append($\"${dbname}.OpenWait(\"${dbname}\", \"${";
_sb.Append((""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_dbname))+".OpenWait(\""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_dbname))+"\", \""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_dbname))+"\")\\r\\n\\r\\n"));
 break; }
case 1: {
 //BA.debugLineNum = 37;BA.debugLine="sb.append(\"'STEP 1: In Main.AppStart, include t";
_sb.Append("'STEP 1: In Main.AppStart, include the code after initializing BANano\\r\\n\\r\\n");
 //BA.debugLineNum = 38;BA.debugLine="sb.append($\"BANano.PHP_NAME = \"app.php\"\\r\\nBANa";
_sb.Append(("BANano.PHP_NAME = \"app.php\"\\r\\nBANano.PHPHost = \"http://www.yourserver.com/app/\"\\r\\nBANano.PHPAddHeader(\"Access-Control-Allow-Origin: *\")\\r\\n\\r\\n"));
 //BA.debugLineNum = 39;BA.debugLine="sb.append(\"Ensure you update your .PHPHost to p";
_sb.Append("Ensure you update your .PHPHost to point to the right location of your app.\\r\\n\\r\\n");
 break; }
case 2: {
 //BA.debugLineNum = 41;BA.debugLine="sb.Append(\"'STEP 1: Copy the config.php file fr";
_sb.Append("'STEP 1: Copy the config.php file from the 'assets' folder to your root folder and update it\\r\\n\\r\\n");
 //BA.debugLineNum = 42;BA.debugLine="sb.append($\"const DB_HOST = '${host}';\\r\\nconst";
_sb.Append(("const DB_HOST = '"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_host))+"';\\r\\nconst DB_USER = '"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_username))+"';\\r\\nconst DB_PASS = '"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_password))+"';\\r\\nconst DB_NAME = '"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_dbname))+"';\\r\\n\\r\\n"));
 //BA.debugLineNum = 43;BA.debugLine="sb.append(\"'STEP 2: In Main.AppStart, include t";
_sb.Append("'STEP 2: In Main.AppStart, include the code after initializing BANano\\r\\n\\r\\n");
 //BA.debugLineNum = 44;BA.debugLine="sb.append($\"BANano.PHP_NAME = \"app.php\"\\r\\nBANa";
_sb.Append(("BANano.PHP_NAME = \"app.php\"\\r\\nBANano.PHPHost = \"http://www.yourserver.com/app/\"\\r\\nBANano.PHPAddHeader(\"Access-Control-Allow-Origin: *\")\\r\\n\\r\\n"));
 //BA.debugLineNum = 45;BA.debugLine="sb.append(\"Ensure you update your .PHPHost to p";
_sb.Append("Ensure you update your .PHPHost to point to the right location of your app.\\r\\n\\r\\n");
 break; }
}
;
 //BA.debugLineNum = 47;BA.debugLine="Return sb.tostring";
