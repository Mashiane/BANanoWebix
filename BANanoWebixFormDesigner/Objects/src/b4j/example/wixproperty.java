...
public String  _addcheckbox(String _eid,String _label,String _value) throws Exception{
 //BA.debugLineNum = 124;BA.debugLine="Sub AddCheckBox(eid As String, label As String, va";
 //BA.debugLineNum = 125;BA.debugLine="elements.Add(El(eid, label, \"checkbox\", value, Nu";
...
public String  _addcolor(String _eid,String _label,String _value) throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Sub AddColor(eid As String, label As String, value";
 //BA.debugLineNum = 93;BA.debugLine="elements.Add(El(eid,label, \"color\", value, Null,N";
...
public String  _addcombo(String _eid,String _label,String _value,anywheresoftware.b4a.objects.collections.List _options) throws Exception{
 //BA.debugLineNum = 116;BA.debugLine="Sub AddCombo(eid As String, label As String, value";
 //BA.debugLineNum = 117;BA.debugLine="elements.Add(El(eid, label, \"combo\", value, optio";
_elements.Add((Object)(_el(_eid,_label,"combo",(Object)(_value),_options,__c.Null).getObject()));
 //BA.debugLineNum = 118;BA.debugLine="End Sub";
return "";
}
public String  _adddate(String _eid,String _label,String _value,Object _format) throws Exception{
 //BA.debugLineNum = 108;BA.debugLine="Sub AddDate(eid As String, label As String, value";
 //BA.debugLineNum = 109;BA.debugLine="elements.Add(El(eid, label, \"date\", value,  Null,";
...
public String  _addlabel(String _label) throws Exception{
 //BA.debugLineNum = 100;BA.debugLine="Sub AddLabel(label As String)";
 //BA.debugLineNum = 101;BA.debugLine="elements.Add(El(\"\", label, \"label\", \"\", Null,Null";
...
public String  _addpassword(String _eid,String _label,String _value) throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub AddPassword(eid As String, label As String, va";
 //BA.debugLineNum = 105;BA.debugLine="elements.Add(El(eid, label, \"password\", value,  N";
...
public String  _addrichselect(String _eid,String _label,String _value,anywheresoftware.b4a.objects.collections.List _options) throws Exception{
 //BA.debugLineNum = 120;BA.debugLine="Sub AddRichSelect(eid As String, label As String,";
 //BA.debugLineNum = 121;BA.debugLine="elements.Add(El(eid, label, \"richselect\", value,";
...
public String  _addselect(String _eid,String _label,String _value,anywheresoftware.b4a.objects.collections.List _options) throws Exception{
 //BA.debugLineNum = 112;BA.debugLine="Sub AddSelect(eid As String, label As String, valu";
 //BA.debugLineNum = 113;BA.debugLine="elements.Add(El(eid, label, \"select\", value, opti";
...
public String  _addtextbox(String _eid,String _label,String _value) throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Sub AddTextBox(eid As String, label As String, val";
 //BA.debugLineNum = 97;BA.debugLine="elements.Add(El(eid, label, \"text\", value, Null,N";
...
public String  _addtocolumns(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub AddToColumns(P As WixElement)";
 //BA.debugLineNum = 195;BA.debugLine="P.AddColumns(Item)";
_p._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 196;BA.debugLine="End Sub";
return "";
}
public String  _addtoelements(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Sub AddToElements(P As WixElement)";
 //BA.debugLineNum = 200;BA.debugLine="P.AddElements(Item)";
_p._addelements /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 201;BA.debugLine="End Sub";
return "";
}
public String  _addtorows(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Sub AddToRows(P As WixElement)";
 //BA.debugLineNum = 190;BA.debugLine="P.AddRows(Item)";
...
public String  _clear() throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub Clear";
 //BA.debugLineNum = 129;BA.debugLine="elements.clear";
_elements.Clear();
...
_opt = __c.createMap(new Object[] {});
 //BA.debugLineNum = 18;BA.debugLine="opt.Put(\"id\", eid)";
_opt.Put((Object)("id"),(Object)(_eid));
 //BA.debugLineNum = 19;BA.debugLine="opt.Put(\"label\", label)";
_opt.Put((Object)("label"),(Object)(_label));
 //BA.debugLineNum = 20;BA.debugLine="opt.Put(\"type\", typeOf)";
_opt.Put((Object)("type"),(Object)(_typeof));
 //BA.debugLineNum = 21;BA.debugLine="opt.Put(\"value\", value)";
_opt.Put((Object)("value"),_value);
 //BA.debugLineNum = 22;BA.debugLine="If format <> Null Then";
if (_format!= null) { 
 //BA.debugLineNum = 23;BA.debugLine="opt.Put(\"format\", format)";
_opt.Put((Object)("format"),_format);
 };
 //BA.debugLineNum = 25;BA.debugLine="If options <> Null Then";
if (_options!= null) { 
 //BA.debugLineNum = 26;BA.debugLine="opt.Put(\"options\", options)";
_opt.Put((Object)("options"),(Object)(_options.getObject()));
 };
 //BA.debugLineNum = 28;BA.debugLine="Return opt";
if (true) return _opt;
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 ...
 //BA.debugLineNum = 140;BA.debugLine="Property.SetAttr(\"elements\", elements)";
_property._setattr /*b4j.example.wixelement*/ ("elements",(Object)(_elements.getObject()));
 //BA.debugLineNum = 141;BA.debugLine="Return Property.item";
...
anywheresoftware.b4a.objects.collections.Map _opt = null;
 //BA.debugLineNum = 132;BA.debugLine="Sub Refresh(pg As WixPage)";
 //BA.debugLineNum = 133;BA.debugLine="Dim opt As Map = CreateMap(\"elements\": elements)";
_opt = new anywheresoftware.b4a.objects.collections.Map();
_opt = __c.createMap(new Object[] {(Object)("elements"),(Object)(_elements.getObject())});
 //BA.debugLineNum = 134;BA.debugLine="pg.Define(ID, opt)";
_pg._define /*String*/ (_id,_opt);
 //BA.debugLineNum = 135;BA.debugLine="pg.Refresh(ID)";
_pg._refresh /*String*/ (_id);
 //BA.debugLineNum = 136;BA.debugLine="End Sub";
return "";
}
public b4j.example.wixproperty  _setborderless(boolean _t) throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Sub SetBorderLess(t As Boolean) As WixProperty";
 //BA.debugLineNum = 158;BA.debugLine="Property.SetAttr(\"borderless\", t)";
...
public b4j.example.wixproperty  _setcomplexdata(boolean _b) throws Exception{
 //BA.debugLineNum = 86;BA.debugLine="Sub SetComplexData(b As Boolean) As WixProperty";
 //BA.debugLineNum = 87;BA.debugLine="Property.SetAttr(\"complexData\", b)";
...
public b4j.example.wixproperty  _setdata(anywheresoftware.b4a.objects.collections.List _data) throws Exception{
 //BA.debugLineNum = 145;BA.debugLine="Sub SetData(data As List) As WixProperty";
 //BA.debugLineNum = 146;BA.debugLine="Property.SetData(data)";
...
public b4j.example.wixproperty  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Sub SetHeight(h As Object) As WixProperty";
 //BA.debugLineNum = 177;BA.debugLine="Property.SetHeight(h)";
...
String _strkey = "";
String _strval = "";
 //BA.debugLineNum = 70;BA.debugLine="Sub SetMap(m As Map) As WixProperty";
...
_strval = BA.ObjectToString(_m.Get((Object)(_strkey)));
 //BA.debugLineNum = 73;BA.debugLine="Property.SetAttr(strKey,	strVal)";
...
public b4j.example.wixproperty  _setminheight(int _h) throws Exception{
 //BA.debugLineNum = 64;BA.debugLine="Sub SetMinHeight(h As Int) As WixProperty";
 //BA.debugLineNum = 65;BA.debugLine="Property.SetMinHeight(h)";
...
public b4j.example.wixproperty  _setminwidth(int _w) throws Exception{
 //BA.debugLineNum = 58;BA.debugLine="Sub SetMinWidth(w As Int) As WixProperty";
 //BA.debugLineNum = 59;BA.debugLine="Property.SetMinWidth(w)";
...
public b4j.example.wixproperty  _setname(String _n) throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub SetName(n As String) As WixProperty";
 //BA.debugLineNum = 40;BA.debugLine="Property.SetName(n)";
...
public b4j.example.wixproperty  _setnamewidth(int _w) throws Exception{
 //BA.debugLineNum = 80;BA.debugLine="Sub SetNameWidth(w As Int) As WixProperty";
 //BA.debugLineNum = 81;BA.debugLine="Property.SetAttr(\"nameWidth\", w)";
...
public b4j.example.wixproperty  _setresponsive(Object _b) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub SetResponsive(b As Object) As WixProperty";
 //BA.debugLineNum = 46;BA.debugLine="Property.SetResponsive(b)";
...
public b4j.example.wixproperty  _setresponsivecell(Object _b) throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub SetResponsiveCell(b As Object) As WixProperty";
 //BA.debugLineNum = 52;BA.debugLine="Property.SetResponsiveCell(b)";
...
public b4j.example.wixproperty  _setscroll(Object _c) throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Sub SetScroll(c As Object) As WixProperty";
 //BA.debugLineNum = 33;BA.debugLine="Property.SetAttr(\"scroll\", c)";
...
public b4j.example.wixproperty  _setstyle(String _prop,String _val) throws Exception{
 //BA.debugLineNum = 151;BA.debugLine="Sub SetStyle(prop As String, val As String) As Wix";
 //BA.debugLineNum = 152;BA.debugLine="Property.SetStyle(prop,val)";
...
public b4j.example.wixproperty  _settemplate(Object _t) throws Exception{
 //BA.debugLineNum = 164;BA.debugLine="Sub SetTemplate(t As Object) As WixProperty";
 //BA.debugLineNum = 165;BA.debugLine="Property.SetTemplate(t)";
...
public b4j.example.wixproperty  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub SetTooltip(tt As String) As WixProperty";
 //BA.debugLineNum = 171;BA.debugLine="Property.SetTooltip(tt)";
...
public b4j.example.wixproperty  _setwidth(Object _h) throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub SetWidth(h As Object) As WixProperty";
 //BA.debugLineNum = 183;BA.debugLine="Property.SetWidth(h)";
