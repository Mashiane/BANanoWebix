...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","tabbar1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","tabbar",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("value","Value","2");
...
_bag._addcheckbox /*b4j.example.wixproperty*/ ("multiview","Multi View","");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddCheckBox(\"fitBiggest\", \"Fit Biggest\", \"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("fitBiggest","Fit Biggest","");
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddCheckBox(\"bottom\", \"Bottom\", \"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("bottom","Bottom","");
...
_bag._addcheckbox /*b4j.example.wixproperty*/ ("keepViews","Keep Views","");
