...
public class dtabbar extends Object{
public static dtabbar mostCurrent = new dtabbar();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dtabbar", null);
		ba.loadHtSubs(dtabbar.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dtabbar", ba);
		}
	}
    public static Class<?> getObject() {
		return dtabbar.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"tabbar1\")";
_bag._addtextbox /*String*/ ("id","ID","tabbar1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"tabbar1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","tabbar1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"tabbar\", Page.views)";
_bag._addcombo /*String*/ ("view","View","tabbar",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 23;BA.debugLine="Bag.AddLabel(\"Details\")";
_bag._addlabel /*String*/ ("Details");
 //BA.debugLineNum = 24;BA.debugLine="Bag.AddTextBox(\"value\", \"Value\",\"2\")";
_bag._addtextbox /*String*/ ("value","Value","2");
 //BA.debugLineNum = 25;BA.debugLine="Bag.AddTextBox(\"name\", \"Name\",\"\")";
_bag._addtextbox /*String*/ ("name","Name","");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddTextBox(\"icon\", \"Icon\",\"\")";
...
_bag._addtextbox /*String*/ ("batch","Batch","");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddCheckBox(\"multiview\", \"Multi View\",\"\")";
_bag._addcheckbox /*String*/ ("multiview","Multi View","");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddCheckBox(\"fitBiggest\", \"Fit Biggest\", \"\")";
_bag._addcheckbox /*String*/ ("fitBiggest","Fit Biggest","");
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddCheckBox(\"bottom\", \"Bottom\", \"\")";
_bag._addcheckbox /*String*/ ("bottom","Bottom","");
 //BA.debugLineNum = 32;BA.debugLine="Bag.AddCheckBox(\"animate\", \"Animate\", \"\")";
_bag._addcheckbox /*String*/ ("animate","Animate","");
 //BA.debugLineNum = 33;BA.debugLine="Bag.AddCheckBox(\"keepViews\", \"Keep Views\", \"\")";
_bag._addcheckbox /*String*/ ("keepViews","Keep Views","");
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*String*/ ("Size");
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"\")";
_bag._addtextbox /*String*/ ("width","Width","");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
_bag._addtextbox /*String*/ ("height","Height","");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddLabel(\"Options\")";
_bag._addlabel /*String*/ ("Options");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"optionsid\",\"IDs\", \"1,2,3\")";
_bag._addtextbox /*String*/ ("optionsid","IDs","1,2,3");
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddTextBox(\"optionstext\",\"Values\", \"One,Two,T";
_bag._addtextbox /*String*/ ("optionstext","Values","One,Two,Three");
 //BA.debugLineNum = 49;BA.debugLine="Bag.Refresh(Page)";
