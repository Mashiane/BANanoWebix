...
_bag._addtextbox /*String*/ ("id","ID","suggest1");
 //BA.debugLineNum = 19;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"suggest1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","suggest1");
...
_bag._addcombo /*String*/ ("view","View","suggest",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
