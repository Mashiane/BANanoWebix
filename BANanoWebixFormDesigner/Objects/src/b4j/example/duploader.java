...
_bag._addtextbox /*String*/ ("id","ID","upload");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"upload\")";
_bag._addtextbox /*String*/ ("localId","Local ID","upload");
...
_bag._addcombo /*String*/ ("view","View","uploader",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*String*/ ("name","Name","upload");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddTextBox(\"inputName\", \"Input Name\", \"upload";
_bag._addtextbox /*String*/ ("inputName","Input Name","upload");
...
_bag._addtextbox /*String*/ ("label","Text","Uploader 1");
