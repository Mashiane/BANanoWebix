...
public class duploader extends Object{
public static duploader mostCurrent = new duploader();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.duploader", null);
		ba.loadHtSubs(duploader.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.duploader", ba);
		}
	}
    public static Class<?> getObject() {
		return duploader.class;
	}
...
_bag._clear /*b4j.example.wixproperty*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"upload\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","upload");
...
_bag._addlabel /*b4j.example.wixproperty*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"uploader\", Page.view";
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","uploader",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("value","Value","");
 //BA.debugLineNum = 25;BA.debugLine="Bag.AddTextBox(\"name\", \"Name\",\"upload\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("name","Name","upload");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddTextBox(\"inputName\", \"Input Name\", \"upload";
_bag._addtextbox /*b4j.example.wixproperty*/ ("inputName","Input Name","upload");
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("batch","Batch","");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddLabel(\"Label\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Label");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Uploader 1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","Uploader 1");
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddTextBox(\"labelWidth\",\"Width\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelWidth","Width","");
 //BA.debugLineNum = 32;BA.debugLine="Bag.AddTextBox(\"labelHeight\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelHeight","Height","");
 //BA.debugLineNum = 33;BA.debugLine="Bag.AddCombo(\"labelAlign\",\"Align\",\"\",align)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelAlign","Align","",_align);
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddCombo(\"labelPosition\",\"Position\",\"\",pos)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddLabel(\"Options\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Options");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddCheckBox(\"apiOnly\", \"API Only\", \"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("apiOnly","API Only","");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"datatype\", \"Data Type\", \"json\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("datatype","Data Type","json");
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddCheckBox(\"multiple\",\"Multiple\", \"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("multiple","Multiple","");
 //BA.debugLineNum = 40;BA.debugLine="Bag.AddCheckBox(\"autosend\", \"Auto Send\", \"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("autosend","Auto Send","");
 //BA.debugLineNum = 41;BA.debugLine="Bag.AddTextBox(\"link\", \"Link\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("link","Link","");
 //BA.debugLineNum = 42;BA.debugLine="Bag.AddTextBox(\"accept\", \"Accept\", \"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("accept","Accept","");
 //BA.debugLineNum = 43;BA.debugLine="Bag.AddTextBox(\"upload\", \"Upload\", \"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("upload","Upload","");
 //BA.debugLineNum = 44;BA.debugLine="Bag.AddCheckBox(\"autowidth\", \"Auto width \",\"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("autowidth","Auto width ","");
 //BA.debugLineNum = 45;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Size");
 //BA.debugLineNum = 46;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("width","Width","");
 //BA.debugLineNum = 47;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
