...
public class dlabel extends Object{
public static dlabel mostCurrent = new dlabel();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dlabel", null);
		ba.loadHtSubs(dlabel.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dlabel", ba);
		}
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"label1\")";
_bag._addtextbox /*String*/ ("id","ID","label1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"label1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","label1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"label\", Page.views)";
_bag._addcombo /*String*/ ("view","View","label",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Label 1\")";
_bag._addtextbox /*String*/ ("label","Text","Label 1");
