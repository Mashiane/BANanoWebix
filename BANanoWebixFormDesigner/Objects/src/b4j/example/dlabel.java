...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","label1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","label",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","Label 1");
