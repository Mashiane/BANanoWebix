...
public class dcombo extends Object{
public static dcombo mostCurrent = new dcombo();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dcombo", null);
		ba.loadHtSubs(dcombo.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dcombo", ba);
		}
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"combo1\")";
_bag._addtextbox /*String*/ ("id","ID","combo1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"combo1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","combo1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"combo\", Page.views)";
_bag._addcombo /*String*/ ("view","View","combo",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*String*/ ("name","Name","");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddTextBox(\"placeholder\", \"PlaceHolder\",\"\")";
_bag._addtextbox /*String*/ ("placeholder","PlaceHolder","");
 //BA.debugLineNum = 27;BA.debugLine="Bag.AddTextBox(\"icon\", \"Icon\",\"\")";
_bag._addtextbox /*String*/ ("icon","Icon","");
 //BA.debugLineNum = 28;BA.debugLine="Bag.AddTextBox(\"tooltip\", \"Tooltip\",\"\")";
_bag._addtextbox /*String*/ ("tooltip","Tooltip","");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"batch\", \"Batch\",\"\")";
_bag._addtextbox /*String*/ ("batch","Batch","");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddLabel(\"Options\")";
_bag._addlabel /*String*/ ("Options");
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddTextBox(\"optionsid\",\"IDs\", \"1,2,3\")";
_bag._addtextbox /*String*/ ("optionsid","IDs","1,2,3");
 //BA.debugLineNum = 32;BA.debugLine="Bag.AddTextBox(\"optionstext\",\"Values\", \"One,Two,T";
_bag._addtextbox /*String*/ ("optionstext","Values","One,Two,Three");
 //BA.debugLineNum = 33;BA.debugLine="Bag.AddLabel(\"Label\")";
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Combo 1\")";
_bag._addtextbox /*String*/ ("label","Text","Combo 1");
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddTextBox(\"labelWidth\",\"Width\",\"\")";
_bag._addtextbox /*String*/ ("labelWidth","Width","");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"labelHeight\",\"Height\",\"\")";
_bag._addtextbox /*String*/ ("labelHeight","Height","");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddCombo(\"labelAlign\",\"Align\",\"\",align)";
_bag._addcombo /*String*/ ("labelAlign","Align","",_align);
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddCombo(\"labelPosition\",\"Position\",\"\",pos)";
