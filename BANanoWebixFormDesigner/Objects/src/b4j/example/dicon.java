...
_bag._addtextbox /*String*/ ("id","ID","icon1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"icon1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","icon1");
...
_bag._addcombo /*String*/ ("view","View","icon",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*String*/ ("icon","Icon","mdi mdi-account");
...
_bag._addtextbox /*String*/ ("badge","Badge","3");
