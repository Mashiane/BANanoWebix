...
public class dsegmented extends Object{
public static dsegmented mostCurrent = new dsegmented();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dsegmented", null);
		ba.loadHtSubs(dsegmented.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dsegmented", ba);
		}
	}
    public static Class<?> getObject() {
		return dsegmented.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"segmented1\")";
_bag._addtextbox /*String*/ ("id","ID","segmented1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"segmented1";
_bag._addtextbox /*String*/ ("localId","Local ID","segmented1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"segmented\", Page.vie";
_bag._addcombo /*String*/ ("view","View","segmented",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"\")";
_bag._addtextbox /*String*/ ("label","Text","");
