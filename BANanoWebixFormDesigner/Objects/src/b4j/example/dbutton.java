...
_act.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(""),(Object)("new"),(Object)("insert"),(Object)("read"),(Object)("update"),(Object)("delete"),(Object)("getall")}));
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","button1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","Button",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddCombo(\"type\",\"Type\",\"\", bType)";
_bag._addcombo /*b4j.example.wixproperty*/ ("type","Type","",_btype);
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddCombo(\"action\",\"Action\",\"\", act)";
_bag._addcombo /*b4j.example.wixproperty*/ ("action","Action","",_act);
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddCombo(\"css\", \"CSS\",\"\", css)";
_bag._addcombo /*b4j.example.wixproperty*/ ("css","CSS","",_css);
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddLabel(\"Label\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Label");
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Button 1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","Button 1");
 //BA.debugLineNum = 40;BA.debugLine="Bag.AddTextBox(\"labelWidth\",\"Width\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelWidth","Width","");
 //BA.debugLineNum = 41;BA.debugLine="Bag.AddTextBox(\"labelHeight\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelHeight","Height","");
 //BA.debugLineNum = 42;BA.debugLine="Bag.AddCombo(\"labelAlign\",\"Align\",\"\",align)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelAlign","Align","",_align);
 //BA.debugLineNum = 43;BA.debugLine="Bag.AddCombo(\"labelPosition\",\"Position\",\"\",pos)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 44;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Size");
 //BA.debugLineNum = 45;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"100\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("width","Width","100");
 //BA.debugLineNum = 46;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("height","Height","");
 //BA.debugLineNum = 47;BA.debugLine="Bag.AddLabel(\"Details\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Details");
 //BA.debugLineNum = 48;BA.debugLine="Bag.AddTextBox(\"value\", \"Value\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("value","Value","");
 //BA.debugLineNum = 49;BA.debugLine="Bag.AddTextBox(\"name\", \"Name\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("name","Name","");
 //BA.debugLineNum = 50;BA.debugLine="Bag.AddTextBox(\"tooltip\", \"Tooltip\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("tooltip","Tooltip","");
 //BA.debugLineNum = 51;BA.debugLine="Bag.AddTextBox(\"icon\", \"Icon\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("icon","Icon","");
 //BA.debugLineNum = 52;BA.debugLine="Bag.AddTextBox(\"image\", \"Image\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("image","Image","");
 //BA.debugLineNum = 53;BA.debugLine="Bag.AddTextBox(\"batch\", \"Batch\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("batch","Batch","");
 //BA.debugLineNum = 54;BA.debugLine="Bag.AddTextBox(\"popup\", \"PopUp\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("popup","PopUp","");
 //BA.debugLineNum = 55;BA.debugLine="Bag.AddTextBox(\"badge\", \"Badge\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("badge","Badge","");
 //BA.debugLineNum = 56;BA.debugLine="Bag.AddCheckBox(\"autowidth\", \"Auto width \",\"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("autowidth","Auto width ","");
 //BA.debugLineNum = 57;BA.debugLine="Bag.AddLabel(\"Event\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Event");
 //BA.debugLineNum = 58;BA.debugLine="Bag.AddTextBox(\"click\",\"On Click\",\"BANano.CallBac";
_bag._addtextbox /*b4j.example.wixproperty*/ ("click","On Click","BANano.CallBack(Me,button1_click,Null)");
