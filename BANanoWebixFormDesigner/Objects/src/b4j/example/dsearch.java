...
public class dsearch extends Object{
public static dsearch mostCurrent = new dsearch();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dsearch", null);
		ba.loadHtSubs(dsearch.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dsearch", ba);
		}
	}
    public static Class<?> getObject() {
		return dsearch.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"search1\")";
_bag._addtextbox /*String*/ ("id","ID","search1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"search1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","search1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"search\", Page.views)";
_bag._addcombo /*String*/ ("view","View","search",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Search 1\")";
_bag._addtextbox /*String*/ ("label","Text","Search 1");
