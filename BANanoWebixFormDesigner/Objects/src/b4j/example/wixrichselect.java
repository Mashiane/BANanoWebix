...
anywheresoftware.b4a.objects.collections.Map _sug = null;
 //BA.debugLineNum = 100;BA.debugLine="Sub AddOption(sID As String, sValue As String) As";
 //BA.debugLineNum = 101;BA.debugLine="Dim sug As Map = CreateMap()";
_sug = new anywheresoftware.b4a.objects.collections.Map();
_sug = __c.createMap(new Object[] {});
 //BA.debugLineNum = 102;BA.debugLine="sug.Put(\"id\", sID)";
_sug.Put((Object)("id"),(Object)(_sid));
 //BA.debugLineNum = 103;BA.debugLine="sug.Put(\"value\", sValue)";
_sug.Put((Object)("value"),(Object)(_svalue));
 //BA.debugLineNum = 104;BA.debugLine="Options.Add(sug)";
...
public String  _addtocolumns(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Sub AddToColumns(P As WixElement)";
 //BA.debugLineNum = 173;BA.debugLine="P.AddColumns(Item)";
_p._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 174;BA.debugLine="End Sub";
return "";
}
public String  _addtoelements(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Sub AddToElements(P As WixElement)";
 //BA.debugLineNum = 178;BA.debugLine="P.AddElements(Item)";
...
public String  _addtorows(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 167;BA.debugLine="Sub AddToRows(P As WixElement)";
 //BA.debugLineNum = 168;BA.debugLine="P.AddRows(Item)";
...
public b4j.example.wixrichselect  _setaligncenter(String _r) throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Sub SetAlignCenter(r As String) As WixRichSelect '";
 //BA.debugLineNum = 148;BA.debugLine="RichSelect.setAligncenter(\"\")";
...
public b4j.example.wixrichselect  _setalignleft(String _r) throws Exception{
 //BA.debugLineNum = 153;BA.debugLine="Sub SetAlignLeft(r As String) As WixRichSelect 'ig";
 //BA.debugLineNum = 154;BA.debugLine="RichSelect.SetAlignleft(\"\")";
...
public b4j.example.wixrichselect  _setalignright(String _r) throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Sub SetAlignRight(r As String) As WixRichSelect 'i";
 //BA.debugLineNum = 142;BA.debugLine="RichSelect.setAlignright(\"\")";
...
public b4j.example.wixrichselect  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 115;BA.debugLine="Sub SetLabel(l As String) As WixRichSelect";
 //BA.debugLineNum = 116;BA.debugLine="RichSelect.SetLabel(l)";
...
public b4j.example.wixrichselect  _setlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 122;BA.debugLine="Sub SetLabelAlign(a As String) As WixRichSelect";
 //BA.debugLineNum = 123;BA.debugLine="RichSelect.SetLabelAlign(a)";
...
public b4j.example.wixrichselect  _setlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub SetLabelPosition(p As String) As WixRichSelect";
 //BA.debugLineNum = 129;BA.debugLine="RichSelect.SetLabelPosition(p)";
...
public b4j.example.wixrichselect  _setlabelwidth(int _w) throws Exception{
 //BA.debugLineNum = 134;BA.debugLine="Sub SetLabelWidth(w As Int) As WixRichSelect";
 //BA.debugLineNum = 135;BA.debugLine="RichSelect.SetLabelWidth(w)";
...
public b4j.example.wixrichselect  _setsuggest(Object _s) throws Exception{
 //BA.debugLineNum = 160;BA.debugLine="Sub SetSuggest(s As Object) As WixRichSelect";
 //BA.debugLineNum = 161;BA.debugLine="RichSelect.setSuggest(s)";
...
public b4j.example.wixrichselect  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 109;BA.debugLine="Sub SetValue(v As String) As WixRichSelect";
 //BA.debugLineNum = 110;BA.debugLine="RichSelect.SetValue(v)";
