...
_typ.Initialize();
 //BA.debugLineNum = 16;BA.debugLine="typ.AddAll(Array(\"text\",\"password\",\"email\"))";
_typ.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)("text"),(Object)("password"),(Object)("email")}));
...
_bag._addtextbox /*String*/ ("id","ID","text1");
 //BA.debugLineNum = 28;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"text1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","text1");
...
_bag._addcombo /*String*/ ("view","View","text",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddCombo(\"type\",\"Type\", \"text\", typ)";
_bag._addcombo /*String*/ ("type","Type","text",_typ);
...
_bag._addtextbox /*String*/ ("label","Text","Text 1");
...
_bag._addcombo /*String*/ ("inputAlign","Input Align","",_align);
 //BA.debugLineNum = 58;BA.debugLine="Bag.AddTextBox(\"format\", \"Format\", \"\")";
_bag._addtextbox /*String*/ ("format","Format","");
 //BA.debugLineNum = 59;BA.debugLine="Bag.AddTextBox(\"pattern\", \"Pattern\", \"\")";
_bag._addtextbox /*String*/ ("pattern","Pattern","");
