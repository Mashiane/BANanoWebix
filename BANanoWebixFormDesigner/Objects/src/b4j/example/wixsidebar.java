...
public b4j.example.wixsidebar  _setscroll(Object _b) throws Exception{
 ...
 //BA.debugLineNum = 205;BA.debugLine="SideBar.SetProperty(\"scroll\", b)";
_sidebar._setproperty /*b4j.example.wixelement*/ ("scroll",_b);
...
public b4j.example.wixsidebar  _setselect(boolean _b) throws Exception{
 ...
 //BA.debugLineNum = 199;BA.debugLine="SideBar.SetProperty(\"select\", b)";
