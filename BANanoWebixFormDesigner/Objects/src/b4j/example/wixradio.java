...
anywheresoftware.b4a.objects.collections.Map _sug = null;
 //BA.debugLineNum = 96;BA.debugLine="Sub AddOption(sID As String, sValue As String) As";
 //BA.debugLineNum = 97;BA.debugLine="Dim sug As Map = CreateMap()";
_sug = new anywheresoftware.b4a.objects.collections.Map();
_sug = __c.createMap(new Object[] {});
 //BA.debugLineNum = 98;BA.debugLine="sug.Put(\"id\", sID)";
_sug.Put((Object)("id"),(Object)(_sid));
 //BA.debugLineNum = 99;BA.debugLine="sug.Put(\"value\", sValue)";
_sug.Put((Object)("value"),(Object)(_svalue));
 //BA.debugLineNum = 100;BA.debugLine="Options.Add(sug)";
...
public b4j.example.wixradio  _setaligncenter(String _r) throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Sub SetAlignCenter(r As String) As WixRadio 'ignor";
 //BA.debugLineNum = 150;BA.debugLine="Radio.setAligncenter(\"\")";
...
public b4j.example.wixradio  _setalignleft(String _r) throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub SetAlignLeft(r As String) As WixRadio 'ignore";
 //BA.debugLineNum = 156;BA.debugLine="Radio.SetAlignleft(\"\")";
...
public b4j.example.wixradio  _setalignright(String _r) throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub SetAlignRight(r As String) As WixRadio 'ignore";
 //BA.debugLineNum = 144;BA.debugLine="Radio.setAlignright(\"\")";
...
public b4j.example.wixradio  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 111;BA.debugLine="Sub SetLabel(l As String) As WixRadio";
 //BA.debugLineNum = 112;BA.debugLine="Radio.SetLabel(l)";
...
public b4j.example.wixradio  _setlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 124;BA.debugLine="Sub SetLabelAlign(a As String) As WixRadio";
 //BA.debugLineNum = 125;BA.debugLine="Radio.SetLabelAlign(a)";
...
public b4j.example.wixradio  _setlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 130;BA.debugLine="Sub SetLabelPosition(p As String) As WixRadio";
 //BA.debugLineNum = 131;BA.debugLine="Radio.SetLabelPosition(p)";
...
public b4j.example.wixradio  _setlabelwidth(int _w) throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Sub SetLabelWidth(w As Int) As WixRadio";
 //BA.debugLineNum = 137;BA.debugLine="Radio.SetLabelWidth(w)";
...
public b4j.example.wixradio  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Sub SetValue(v As String) As WixRadio";
 //BA.debugLineNum = 106;BA.debugLine="Radio.SetValue(v)";
...
public b4j.example.wixradio  _setvertical(boolean _b) throws Exception{
 //BA.debugLineNum = 117;BA.debugLine="Sub SetVertical(b As Boolean) As WixRadio";
 //BA.debugLineNum = 118;BA.debugLine="Vertical = b";
_vertical = _b;
