...
_tblbar._addspacer /*b4j.example.wixtoolbar*/ ();
 //BA.debugLineNum = 12;BA.debugLine="tblBar.createicon(\"multi\").SetIcon(\"mdi mdi-share";
_tblbar._createicon /*b4j.example.wixicon*/ ("multi")._seticon /*b4j.example.wixicon*/ ((Object)("mdi mdi-share-variant"))._settooltip /*b4j.example.wixicon*/ ("Add multiple elements")._setclick /*b4j.example.wixicon*/ ((com.ab.banano.BANanoObject)(_banano.CallBack((Object)(_pgformdesigner.getObject()),"multiels",(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)))))._pop /*String*/ ();
...
_tblbar._createicon /*b4j.example.wixicon*/ ("refresh")._seticon /*b4j.example.wixicon*/ ((Object)("mdi mdi-refresh"))._settooltip /*b4j.example.wixicon*/ ("Refresh tree")._setclick /*b4j.example.wixicon*/ ((com.ab.banano.BANanoObject)(_banano.CallBack((Object)(_pgformdesigner.getObject()),"refreshapp",(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)))))._pop /*String*/ ();
 //BA.debugLineNum = 14;BA.debugLine="tblBar.CreateIcon(\"clearform\").SetIcon(\"mdi mdi-t";
_tblbar._createicon /*b4j.example.wixicon*/ ("clearform")._seticon /*b4j.example.wixicon*/ ((Object)("mdi mdi-trash-can"))._settooltip /*b4j.example.wixicon*/ ("Clear form")._setclick /*b4j.example.wixicon*/ ((com.ab.banano.BANanoObject)(_banano.CallBack((Object)(_pgformdesigner.getObject()),"clearform",(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)))))._pop /*String*/ ();
...
_tblbar._createicon /*b4j.example.wixicon*/ ("help")._seticon /*b4j.example.wixicon*/ ((Object)("mdi mdi-help"))._settooltip /*b4j.example.wixicon*/ ("Hints")._setclick /*b4j.example.wixicon*/ ((com.ab.banano.BANanoObject)(_banano.CallBack((Object)(_pgformdesigner.getObject()),"showhints",(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)))))._pop /*String*/ ();
 //BA.debugLineNum = 18;BA.debugLine="tblBar.setPadding(3)";
_tblbar._setpadding /*b4j.example.wixtoolbar*/ (BA.NumberToString(3));
 //BA.debugLineNum = 19;BA.debugLine="Return tblBar";
