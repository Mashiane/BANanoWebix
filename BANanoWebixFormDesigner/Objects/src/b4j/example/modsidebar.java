...
_sm._initialize /*b4j.example.wixsidebar*/ (ba,"smp")._setcollapsed /*b4j.example.wixsidebar*/ (anywheresoftware.b4a.keywords.Common.False)._setactivetitle /*b4j.example.wixsidebar*/ (anywheresoftware.b4a.keywords.Common.True)._setscroll /*b4j.example.wixsidebar*/ ((Object)(anywheresoftware.b4a.keywords.Common.True))._setselect /*b4j.example.wixsidebar*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 20;BA.debugLine="sm.AddItem(\"\",\"downloads\",\"Downloads\",\"\",\"\",\"\",\"\"";
_sm._additem /*b4j.example.wixsidebar*/ ("","downloads","Downloads","","","","");
 //BA.debugLineNum = 21;BA.debugLine="sm.AddItem(\"downloads\", \"b4xlib\",\"B4X Lib\",\"https";
_sm._additem /*b4j.example.wixsidebar*/ ("downloads","b4xlib","B4X Lib","https://github.com/Mashiane/BANanoWebix/raw/master/BANanoWebix.b4xlib","mdi mdi-cloud-download-outline","","_blank");
 //BA.debugLineNum = 22;BA.debugLine="sm.AddItem(\"downloads\", \"skeletonapp\", \"Skeleton";
_sm._additem /*b4j.example.wixsidebar*/ ("downloads","skeletonapp","Skeleton App","./assets/app.zip","mdi mdi-apps","","_blank");
