...
_bag._addtextbox /*String*/ ("id","ID","table");
 //BA.debugLineNum = 14;BA.debugLine="Bag.AddTextBox(\"value\", \"Table Name\",\"table1\")";
_bag._addtextbox /*String*/ ("value","Table Name","table1");
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"primarykey\", \"Primary Field\", \"id";
_bag._addtextbox /*String*/ ("primarykey","Primary Field","id");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddCombo(\"type\", \"Field Type\",\"INT\", types)";
_bag._addcombo /*String*/ ("type","Field Type","INT",_types);
 //BA.debugLineNum = 17;BA.debugLine="Bag.AddCheckBox(\"autoincrement\", \"Auto Increment\"";
_bag._addcheckbox /*String*/ ("autoincrement","Auto Increment",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False));
