...
public b4j.example.wixcolumn  _addcolumns(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 98;BA.debugLine="Sub AddColumns(itm As Map) As WixColumn";
 //BA.debugLineNum = 99;BA.debugLine="Column.AddColumns(itm)";
...
public String  _additem(anywheresoftware.b4a.objects.collections.Map _wxel) throws Exception{
 //BA.debugLineNum = 109;BA.debugLine="Sub AddItem(wxEL As Map)";
 //BA.debugLineNum = 110;BA.debugLine="Column.AddColumns(wxEL)";
_column._addcolumns /*b4j.example.wixelement*/ (_wxel);
 //BA.debugLineNum = 111;BA.debugLine="End Sub";
return "";
}
public b4j.example.wixcolumn  _addresizertocolumns(String _s) throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Sub AddResizerToColumns(s As String) As WixColumn";
 //BA.debugLineNum = 39;BA.debugLine="Column.AddResizerToColumns(s)";
_column._addresizertocolumns /*b4j.example.wixelement*/ (_s);
 //BA.debugLineNum = 40;BA.debugLine="End Sub";
return null;
}
public b4j.example.wixcolumn  _addresizertorows(String _s) throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub AddResizerToRows(s As String) As WixColumn   '";
 //BA.debugLineNum = 35;BA.debugLine="Column.AddResizerToRows(s)";
_column._addresizertorows /*b4j.example.wixelement*/ (_s);
...
public String  _addtocolumns(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Sub AddToColumns(P As WixElement)";
 //BA.debugLineNum = 150;BA.debugLine="P.AddColumns(Item)";
_p._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 151;BA.debugLine="End Sub";
return "";
}
public String  _addtoelements(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 154;BA.debugLine="Sub AddToElements(P As WixElement)";
 //BA.debugLineNum = 155;BA.debugLine="P.AddElements(Item)";
...
public String  _addtorow(b4j.example.wixrow _r) throws Exception{
 //BA.debugLineNum = 120;BA.debugLine="Sub AddToRow(r As WixRow)";
 //BA.debugLineNum = 121;BA.debugLine="r.Row.AddColumns(Item)";
_r._row /*b4j.example.wixelement*/ ._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 122;BA.debugLine="End Sub";
return "";
}
public String  _addtorows(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 144;BA.debugLine="Sub AddToRows(P As WixElement)";
 //BA.debugLineNum = 145;BA.debugLine="P.AddRows(Item)";
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub Item As Map";
 //BA.debugLineNum = 105;BA.debugLine="Return Column.item";
...
public b4j.example.wixcolumn  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Sub SetHeight(h As Object) As WixColumn";
 //BA.debugLineNum = 126;BA.debugLine="Column.SetHeight(h)";
...
String _strkey = "";
String _strval = "";
 //BA.debugLineNum = 88;BA.debugLine="Sub SetMap(m As Map) As WixColumn";
...
_strval = BA.ObjectToString(_m.Get((Object)(_strkey)));
 //BA.debugLineNum = 91;BA.debugLine="Column.SetAttr(strKey,	strVal)";
...
public b4j.example.wixcolumn  _setmargin(Object _margin) throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub SetMargin(margin As Object) As WixColumn";
 //BA.debugLineNum = 45;BA.debugLine="Column.SetMargin(margin)";
...
public b4j.example.wixcolumn  _setminheight(int _h) throws Exception{
 //BA.debugLineNum = 76;BA.debugLine="Sub SetMinHeight(h As Int) As WixColumn";
 //BA.debugLineNum = 77;BA.debugLine="Column.SetMinHeight(h)";
...
public b4j.example.wixcolumn  _setminwidth(int _w) throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Sub SetMinWidth(w As Int) As WixColumn";
 //BA.debugLineNum = 71;BA.debugLine="Column.SetMinWidth(w)";
...
public b4j.example.wixcolumn  _setname(String _n) throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub SetName(n As String) As WixColumn";
 //BA.debugLineNum = 52;BA.debugLine="Column.SetName(n)";
...
public b4j.example.wixcolumn  _setresponsive(Object _b) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub SetResponsive(b As Object) As WixColumn";
 //BA.debugLineNum = 58;BA.debugLine="Column.SetResponsive(b)";
...
public b4j.example.wixcolumn  _setresponsivecell(Object _b) throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub SetResponsiveCell(b As Object) As WixColumn";
 //BA.debugLineNum = 64;BA.debugLine="Column.SetResponsiveCell(b)";
...
public b4j.example.wixcolumn  _settemplate(String _t) throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Sub SetTemplate(t As String) As WixColumn";
 //BA.debugLineNum = 138;BA.debugLine="Column.SetTemplate(t)";
...
public b4j.example.wixcolumn  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 82;BA.debugLine="Sub SetTooltip(tt As String) As WixColumn";
 //BA.debugLineNum = 83;BA.debugLine="Column.SetTooltip(tt)";
...
public b4j.example.wixcolumn  _setwidth(Object _w) throws Exception{
 //BA.debugLineNum = 131;BA.debugLine="Sub SetWidth(w As Object) As WixColumn";
 //BA.debugLineNum = 132;BA.debugLine="Column.SetWidth(w)";
