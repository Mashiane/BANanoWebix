...
public class drichselect extends Object{
public static drichselect mostCurrent = new drichselect();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.drichselect", null);
		ba.loadHtSubs(drichselect.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.drichselect", ba);
		}
	}
    public static Class<?> getObject() {
		return drichselect.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"richselect1\")";
_bag._addtextbox /*String*/ ("id","ID","richselect1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"richselect";
_bag._addtextbox /*String*/ ("localId","Local ID","richselect1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"richselect\", Page.vi";
_bag._addcombo /*String*/ ("view","View","richselect",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Richselect 1\")";
_bag._addtextbox /*String*/ ("label","Text","Richselect 1");
...
_bag._addlabel /*String*/ ("Options");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"optionsid\",\"IDs\", \"1,2,3\")";
_bag._addtextbox /*String*/ ("optionsid","IDs","1,2,3");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddTextBox(\"optionstext\",\"Values\", \"One,Two,T";
