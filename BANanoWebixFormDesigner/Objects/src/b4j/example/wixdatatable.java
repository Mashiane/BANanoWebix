...
public String  _addcolumns(b4j.example.wixdatacolumn _c) throws Exception{
 //BA.debugLineNum = 228;BA.debugLine="Sub AddColumns(c As WixDataColumn)";
 //BA.debugLineNum = 229;BA.debugLine="DataTable.AddDataColumn(c.Item)";
...
b4j.example.wixdatacolumn _d = null;
 //BA.debugLineNum = 180;BA.debugLine="Sub AddEditTrash";
 //BA.debugLineNum = 181;BA.debugLine="Dim e As WixDataColumn = CreateColumn(\"edit\").Set";
_e = _createcolumn("edit")._setheader /*b4j.example.wixdatacolumn*/ ((Object)("Edit"))._settemplate /*b4j.example.wixdatacolumn*/ ((Object)("{common.editIcon()}"))._setwidth /*b4j.example.wixdatacolumn*/ ((Object)(100));
 //BA.debugLineNum = 182;BA.debugLine="Dim d As WixDataColumn = CreateColumn(\"delete\").S";
_d = _createcolumn("delete")._setheader /*b4j.example.wixdatacolumn*/ ((Object)("Delete"))._settemplate /*b4j.example.wixdatacolumn*/ ((Object)("{common.trashIcon()}"))._setwidth /*b4j.example.wixdatacolumn*/ ((Object)(100));
 //BA.debugLineNum = 183;BA.debugLine="DataTable.AddDataColumn(e.Item)";
_datatable._adddatacolumn /*b4j.example.wixelement*/ (_e._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 184;BA.debugLine="DataTable.AddDataColumn(d.item)";
...
public String  _addtocolumns(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 376;BA.debugLine="Sub AddToColumns(P As WixElement)";
 //BA.debugLineNum = 377;BA.debugLine="P.AddColumns(Item)";
_p._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 378;BA.debugLine="End Sub";
return "";
}
public String  _addtoelements(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 381;BA.debugLine="Sub AddToElements(P As WixElement)";
 //BA.debugLineNum = 382;BA.debugLine="P.AddElements(Item)";
_p._addelements /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 383;BA.debugLine="End Sub";
return "";
}
public String  _addtoform(b4j.example.wixform _frm) throws Exception{
 //BA.debugLineNum = 359;BA.debugLine="Sub AddToForm(frm As WixForm)";
 //BA.debugLineNum = 360;BA.debugLine="frm.AddItem(Item)";
_frm._additem /*String*/ (_item());
 //BA.debugLineNum = 361;BA.debugLine="End Sub";
return "";
}
public String  _addtorows(b4j.example.wixelement _p) throws Exception{
 //BA.debugLineNum = 371;BA.debugLine="Sub AddToRows(P As WixElement)";
 //BA.debugLineNum = 372;BA.debugLine="P.AddRows(Item)";
...
b4j.example.wixdatacolumn _hdr = null;
 //BA.debugLineNum = 270;BA.debugLine="Sub CreateColumn(hid As String) As WixDataColumn";
 //BA.debugLineNum = 271;BA.debugLine="Dim hdr As WixDataColumn";
_hdr = new b4j.example.wixdatacolumn();
 //BA.debugLineNum = 272;BA.debugLine="hdr.Initialize(hid)";
_hdr._initialize /*b4j.example.wixdatacolumn*/ (ba,_hid);
 //BA.debugLineNum = 273;BA.debugLine="Return hdr";
if (true) return _hdr;
...
innerInitialize(_ba);
 //BA.debugLineNum = 219;BA.debugLine="Public Sub Initialize(tID As String) As WixDataTab";
 //BA.debugLineNum = 220;BA.debugLine="ID = tID.ToLowerCase";
_id = _tid.toLowerCase();
 //BA.debugLineNum = 221;BA.debugLine="DataTable.Initialize(ID).SetView(\"datatable\")";
_datatable._initialize /*b4j.example.wixelement*/ (ba,_id)._setview /*b4j.example.wixelement*/ ("datatable");
 //BA.debugLineNum = 222;BA.debugLine="AutoConfig = False";
_autoconfig = __c.False;
 //BA.debugLineNum = 223;BA.debugLine="Rules.Initialize";
_rules.Initialize();
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 //BA.debugLineNum = 332;BA.debugLine="Sub Item As Map";
 //BA.debugLineNum = 333;BA.debugLine="If Rules.Size > 0 Then";
if (_rules.getSize()>0) { 
 //BA.debugLineNum = 334;BA.debugLine="DataTable.SetProperty(\"rules\", Rules)";
_datatable._setproperty /*b4j.example.wixelement*/ ("rules",(Object)(_rules.getObject()));
 };
 //BA.debugLineNum = 336;BA.debugLine="DataTable.SetAttr(\"autoConfig\", AutoConfig)";
_datatable._setattr /*b4j.example.wixelement*/ ("autoConfig",(Object)(_autoconfig));
 //BA.debugLineNum = 337;BA.debugLine="Return DataTable.item";
...
public b4j.example.wixdatatable  _setautoconfig(boolean _a) throws Exception{
 //BA.debugLineNum = 341;BA.debugLine="Sub SetAutoConfig(a As Boolean) As WixDataTable";
 //BA.debugLineNum = 342;BA.debugLine="AutoConfig = a";
_autoconfig = _a;
...
public b4j.example.wixdatatable  _setautoheight(boolean _b) throws Exception{
 //BA.debugLineNum = 258;BA.debugLine="Sub SetAutoHeight(b As Boolean) As WixDataTable";
 //BA.debugLineNum = 259;BA.debugLine="DataTable.SetAttr(\"autoheight\", b)";
...
public b4j.example.wixdatatable  _setautowidth(boolean _b) throws Exception{
 //BA.debugLineNum = 264;BA.debugLine="Sub SetAutoWidth(b As Boolean) As WixDataTable";
 //BA.debugLineNum = 265;BA.debugLine="DataTable.SetAttr(\"autowidth\", b)";
...
public b4j.example.wixdatatable  _setblockselect(boolean _b) throws Exception{
 //BA.debugLineNum = 295;BA.debugLine="Sub SetBlockSelect(b As Boolean) As WixDataTable";
 //BA.debugLineNum = 296;BA.debugLine="DataTable.SetAttr(\"blockselect\", b)";
...
public b4j.example.wixdatatable  _setborderless(boolean _b) throws Exception{
 //BA.debugLineNum = 307;BA.debugLine="Sub SetBorderLess(b As Boolean) As WixDataTable";
 //BA.debugLineNum = 308;BA.debugLine="DataTable.SetAttr(\"borderless\", b)";
...
public b4j.example.wixdatatable  _setcolumnwidth(int _w) throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Sub SetColumnWidth(w As Int) As WixDataTable";
 //BA.debugLineNum = 175;BA.debugLine="DataTable.SetAttr(\"columnWidth\", w)";
...
public b4j.example.wixdatatable  _setcontainer(String _c) throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Sub SetContainer(c As String) As WixDataTable";
 //BA.debugLineNum = 214;BA.debugLine="DataTable.SetAttr(\"container\", c)";
...
public b4j.example.wixdatatable  _setdata(anywheresoftware.b4a.objects.collections.List _data) throws Exception{
 //BA.debugLineNum = 364;BA.debugLine="Sub SetData(data As List) As WixDataTable";
 //BA.debugLineNum = 365;BA.debugLine="DataTable.SetData(data)";
...
public b4j.example.wixdatatable  _setdatatype(String _t) throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Sub SetDataType(t As String) As WixDataTable";
 //BA.debugLineNum = 241;BA.debugLine="DataTable.SetAttr(\"datatype\", t)";
...
public b4j.example.wixdatatable  _seteditable(boolean _b) throws Exception{
 //BA.debugLineNum = 320;BA.debugLine="Sub SetEditable(b As Boolean) As WixDataTable";
 //BA.debugLineNum = 321;BA.debugLine="DataTable.SetAttr(\"editable\", b)";
...
public b4j.example.wixdatatable  _seteditaction(String _a) throws Exception{
 //BA.debugLineNum = 301;BA.debugLine="Sub SetEditAction(a As String) As WixDataTable";
 //BA.debugLineNum = 302;BA.debugLine="DataTable.SetAttr(\"editaction\", a)";
...
public b4j.example.wixdatatable  _setform(String _frmid) throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub SetForm(frmID As String) As WixDataTable";
 //BA.debugLineNum = 167;BA.debugLine="frmID = frmID.ToLowerCase";
_frmid = _frmid.toLowerCase();
 //BA.debugLineNum = 168;BA.debugLine="DataTable.SetAttr(\"form\", frmID)";
...
public b4j.example.wixdatatable  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 347;BA.debugLine="Sub SetHeight(h As Object) As WixDataTable";
 //BA.debugLineNum = 348;BA.debugLine="DataTable.SetHeight(h)";
...
public b4j.example.wixdatatable  _sethover(String _h) throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub SetHover(h As String) As WixDataTable";
 //BA.debugLineNum = 189;BA.debugLine="DataTable.SetAttr(\"hover\", h)";
...
public b4j.example.wixdatatable  _setleftsplit(int _c) throws Exception{
 //BA.debugLineNum = 289;BA.debugLine="Sub SetLeftSplit(c As Int) As WixDataTable";
 //BA.debugLineNum = 290;BA.debugLine="DataTable.SetAttr(\"leftSplit\", c)";
...
String _strkey = "";
String _strval = "";
 //BA.debugLineNum = 125;BA.debugLine="Sub SetMap(m As Map) As WixDataTable";
 //BA.debugLineNum = 126;BA.debugLine="For Each strKey As String In m.Keys";
{
...
_strkey = BA.ObjectToString(group1.Get(index1));
 //BA.debugLineNum = 127;BA.debugLine="Dim strVal As String = m.Get(strKey)";
_strval = BA.ObjectToString(_m.Get((Object)(_strkey)));
 //BA.debugLineNum = 128;BA.debugLine="DataTable.SetAttr(strKey,	strVal)";
...
public b4j.example.wixdatatable  _setminheight(int _h) throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub SetMinHeight(h As Int) As WixDataTable";
 //BA.debugLineNum = 100;BA.debugLine="DataTable.SetMinHeight(h)";
...
public b4j.example.wixdatatable  _setminwidth(int _w) throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Sub SetMinWidth(w As Int) As WixDataTable";
 //BA.debugLineNum = 94;BA.debugLine="DataTable.SetMinWidth(w)";
...
public b4j.example.wixdatatable  _setmultiselect(Object _s) throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub SetMultiSelect(s As Object) As WixDataTable";
 //BA.debugLineNum = 207;BA.debugLine="DataTable.SetAttr(\"multiselect\", s)";
...
public b4j.example.wixdatatable  _setname(String _n) throws Exception{
 //BA.debugLineNum = 74;BA.debugLine="Sub SetName(n As String) As WixDataTable";
 //BA.debugLineNum = 75;BA.debugLine="DataTable.SetName(n)";
...
public b4j.example.wixdatatable  _setnavigation(Object _b) throws Exception{
 //BA.debugLineNum = 112;BA.debugLine="Sub SetNavigation(b As Object) As WixDataTable";
 //BA.debugLineNum = 113;BA.debugLine="DataTable.SetAttr(\"navigation\", b)";
...
public b4j.example.wixdatatable  _setpager(String _p) throws Exception{
 //BA.debugLineNum = 135;BA.debugLine="Sub SetPager(p As String) As WixDataTable";
 //BA.debugLineNum = 136;BA.debugLine="p = p.tolowercase";
_p = _p.toLowerCase();
 //BA.debugLineNum = 137;BA.debugLine="DataTable.SetAttr(\"pager\", p)";
...
public b4j.example.wixdatatable  _setresizecolumn(boolean _b) throws Exception{
 //BA.debugLineNum = 160;BA.debugLine="Sub SetResizeColumn(b As Boolean) As WixDataTable";
 //BA.debugLineNum = 161;BA.debugLine="DataTable.SetAttr(\"resizeColumn\", b)";
...
public b4j.example.wixdatatable  _setresizerow(boolean _b) throws Exception{
 //BA.debugLineNum = 154;BA.debugLine="Sub SetResizeRow(b As Boolean) As WixDataTable";
 //BA.debugLineNum = 155;BA.debugLine="DataTable.SetAttr(\"resizeRow\", b)";
...
public b4j.example.wixdatatable  _setresponsive(Object _b) throws Exception{
 //BA.debugLineNum = 80;BA.debugLine="Sub SetResponsive(b As Object) As WixDataTable";
 //BA.debugLineNum = 81;BA.debugLine="DataTable.SetResponsive(b)";
...
public b4j.example.wixdatatable  _setresponsivecell(Object _b) throws Exception{
 //BA.debugLineNum = 86;BA.debugLine="Sub SetResponsiveCell(b As Object) As WixDataTable";
 //BA.debugLineNum = 87;BA.debugLine="DataTable.SetResponsiveCell(b)";
...
public b4j.example.wixdatatable  _setrightsplit(int _r) throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub SetRightSplit(r As Int) As WixDataTable";
 //BA.debugLineNum = 195;BA.debugLine="DataTable.SetAttr(\"rightSplit\", r)";
...
public b4j.example.wixdatatable  _setrowheight(int _h) throws Exception{
 //BA.debugLineNum = 277;BA.debugLine="Sub SetRowHeight(h As Int) As WixDataTable";
 //BA.debugLineNum = 278;BA.debugLine="DataTable.SetAttr(\"rowHeight\", h)";
...
public b4j.example.wixdatatable  _setscroll(Object _b) throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Sub SetScroll(b As Object) As WixDataTable";
 //BA.debugLineNum = 235;BA.debugLine="DataTable.SetAttr(\"scroll\", b)";
...
public b4j.example.wixdatatable  _setscrollx(Object _b) throws Exception{
 //BA.debugLineNum = 148;BA.debugLine="Sub SetScrollX(b As Object) As WixDataTable";
 //BA.debugLineNum = 149;BA.debugLine="DataTable.SetAttr(\"scrollX\", b)";
...
public b4j.example.wixdatatable  _setscrolly(Object _b) throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Sub SetScrollY(b As Object) As WixDataTable";
 //BA.debugLineNum = 143;BA.debugLine="DataTable.SetAttr(\"scrollY\", b)";
...
public b4j.example.wixdatatable  _setselect(Object _s) throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub SetSelect(s As Object) As WixDataTable";
 //BA.debugLineNum = 201;BA.debugLine="DataTable.SetAttr(\"select\", s)";
...
public b4j.example.wixdatatable  _setstyle(String _prop,String _val) throws Exception{
 //BA.debugLineNum = 314;BA.debugLine="Sub SetStyle(prop As String, val As String) As Wix";
 //BA.debugLineNum = 315;BA.debugLine="DataTable.SetStyle(prop,val)";
...
public b4j.example.wixdatatable  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 326;BA.debugLine="Sub SetTooltip(tt As String) As WixDataTable";
 //BA.debugLineNum = 327;BA.debugLine="DataTable.SetTooltip(tt)";
...
public b4j.example.wixdatatable  _settopsplit(int _r) throws Exception{
 //BA.debugLineNum = 283;BA.debugLine="Sub SetTopSplit(r As Int) As WixDataTable";
 //BA.debugLineNum = 284;BA.debugLine="DataTable.SetAttr(\"topSplit\", r)";
...
public b4j.example.wixdatatable  _seturl(String _u) throws Exception{
 //BA.debugLineNum = 252;BA.debugLine="Sub SetURL(u As String) As WixDataTable";
 //BA.debugLineNum = 253;BA.debugLine="DataTable.SetAttr(\"url\", u)";
...
public b4j.example.wixdatatable  _setvisiblebatch(int _b) throws Exception{
 //BA.debugLineNum = 246;BA.debugLine="Sub SetVisibleBatch(b As Int) As WixDataTable";
 //BA.debugLineNum = 247;BA.debugLine="DataTable.SetAttr(\"visibleBatch\", b)";
...
public b4j.example.wixdatatable  _setwidth(Object _h) throws Exception{
 //BA.debugLineNum = 353;BA.debugLine="Sub SetWidth(h As Object) As WixDataTable";
 //BA.debugLineNum = 354;BA.debugLine="DataTable.SetWidth(h)";
...
public b4j.example.wixdatatable  _setxcount(int _x) throws Exception{
 //BA.debugLineNum = 119;BA.debugLine="Sub SetXCount(x As Int) As WixDataTable";
 //BA.debugLineNum = 120;BA.debugLine="DataTable.SetAttr(\"xCount\", x)";
...
public b4j.example.wixdatatable  _setycount(int _x) throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Sub SetYCount(x As Int) As WixDataTable";
 //BA.debugLineNum = 106;BA.debugLine="DataTable.SetAttr(\"yCount\", x)";
