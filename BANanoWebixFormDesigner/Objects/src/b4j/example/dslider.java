...
public class dslider extends Object{
public static dslider mostCurrent = new dslider();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dslider", null);
		ba.loadHtSubs(dslider.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dslider", ba);
		}
	}
    public static Class<?> getObject() {
		return dslider.class;
	}
...
_bag._clear /*b4j.example.wixproperty*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"slider1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","slider1");
...
_bag._addlabel /*b4j.example.wixproperty*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"slider\", Page.views)";
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","slider",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 23;BA.debugLine="Bag.AddLabel(\"Details\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Details");
 //BA.debugLineNum = 24;BA.debugLine="Bag.AddTextBox(\"value\", \"Value\",\"43\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("value","Value","43");
 //BA.debugLineNum = 25;BA.debugLine="Bag.AddTextBox(\"title\", \"Title\", \"#value#\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("title","Title","#value#");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddTextBox(\"name\", \"Name\",\"\")";
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("batch","Batch","");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddCheckBox(\"vertical\", \"Vertical\", \"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("vertical","Vertical","");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddLabel(\"Label\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Label");
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Slider 1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","Slider 1");
 //BA.debugLineNum = 32;BA.debugLine="Bag.AddTextBox(\"labelWidth\",\"Width\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelWidth","Width","");
 //BA.debugLineNum = 33;BA.debugLine="Bag.AddTextBox(\"labelHeight\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelHeight","Height","");
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddCombo(\"labelAlign\",\"Align\",\"\",align)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelAlign","Align","",_align);
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddCombo(\"labelPosition\",\"Position\",\"\",pos)";
...
_bag._addlabel /*b4j.example.wixproperty*/ ("Options");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddTextBox(\"min\",\"Min\", \"0\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("min","Min","0");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"max\",\"Max\", \"100\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("max","Max","100");
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddTextBox(\"step\",\"Step\", \"1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("step","Step","1");
 //BA.debugLineNum = 41;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Size");
 //BA.debugLineNum = 42;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"200\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("width","Width","200");
 //BA.debugLineNum = 43;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("height","Height","");
 //BA.debugLineNum = 47;BA.debugLine="Bag.Refresh(Page)";
