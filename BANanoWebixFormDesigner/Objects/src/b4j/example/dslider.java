...
_bag._addtextbox /*String*/ ("id","ID","slider1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"slider1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","slider1");
...
_bag._addcombo /*String*/ ("view","View","slider",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*String*/ ("value","Value","43");
 //BA.debugLineNum = 25;BA.debugLine="Bag.AddTextBox(\"title\", \"Title\", \"#value#\")";
_bag._addtextbox /*String*/ ("title","Title","#value#");
...
_bag._addcheckbox /*String*/ ("vertical","Vertical","");
...
_bag._addtextbox /*String*/ ("label","Text","Slider 1");
...
_bag._addtextbox /*String*/ ("width","Width","200");
