...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","select1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","select",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","Select 1");
