...
public class dselect extends Object{
public static dselect mostCurrent = new dselect();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dselect", null);
		ba.loadHtSubs(dselect.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dselect", ba);
		}
	}
    public static Class<?> getObject() {
		return dselect.class;
	}
...
_bag._clear /*String*/ ();
 //BA.debugLineNum = 15;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"select1\")";
_bag._addtextbox /*String*/ ("id","ID","select1");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"select1\")";
_bag._addtextbox /*String*/ ("localId","Local ID","select1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"select\", Page.views)";
_bag._addcombo /*String*/ ("view","View","select",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"Select 1\")";
_bag._addtextbox /*String*/ ("label","Text","Select 1");
