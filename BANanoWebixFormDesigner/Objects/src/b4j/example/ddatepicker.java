...
_bag._addtextbox /*String*/ ("id","ID","datepicker1");
 //BA.debugLineNum = 20;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"datepicker";
_bag._addtextbox /*String*/ ("localId","Local ID","datepicker1");
...
_bag._addcombo /*String*/ ("view","View","datepicker",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*String*/ ("label","Text","DatePicker 1");
...
_bag._addcheckbox /*String*/ ("timepicker","Time Picker","");
 //BA.debugLineNum = 45;BA.debugLine="Bag.AddCombo(\"type\",\"Type\", \"date\", typ)";
_bag._addcombo /*String*/ ("type","Type","date",_typ);
 //BA.debugLineNum = 46;BA.debugLine="Bag.AddTextBox(\"format\",\"Format\", \"%Y-%m-%d\")";
_bag._addtextbox /*String*/ ("format","Format","%Y-%m-%d");
