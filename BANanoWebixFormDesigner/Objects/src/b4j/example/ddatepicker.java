...
public class ddatepicker extends Object{
public static ddatepicker mostCurrent = new ddatepicker();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.ddatepicker", null);
		ba.loadHtSubs(ddatepicker.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.ddatepicker", ba);
		}
	}
    public static Class<?> getObject() {
		return ddatepicker.class;
	}
...
_typ.Initialize();
 //BA.debugLineNum = 16;BA.debugLine="typ.AddAll(Array(\"time\",\"date\"))";
_typ.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)("time"),(Object)("date")}));
 //BA.debugLineNum = 18;BA.debugLine="Bag.Clear";
_bag._clear /*b4j.example.wixproperty*/ ();
 //BA.debugLineNum = 19;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"datepicker1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","datepicker1");
...
_bag._addlabel /*b4j.example.wixproperty*/ ("View");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"datepicker\", Page.vi";
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","datepicker",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 27;BA.debugLine="Bag.AddLabel(\"Details\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Details");
 //BA.debugLineNum = 28;BA.debugLine="Bag.AddTextBox(\"value\", \"Value\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("value","Value","");
 //BA.debugLineNum = 29;BA.debugLine="Bag.AddTextBox(\"name\", \"Name\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("name","Name","");
 //BA.debugLineNum = 30;BA.debugLine="Bag.AddTextBox(\"placeholder\", \"PlaceHolder\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("placeholder","PlaceHolder","");
 //BA.debugLineNum = 31;BA.debugLine="Bag.AddTextBox(\"icon\", \"Icon\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("icon","Icon","");
 //BA.debugLineNum = 32;BA.debugLine="Bag.AddTextBox(\"tooltip\", \"Tooltip\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("tooltip","Tooltip","");
 //BA.debugLineNum = 33;BA.debugLine="Bag.AddTextBox(\"batch\", \"Batch\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("batch","Batch","");
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddLabel(\"Label\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Label");
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"DatePicker 1\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","DatePicker 1");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"labelWidth\",\"Width\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelWidth","Width","");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddTextBox(\"labelHeight\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("labelHeight","Height","");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddCombo(\"labelAlign\",\"Align\",\"\",align)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelAlign","Align","",_align);
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddCombo(\"labelPosition\",\"Position\",\"\",pos)";
_bag._addcombo /*b4j.example.wixproperty*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 40;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Size");
 //BA.debugLineNum = 41;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("width","Width","");
 //BA.debugLineNum = 42;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("height","Height","");
 //BA.debugLineNum = 43;BA.debugLine="Bag.AddLabel(\"Options\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Options");
 //BA.debugLineNum = 44;BA.debugLine="Bag.AddCheckBox(\"timepicker\",\"Time Picker\", \"\")";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("timepicker","Time Picker","");
 //BA.debugLineNum = 45;BA.debugLine="Bag.AddCombo(\"type\",\"Type\", \"date\", typ)";
_bag._addcombo /*b4j.example.wixproperty*/ ("type","Type","date",_typ);
 //BA.debugLineNum = 46;BA.debugLine="Bag.AddTextBox(\"format\",\"Format\", \"%Y-%m-%d\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("format","Format","%Y-%m-%d");
 //BA.debugLineNum = 50;BA.debugLine="Bag.Refresh(Page)";
