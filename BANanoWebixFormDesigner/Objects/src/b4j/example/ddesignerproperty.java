...
_bag._addtextbox /*b4j.example.wixproperty*/ ("Key","Key","");
...
_bag._addlabel /*b4j.example.wixproperty*/ ("Designer Property");
 //BA.debugLineNum = 16;BA.debugLine="Bag.AddTextBox(\"DisplayName\",\"Display Name\", \"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("DisplayName","Display Name","");
 //BA.debugLineNum = 17;BA.debugLine="Bag.AddCombo(\"FieldType\",\"Field Type\",\"AddRows\",";
_bag._addcombo /*b4j.example.wixproperty*/ ("FieldType","Field Type","AddRows",_ft);
 //BA.debugLineNum = 18;BA.debugLine="Bag.AddTextBox(\"DefaultValue\", \"Default Value\", \"";
_bag._addtextbox /*b4j.example.wixproperty*/ ("DefaultValue","Default Value","");
 //BA.debugLineNum = 19;BA.debugLine="Bag.AddTextBox(\"MinRange\",\"Min Range\", \"0\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("MinRange","Min Range","0");
 //BA.debugLineNum = 20;BA.debugLine="Bag.AddTextBox(\"MaxRange\", \"Max Range\", \"100\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("MaxRange","Max Range","100");
 //BA.debugLineNum = 21;BA.debugLine="Bag.AddTextBox(\"List\", \"List\",\"Sunday|Monday|Tues";
_bag._addtextbox /*b4j.example.wixproperty*/ ("List","List","Sunday|Monday|Tuesday");
 //BA.debugLineNum = 22;BA.debugLine="Bag.AddTextBox(\"Description\", \"Description\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("Description","Description","");
 //BA.debugLineNum = 23;BA.debugLine="Bag.AddCheckBox(\"hasSet\", \"Can Set\", True)";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("hasSet","Can Set",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.True));
 //BA.debugLineNum = 24;BA.debugLine="Bag.AddCheckBox(\"hasGet\", \"Can Get\", True)";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("hasGet","Can Get",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.True));
 //BA.debugLineNum = 25;BA.debugLine="Bag.AddLabel(\"Links\")";
_bag._addlabel /*b4j.example.wixproperty*/ ("Links");
 //BA.debugLineNum = 26;BA.debugLine="Bag.AddTextBox(\"attributeName\", \"Attribute\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("attributeName","Attribute","");
 //BA.debugLineNum = 27;BA.debugLine="Bag.AddTextBox(\"className\", \"Class\",\"\")";
_bag._addtextbox /*b4j.example.wixproperty*/ ("className","Class","");
 //BA.debugLineNum = 28;BA.debugLine="Bag.AddCheckBox(\"conditional\", \"Conditional\", Tru";
_bag._addcheckbox /*b4j.example.wixproperty*/ ("conditional","Conditional",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.True));
