...
public class dtextarea extends Object{
public static dtextarea mostCurrent = new dtextarea();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.dtextarea", null);
		ba.loadHtSubs(dtextarea.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.dtextarea", ba);
		}
	}
    public static Class<?> getObject() {
		return dtextarea.class;
	}
...
anywheresoftware.b4a.objects.collections.List _ia = null;
...
_pos.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(""),(Object)("left"),(Object)("top")}));
 //BA.debugLineNum = 14;BA.debugLine="Dim ia As List";
_ia = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 15;BA.debugLine="ia.Initialize";
_ia.Initialize();
 //BA.debugLineNum = 16;BA.debugLine="ia.AddAll(Array(\"\",\"left\", \"right\"))";
_ia.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(""),(Object)("left"),(Object)("right")}));
...
_v.Initialize();
 //BA.debugLineNum = 24;BA.debugLine="v.AddAll(Array(\"\",\"isNotEmpty\",\"isNumber\",\"isEmai";
_v.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(""),(Object)("isNotEmpty"),(Object)("isNumber"),(Object)("isEmail")}));
 //BA.debugLineNum = 26;BA.debugLine="Bag.Clear";
_bag._clear /*String*/ ();
 //BA.debugLineNum = 27;BA.debugLine="Bag.AddTextBox(\"id\", \"ID\",\"textarea1\")";
_bag._addtextbox /*String*/ ("id","ID","textarea1");
 //BA.debugLineNum = 28;BA.debugLine="Bag.AddTextBox(\"localId\", \"Local ID\", \"textarea1\"";
_bag._addtextbox /*String*/ ("localId","Local ID","textarea1");
...
_bag._addlabel /*String*/ ("View");
 //BA.debugLineNum = 34;BA.debugLine="Bag.AddCombo(\"view\",\"View\", \"textarea\", Page.view";
_bag._addcombo /*String*/ ("view","View","textarea",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
 //BA.debugLineNum = 35;BA.debugLine="Bag.AddLabel(\"Details\")";
_bag._addlabel /*String*/ ("Details");
 //BA.debugLineNum = 36;BA.debugLine="Bag.AddTextBox(\"value\", \"Value\",\"\")";
_bag._addtextbox /*String*/ ("value","Value","");
 //BA.debugLineNum = 37;BA.debugLine="Bag.AddTextBox(\"name\", \"Name\",\"\")";
_bag._addtextbox /*String*/ ("name","Name","");
 //BA.debugLineNum = 38;BA.debugLine="Bag.AddTextBox(\"placeholder\", \"PlaceHolder\",\"\")";
_bag._addtextbox /*String*/ ("placeholder","PlaceHolder","");
 //BA.debugLineNum = 39;BA.debugLine="Bag.AddTextBox(\"tooltip\", \"Tooltip\",\"\")";
_bag._addtextbox /*String*/ ("tooltip","Tooltip","");
 //BA.debugLineNum = 40;BA.debugLine="Bag.AddTextBox(\"batch\", \"Batch\",\"\")";
_bag._addtextbox /*String*/ ("batch","Batch","");
 //BA.debugLineNum = 41;BA.debugLine="Bag.AddLabel(\"Label\")";
_bag._addlabel /*String*/ ("Label");
 //BA.debugLineNum = 42;BA.debugLine="Bag.AddTextBox(\"label\",\"Text\",\"TextArea 1\")";
_bag._addtextbox /*String*/ ("label","Text","TextArea 1");
 //BA.debugLineNum = 43;BA.debugLine="Bag.AddTextBox(\"labelWidth\",\"Width\",\"\")";
_bag._addtextbox /*String*/ ("labelWidth","Width","");
 //BA.debugLineNum = 44;BA.debugLine="Bag.AddTextBox(\"labelHeight\",\"Height\",\"\")";
_bag._addtextbox /*String*/ ("labelHeight","Height","");
 //BA.debugLineNum = 45;BA.debugLine="Bag.AddCombo(\"labelAlign\",\"Align\",\"\",align)";
_bag._addcombo /*String*/ ("labelAlign","Align","",_align);
 //BA.debugLineNum = 46;BA.debugLine="Bag.AddCombo(\"labelPosition\",\"Position\",\"\",pos)";
_bag._addcombo /*String*/ ("labelPosition","Position","",_pos);
 //BA.debugLineNum = 47;BA.debugLine="Bag.AddLabel(\"Validation\")";
_bag._addlabel /*String*/ ("Validation");
 //BA.debugLineNum = 48;BA.debugLine="Bag.AddCheckBox(\"required\", \"Required\", \"\")";
_bag._addcheckbox /*String*/ ("required","Required","");
 //BA.debugLineNum = 49;BA.debugLine="Bag.AddCombo(\"validate\", \"Validate\", \"\", v)";
_bag._addcombo /*String*/ ("validate","Validate","",_v);
 //BA.debugLineNum = 50;BA.debugLine="Bag.AddTextBox(\"invalidMessage\", \"Invalid Message";
_bag._addtextbox /*String*/ ("invalidMessage","Invalid Message","");
 //BA.debugLineNum = 51;BA.debugLine="Bag.AddCombo(\"validateEvent\", \"Validate Event\", \"";
_bag._addcombo /*String*/ ("validateEvent","Validate Event","",_ve);
 //BA.debugLineNum = 52;BA.debugLine="Bag.AddTextBox(\"bottomLabel\", \"Bottom Label\", \"\")";
_bag._addtextbox /*String*/ ("bottomLabel","Bottom Label","");
 //BA.debugLineNum = 53;BA.debugLine="Bag.AddTextBox(\"bottomPadding\", \"Bottom Padding\",";
_bag._addtextbox /*String*/ ("bottomPadding","Bottom Padding","");
 //BA.debugLineNum = 54;BA.debugLine="Bag.AddLabel(\"Options\")";
_bag._addlabel /*String*/ ("Options");
 //BA.debugLineNum = 55;BA.debugLine="Bag.AddCombo(\"inputAlign\", \"Input Align\",\"\", ia)";
_bag._addcombo /*String*/ ("inputAlign","Input Align","",_ia);
 //BA.debugLineNum = 56;BA.debugLine="Bag.AddCheckBox(\"readonly\", \"Read Only\", \"\")";
_bag._addcheckbox /*String*/ ("readonly","Read Only","");
 //BA.debugLineNum = 57;BA.debugLine="Bag.AddCheckBox(\"disabled\", \"Disabled\", \"\")";
_bag._addcheckbox /*String*/ ("disabled","Disabled","");
 //BA.debugLineNum = 59;BA.debugLine="Bag.AddLabel(\"Size\")";
_bag._addlabel /*String*/ ("Size");
 //BA.debugLineNum = 60;BA.debugLine="Bag.AddTextBox(\"width\",\"Width\",\"\")";
_bag._addtextbox /*String*/ ("width","Width","");
 //BA.debugLineNum = 61;BA.debugLine="Bag.AddTextBox(\"height\",\"Height\",\"\")";
_bag._addtextbox /*String*/ ("height","Height","");
 //BA.debugLineNum = 65;BA.debugLine="Bag.Refresh(Page)";
