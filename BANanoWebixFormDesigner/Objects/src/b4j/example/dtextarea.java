...
_bag._addtextbox /*b4j.example.wixproperty*/ ("id","ID","textarea1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("view","View","textarea",_page._views /*anywheresoftware.b4a.objects.collections.List*/ );
...
_bag._addtextbox /*b4j.example.wixproperty*/ ("label","Text","TextArea 1");
...
_bag._addcombo /*b4j.example.wixproperty*/ ("inputAlign","Input Align","",_ia);
