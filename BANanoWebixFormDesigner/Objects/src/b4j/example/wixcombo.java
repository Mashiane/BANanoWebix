...
public b4j.example.wixcombo  _addoption(String _optid,String _optvalue) throws Exception{
 //BA.debugLineNum = 107;BA.debugLine="Sub AddOption(optID As String, optValue As String)";
 //BA.debugLineNum = 108;BA.debugLine="Options.Add(CreateMap(\"id\":optID,\"value\":optValue";
...
public b4j.example.wixcombo  _setaligncenter(String _r) throws Exception{
 //BA.debugLineNum = 162;BA.debugLine="Sub SetAlignCenter(r As String) As WixCombo 'ignor";
 //BA.debugLineNum = 163;BA.debugLine="Combo.setAligncenter(\"\")";
...
public b4j.example.wixcombo  _setalignleft(String _r) throws Exception{
 //BA.debugLineNum = 168;BA.debugLine="Sub SetAlignLeft(r As String) As WixCombo 'ignore";
 //BA.debugLineNum = 169;BA.debugLine="Combo.SetAlignleft(\"\")";
...
public b4j.example.wixcombo  _setalignright(String _r) throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Sub SetAlignRight(r As String) As WixCombo 'ignore";
 //BA.debugLineNum = 157;BA.debugLine="Combo.setAlignright(\"\")";
...
public b4j.example.wixcombo  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Sub SetLabel(l As String) As WixCombo";
 //BA.debugLineNum = 126;BA.debugLine="Combo.SetLabel(l)";
...
public b4j.example.wixcombo  _setlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Sub SetLabelAlign(a As String) As WixCombo";
 //BA.debugLineNum = 138;BA.debugLine="Combo.SetLabelAlign(a)";
...
public b4j.example.wixcombo  _setlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub SetLabelPosition(p As String) As WixCombo";
 //BA.debugLineNum = 144;BA.debugLine="Combo.SetLabelPosition(p)";
...
public b4j.example.wixcombo  _setlabelwidth(int _w) throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Sub SetLabelWidth(w As Int) As WixCombo";
 //BA.debugLineNum = 150;BA.debugLine="Combo.SetLabelWidth(w)";
...
public b4j.example.wixcombo  _setrequired(boolean _b) throws Exception{
 //BA.debugLineNum = 131;BA.debugLine="Sub SetRequired(b As Boolean) As WixCombo";
 //BA.debugLineNum = 132;BA.debugLine="Combo.SetRequired(b)";
...
public b4j.example.wixcombo  _setsuggest(Object _s) throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Sub SetSuggest(s As Object) As WixCombo";
 //BA.debugLineNum = 175;BA.debugLine="Combo.setSuggest(s)";
...
public b4j.example.wixcombo  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 119;BA.debugLine="Sub SetValue(v As String) As WixCombo";
 //BA.debugLineNum = 120;BA.debugLine="Combo.SetValue(v)";
...
public b4j.example.wixcombo  _setycount(int _y) throws Exception{
 //BA.debugLineNum = 113;BA.debugLine="Sub SetYCount(y As Int) As WixCombo";
 //BA.debugLineNum = 114;BA.debugLine="yCount = y";
_ycount = _y;
