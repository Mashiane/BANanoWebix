...
public class wixbutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixbutton", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixbutton.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _button = null;
...
_button = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixbutton  _initialize(anywheresoftware.b4a.BA _ba,String _bid) throws Exception{
innerInitialize(_ba);
...
_button._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_id)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("button");
...
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
...
_button._setoncontent /*b4j.Mashy.BANanoWebix.wixelement*/ ("onLabel",_onlabel);
 //BA.debugLineNum = 99;BA.debugLine="Button.SetOnContent(\"offLabel\", OffLabel)";
_button._setoncontent /*b4j.Mashy.BANanoWebix.wixelement*/ ("offLabel",_offlabel);
 //BA.debugLineNum = 100;BA.debugLine="Button.SetOnContent(\"offIcon\", offIcon)";
_button._setoncontent /*b4j.Mashy.BANanoWebix.wixelement*/ ("offIcon",_officon);
 //BA.debugLineNum = 101;BA.debugLine="Button.SetOnContent(\"onIcon\", onIcon)";
_button._setoncontent /*b4j.Mashy.BANanoWebix.wixelement*/ ("onIcon",_onicon);
 //BA.debugLineNum = 102;BA.debugLine="Button.SetOnContent(\"icon\", Icon)";
_button._setoncontent /*b4j.Mashy.BANanoWebix.wixelement*/ ("icon",_icon);
 //BA.debugLineNum = 103;BA.debugLine="Button.SetOnContent(\"image\", ImageURL)";
_button._setoncontent /*b4j.Mashy.BANanoWebix.wixelement*/ ("image",_imageurl);
...
_button._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("click",(Object)(_onclick));
 };
...
public b4j.Mashy.BANanoWebix.wixbutton  _setaligncenter(String _r) throws Exception{
...
_button._setaligncenter /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 231;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 232;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _setalignleft(String _r) throws Exception{
...
_button._setalignleft /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 237;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 238;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _setalignright(String _r) throws Exception{
...
_button._setalignright /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 225;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 226;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _setbatch(int _b) throws Exception{
 //BA.debugLineNum = 118;BA.debugLine="Sub SetBatch(b As Int) As WixButton";
 //BA.debugLineNum = 119;BA.debugLine="Button.SetBatch(b)";
_button._setbatch /*b4j.Mashy.BANanoWebix.wixelement*/ (_b);
 //BA.debugLineNum = 120;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 121;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _setclick(com.ab.banano.BANanoObject _e) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 210;BA.debugLine="Sub SetHeight(h As Object) As WixButton";
 //BA.debugLineNum = 211;BA.debugLine="Button.Height = h";
_button._height /*Object*/  = _h;
 //BA.debugLineNum = 212;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 213;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _seticon(String _icn) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setimage(String _img) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setinputwidth(int _w) throws Exception{
...
_button._setinputwidth /*b4j.Mashy.BANanoWebix.wixelement*/ (_w);
 //BA.debugLineNum = 35;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 36;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _setlabel(String _lbl) throws Exception{
...
_button._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Text /*String*/  = _lbl;
...
public b4j.Mashy.BANanoWebix.wixbutton  _setofficon(String _icn) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setofflabel(String _l) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setonicon(String _icn) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setonlabel(String _l) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setparent(b4j.Mashy.BANanoWebix.wixelement _p) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setstyle(String _prop,String _val) throws Exception{
...
_button._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 47;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _settoggle(String _t) throws Exception{
...
_button._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("toggle");
 //BA.debugLineNum = 66;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 67;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _settooltip(String _tt) throws Exception{
...
_button._setproperty /*b4j.Mashy.BANanoWebix.wixelement*/ ("tooltip",(Object)(_tt));
 //BA.debugLineNum = 41;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixbutton)(this);
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixbutton  _settypedanger(String _r) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _settypeform(String _r) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _settypeicon(String _r) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _settypeiconbutton(String _i) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _settypeiconbuttontop(String _r) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _settypeimage(String _r) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _settypeimagebutton(String _r) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _settypenext(String _r) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _settypeprev(String _r) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setvalue(String _v) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixbutton  _setwidth(Object _w) throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub SetWidth(w As object) As WixButton";
 //BA.debugLineNum = 217;BA.debugLine="Button.Width = w";
_button._width /*Object*/  = _w;
