...
public class wixtreetable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixtreetable", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixtreetable.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _treetable = null;
...
public String  _addcolumn(b4j.Mashy.BANanoWebix.wixdatacolumn _c) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixtreetable  _additem(String _parentid,String _meid,String _mvalue,anywheresoftware.b4a.objects.collections.Map _mdata,boolean _mopen) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
...
_treetable = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixtreetable  _initialize(anywheresoftware.b4a.BA _ba,String _eid) throws Exception{
innerInitialize(_ba);
...
_treetable._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_id)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("treetable");
...
_treetable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("columns",(Object)(_columns.getObject()));
...
public b4j.Mashy.BANanoWebix.wixtreetable  _setautoheight(boolean _b) throws Exception{
...
_treetable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("autoheight",(Object)(_b));
 //BA.debugLineNum = 92;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 93;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _setautowidth(boolean _b) throws Exception{
...
_treetable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("autowidth",(Object)(_b));
 //BA.debugLineNum = 98;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 99;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _setborderless(boolean _b) throws Exception{
...
_treetable._setborderless /*b4j.Mashy.BANanoWebix.wixelement*/ (_b);
 //BA.debugLineNum = 49;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 50;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _setdata(anywheresoftware.b4a.objects.collections.List _data) throws Exception{
...
_treetable._setdata /*b4j.Mashy.BANanoWebix.wixelement*/ (_data);
 //BA.debugLineNum = 55;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 56;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _seteditable(boolean _b) throws Exception{
...
_treetable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("editable",(Object)(_b));
 //BA.debugLineNum = 25;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 26;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Sub SetHeight(h As Object) As WixTreeTable";
 //BA.debugLineNum = 78;BA.debugLine="TreeTable.SetHeight(h)";
_treetable._setheight /*b4j.Mashy.BANanoWebix.wixelement*/ (_h);
 //BA.debugLineNum = 79;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _setselect(Object _s) throws Exception{
...
_treetable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("select",_s);
 //BA.debugLineNum = 32;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 33;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _setstyle(String _prop,String _val) throws Exception{
...
_treetable._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 61;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 62;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _settemplate(Object _t) throws Exception{
...
_treetable._settemplate /*b4j.Mashy.BANanoWebix.wixelement*/ (_t);
 //BA.debugLineNum = 67;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 68;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _settooltip(String _tt) throws Exception{
...
_treetable._settooltip /*b4j.Mashy.BANanoWebix.wixelement*/ (_tt);
 //BA.debugLineNum = 73;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtreetable)(this);
 //BA.debugLineNum = 74;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtreetable  _setwidth(Object _h) throws Exception{
 //BA.debugLineNum = 83;BA.debugLine="Sub SetWidth(h As object) As WixTreeTable";
 //BA.debugLineNum = 84;BA.debugLine="TreeTable.SetWidth(h)";
_treetable._setwidth /*b4j.Mashy.BANanoWebix.wixelement*/ (_h);
