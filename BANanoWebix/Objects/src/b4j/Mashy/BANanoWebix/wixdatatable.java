...
public class wixdatatable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixdatatable", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixdatatable.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _datatable = null;
...
b4j.Mashy.BANanoWebix.wixdatacolumn _e = null;
b4j.Mashy.BANanoWebix.wixdatacolumn _d = null;
 //BA.debugLineNum = 78;BA.debugLine="Sub AddEditTrash";
 //BA.debugLineNum = 79;BA.debugLine="Dim e As WixDataColumn";
_e = new b4j.Mashy.BANanoWebix.wixdatacolumn();
 //BA.debugLineNum = 80;BA.debugLine="e.Initialize2(\"edit\").SetHeader(\"Edit\").SetTempla";
_e._initialize2 /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ ("edit")._setheader /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ ("Edit")._settemplate /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ ((Object)("{common.editIcon()}"))._setwidth /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ ((Object)(100));
 //BA.debugLineNum = 81;BA.debugLine="Dim d As WixDataColumn";
_d = new b4j.Mashy.BANanoWebix.wixdatacolumn();
 //BA.debugLineNum = 82;BA.debugLine="d.Initialize2(\"delete\").SetHeader(\"Delete\").SetTe";
_d._initialize2 /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ ("delete")._setheader /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ ("Delete")._settemplate /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ ((Object)("{common.trashIcon()}"))._setwidth /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ ((Object)(100));
...
public b4j.Mashy.BANanoWebix.wixdatatable  _addheader(String _sid,String _sheader,int _ifillspace) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 137;BA.debugLine="End Sub";
return null;
}
public String  _addheader1(b4j.Mashy.BANanoWebix.wixdatacolumn _hdr) throws Exception{
...
_datatable = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixdatacolumn  _createheader(String _hid) throws Exception{
b4j.Mashy.BANanoWebix.wixdatacolumn _hdr = null;
...
_hdr = new b4j.Mashy.BANanoWebix.wixdatacolumn();
 //BA.debugLineNum = 182;BA.debugLine="hdr.Initialize2(hid)";
_hdr._initialize2 /*b4j.Mashy.BANanoWebix.wixdatacolumn*/ (_hid);
 //BA.debugLineNum = 183;BA.debugLine="Return hdr";
if (true) return _hdr;
 //BA.debugLineNum = 184;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _initialize(anywheresoftware.b4a.BA _ba,String _tid) throws Exception{
innerInitialize(_ba);
...
_datatable._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_id)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("datatable");
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("columns",(Object)(_columns.getObject()));
 //BA.debugLineNum = 244;BA.debugLine="DataTable.SetAttr(\"autoConfig\", AutoConfig)";
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("autoConfig",(Object)(_autoconfig));
...
public b4j.Mashy.BANanoWebix.wixdatatable  _setautoconfig(boolean _a) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixdatatable  _setautoheight(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("autoheight",(Object)(_b));
 //BA.debugLineNum = 166;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 167;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setautowidth(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("autowidth",(Object)(_b));
 //BA.debugLineNum = 172;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 173;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setblockselect(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("blockselect",(Object)(_b));
 //BA.debugLineNum = 207;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 208;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setborderless(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("borderless",(Object)(_b));
 //BA.debugLineNum = 219;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 220;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setcolumnwidth(int _w) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("columnWidth",(Object)(_w));
 //BA.debugLineNum = 74;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 75;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setcontainer(String _c) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("container",(Object)(_c));
 //BA.debugLineNum = 115;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 116;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setdata(anywheresoftware.b4a.objects.collections.List _data) throws Exception{
...
_datatable._setdata /*b4j.Mashy.BANanoWebix.wixelement*/ (_data);
 //BA.debugLineNum = 274;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 275;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setdatatype(String _t) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("datatype",(Object)(_t));
 //BA.debugLineNum = 148;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 149;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _seteditable(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("editable",(Object)(_b));
 //BA.debugLineNum = 232;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 233;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _seteditaction(String _a) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("editaction",(Object)(_a));
 //BA.debugLineNum = 213;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 214;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setform(String _frmid) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("form",(Object)(_frmid));
 //BA.debugLineNum = 67;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 68;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Sub SetHeight(h As Object) As WixDataTable";
 //BA.debugLineNum = 256;BA.debugLine="DataTable.SetHeight(h)";
_datatable._setheight /*b4j.Mashy.BANanoWebix.wixelement*/ (_h);
 //BA.debugLineNum = 257;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 258;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _sethover(String _h) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("hover",(Object)(_h));
 //BA.debugLineNum = 90;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 91;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setleftsplit(int _c) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("leftSplit",(Object)(_c));
 //BA.debugLineNum = 201;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 202;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setmultiselect(Object _s) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("multiselect",_s);
 //BA.debugLineNum = 108;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 109;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setpager(String _p) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("pager",(Object)(_p));
 //BA.debugLineNum = 36;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 37;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setresizecolumn(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("resizeColumn",(Object)(_b));
 //BA.debugLineNum = 60;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 61;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setresizerow(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("resizeRow",(Object)(_b));
 //BA.debugLineNum = 54;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 55;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setrightsplit(int _r) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("rightSplit",(Object)(_r));
 //BA.debugLineNum = 96;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 97;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setrowheight(int _h) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("rowHeight",(Object)(_h));
 //BA.debugLineNum = 189;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 190;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setscroll(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("scroll",(Object)(_b));
 //BA.debugLineNum = 142;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 143;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setscrollx(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("scrollX",(Object)(_b));
 //BA.debugLineNum = 48;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 49;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setscrolly(boolean _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("scrollY",(Object)(_b));
 //BA.debugLineNum = 42;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 43;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setselect(Object _s) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("select",_s);
 //BA.debugLineNum = 102;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 103;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setstyle(String _prop,String _val) throws Exception{
...
_datatable._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 226;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 227;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _settooltip(String _tt) throws Exception{
...
_datatable._settooltip /*b4j.Mashy.BANanoWebix.wixelement*/ (_tt);
 //BA.debugLineNum = 238;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 239;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _settopsplit(int _r) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("topSplit",(Object)(_r));
 //BA.debugLineNum = 195;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 196;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _seturl(String _u) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("url",(Object)(_u));
 //BA.debugLineNum = 160;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 161;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setvisiblebatch(int _b) throws Exception{
...
_datatable._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("visibleBatch",(Object)(_b));
 //BA.debugLineNum = 154;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixdatatable)(this);
 //BA.debugLineNum = 155;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatatable  _setwidth(Object _h) throws Exception{
 //BA.debugLineNum = 261;BA.debugLine="Sub SetWidth(h As object) As WixDataTable";
 //BA.debugLineNum = 262;BA.debugLine="DataTable.SetWidth(h)";
_datatable._setwidth /*b4j.Mashy.BANanoWebix.wixelement*/ (_h);
