...
public class wixdatacollection extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixdatacollection", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixdatacollection.class).invoke(this, new Object[] {null});
        else
...
public b4j.Mashy.BANanoWebix.wixdatacollection  _initialize(anywheresoftware.b4a.BA _ba) throws Exception{
innerInitialize(_ba);
...
if (true) return (b4j.Mashy.BANanoWebix.wixdatacollection)(this);
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixdatacollection  _seturl(String _u) throws Exception{
