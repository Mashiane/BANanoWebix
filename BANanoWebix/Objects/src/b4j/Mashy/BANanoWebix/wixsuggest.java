...
public class wixsuggest extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixsuggest", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixsuggest.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _suggest = null;
public anywheresoftware.b4a.objects.collections.List _data = null;
public b4j.Mashy.BANanoWebix.wixpage _page = null;
public b4j.Mashy.BANanoWebix.main _main = null;
public b4j.Mashy.BANanoWebix.wixsuggest  _addsuggestion(String _sid,String _svalue) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixsuggest)(this);
...
_suggest = new b4j.Mashy.BANanoWebix.wixelement();
 //BA.debugLineNum = 5;BA.debugLine="Private Data As List";
_data = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 6;BA.debugLine="Private Page As WixPage";
_page = new b4j.Mashy.BANanoWebix.wixpage();
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return "";
}
public b4j.Mashy.BANanoWebix.wixsuggest  _initialize(anywheresoftware.b4a.BA _ba,b4j.Mashy.BANanoWebix.wixpage _pg,String _sid) throws Exception{
innerInitialize(_ba);
...
_suggest._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_sid)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("suggest");
...
_suggest._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("data",(Object)(_data.getObject()));
...
public b4j.Mashy.BANanoWebix.wixsuggest  _setdata(anywheresoftware.b4a.objects.collections.List _d) throws Exception{
