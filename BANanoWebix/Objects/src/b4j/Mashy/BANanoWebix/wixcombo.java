...
public class wixcombo extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixcombo", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixcombo.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _combo = null;
...
public b4j.Mashy.BANanoWebix.wixcombo  _addoption(String _optid,String _optvalue) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
...
_combo = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixcombo  _initialize(anywheresoftware.b4a.BA _ba,String _iid) throws Exception{
innerInitialize(_ba);
...
_combo._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_iid)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("combo");
...
_combo._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("options",(Object)(_opt.getObject()));
...
public b4j.Mashy.BANanoWebix.wixcombo  _setaligncenter(String _r) throws Exception{
...
_combo._setaligncenter /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 115;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 116;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setalignleft(String _r) throws Exception{
...
_combo._setalignleft /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 121;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 122;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setalignright(String _r) throws Exception{
...
_combo._setalignright /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 109;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 110;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 76;BA.debugLine="Sub SetLabel(l As String) As WixCombo";
 //BA.debugLineNum = 77;BA.debugLine="Combo.Label.Text = l";
_combo._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Text /*String*/  = _l;
 //BA.debugLineNum = 78;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 79;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setlabelalign(String _a) throws Exception{
...
_combo._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Align /*String*/  = _a;
 //BA.debugLineNum = 90;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 91;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setlabelposition(String _p) throws Exception{
...
_combo._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Position /*String*/  = _p;
 //BA.debugLineNum = 96;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 97;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setlabelwidth(int _w) throws Exception{
...
_combo._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Width /*int*/  = _w;
 //BA.debugLineNum = 102;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 103;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setoptions(anywheresoftware.b4a.objects.collections.List _o) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixcombo  _setrequired(boolean _b) throws Exception{
...
_combo._setrequired /*b4j.Mashy.BANanoWebix.wixelement*/ (_b);
 //BA.debugLineNum = 84;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 85;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setstyle(String _prop,String _val) throws Exception{
...
_combo._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 40;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _settemplate(String _t) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixcombo  _settooltip(String _tt) throws Exception{
...
_combo._settooltip /*b4j.Mashy.BANanoWebix.wixelement*/ (_tt);
 //BA.debugLineNum = 28;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcombo)(this);
 //BA.debugLineNum = 29;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcombo  _setvalue(String _v) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixcombo  _setycount(int _y) throws Exception{
