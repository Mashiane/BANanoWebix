...
public class wixrichselect extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixrichselect", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixrichselect.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _richselect = null;
public Object _text = null;
public anywheresoftware.b4a.objects.collections.List _options = null;
public b4j.Mashy.BANanoWebix.main _main = null;
public b4j.Mashy.BANanoWebix.wixrichselect  _addoption(String _sid,String _svalue) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
...
_richselect = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixrichselect  _initialize(anywheresoftware.b4a.BA _ba,String _iid) throws Exception{
innerInitialize(_ba);
...
_richselect._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_iid)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("richselect");
...
_richselect._setoncontent /*b4j.Mashy.BANanoWebix.wixelement*/ ("text",BA.ObjectToString(_text));
 //BA.debugLineNum = 40;BA.debugLine="RichSelect.SetAttr(\"options\", Options)";
_richselect._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("options",(Object)(_options.getObject()));
...
public b4j.Mashy.BANanoWebix.wixrichselect  _setaligncenter(String _r) throws Exception{
...
_richselect._setaligncenter /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 106;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 107;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _setalignleft(String _r) throws Exception{
...
_richselect._setalignleft /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 112;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 113;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _setalignright(String _r) throws Exception{
...
_richselect._setalignright /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 100;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 101;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _setlabel(String _l) throws Exception{
...
_richselect._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Text /*String*/  = _l;
 //BA.debugLineNum = 74;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 75;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _setlabelalign(String _a) throws Exception{
...
_richselect._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Align /*String*/  = _a;
 //BA.debugLineNum = 81;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 82;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _setlabelposition(String _p) throws Exception{
...
_richselect._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Position /*String*/  = _p;
 //BA.debugLineNum = 87;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 88;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _setlabelwidth(int _w) throws Exception{
...
_richselect._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Width /*int*/  = _w;
 //BA.debugLineNum = 93;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 94;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _setoptions(anywheresoftware.b4a.objects.collections.List _o) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixrichselect  _setstyle(String _prop,String _val) throws Exception{
...
_richselect._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 28;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 29;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _settext(String _t) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixrichselect  _settooltip(String _tt) throws Exception{
...
_richselect._settooltip /*b4j.Mashy.BANanoWebix.wixelement*/ (_tt);
 //BA.debugLineNum = 22;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixrichselect)(this);
 //BA.debugLineNum = 23;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixrichselect  _setvalue(String _v) throws Exception{
