...
public class wixsegmented extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixsegmented", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixsegmented.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _segmented = null;
...
public b4j.Mashy.BANanoWebix.wixsegmented  _addoption(String _oid,String _otxt,String _childtemplate) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixsegmented)(this);
...
_segmented = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixsegmented  _initialize(anywheresoftware.b4a.BA _ba,String _iid) throws Exception{
innerInitialize(_ba);
...
_segmented._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_iid)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("segmented");
...
_segmented._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("options",(Object)(_options.getObject()));
...
public b4j.Mashy.BANanoWebix.wixsegmented  _setaligncenter(String _r) throws Exception{
...
_segmented._setaligncenter /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 85;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixsegmented)(this);
 //BA.debugLineNum = 86;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixsegmented  _setalignleft(String _r) throws Exception{
...
_segmented._setalignleft /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 91;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixsegmented)(this);
 //BA.debugLineNum = 92;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixsegmented  _setalignright(String _r) throws Exception{
...
_segmented._setalignright /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 79;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixsegmented)(this);
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixsegmented  _setlabel(String _l) throws Exception{
...
_segmented._setlabel /*b4j.Mashy.BANanoWebix.wixelement*/ (_l);
 //BA.debugLineNum = 46;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixsegmented)(this);
 //BA.debugLineNum = 47;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixsegmented  _setoptions(anywheresoftware.b4a.objects.collections.List _o) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixsegmented  _setstyle(String _prop,String _val) throws Exception{
...
_segmented._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 28;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixsegmented)(this);
 //BA.debugLineNum = 29;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixsegmented  _settooltip(String _tt) throws Exception{
...
_segmented._settooltip /*b4j.Mashy.BANanoWebix.wixelement*/ (_tt);
 //BA.debugLineNum = 22;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixsegmented)(this);
 //BA.debugLineNum = 23;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixsegmented  _setvalue(String _v) throws Exception{
...
_segmented._setvalue /*b4j.Mashy.BANanoWebix.wixelement*/ (_v);
