...
public class wixcheckbox extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixcheckbox", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixcheckbox.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _checkbox = null;
...
_checkbox = new b4j.Mashy.BANanoWebix.wixelement();
 //BA.debugLineNum = 5;BA.debugLine="Private LabelOnRight As Boolean";
_labelonright = false;
 //BA.debugLineNum = 6;BA.debugLine="End Sub";
return "";
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _initialize(anywheresoftware.b4a.BA _ba,String _iid) throws Exception{
innerInitialize(_ba);
...
_checkbox._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_iid)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("checkbox");
 //BA.debugLineNum = 12;BA.debugLine="LabelOnRight = False";
_labelonright = __c.False;
 //BA.debugLineNum = 13;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
...
_checkbox._setoncontent /*b4j.Mashy.BANanoWebix.wixelement*/ ("labelRight",_checkbox._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Text /*String*/ );
 //BA.debugLineNum = 31;BA.debugLine="CheckBox.Label.Text = \"\"";
_checkbox._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Text /*String*/  = "";
 };
...
public b4j.Mashy.BANanoWebix.wixcheckbox  _setaligncenter(String _r) throws Exception{
...
_checkbox._setaligncenter /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 89;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 90;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _setalignleft(String _r) throws Exception{
...
_checkbox._setalignleft /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 95;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 96;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _setalignright(String _r) throws Exception{
...
_checkbox._setalignright /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 83;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 84;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _setlabel(String _l) throws Exception{
...
_checkbox._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Text /*String*/  = _l;
 //BA.debugLineNum = 51;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 52;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _setlabelalign(String _a) throws Exception{
...
_checkbox._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Align /*String*/  = _a;
 //BA.debugLineNum = 64;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 65;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _setlabelonright(boolean _b) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixcheckbox  _setlabelposition(String _p) throws Exception{
...
_checkbox._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Position /*String*/  = _p;
 //BA.debugLineNum = 70;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 71;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _setlabelwidth(int _w) throws Exception{
...
_checkbox._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Width /*int*/  = _w;
 //BA.debugLineNum = 76;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 77;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _setstyle(String _prop,String _val) throws Exception{
...
_checkbox._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 39;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 40;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _settooltip(String _tt) throws Exception{
...
_checkbox._setproperty /*b4j.Mashy.BANanoWebix.wixelement*/ ("tooltip",(Object)(_tt));
 //BA.debugLineNum = 19;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcheckbox)(this);
 //BA.debugLineNum = 20;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcheckbox  _setvalue(String _v) throws Exception{
