...
public class wixcontextmenu extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixcontextmenu", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixcontextmenu.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _contextmenu = null;
public anywheresoftware.b4a.objects.collections.List _items = null;
public int _sepcount = 0;
public b4j.Mashy.BANanoWebix.main _main = null;
public b4j.Mashy.BANanoWebix.wixcontextmenu  _additem(String _parentid,String _meid,String _mvalue,String _mhref,String _micon,String _badge,String _target) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 81;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _addseparator(String _parentid) throws Exception{
String _meid = "";
anywheresoftware.b4a.objects.collections.Map _mitem = null;
...
_contextmenu = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixcontextmenu  _initialize(anywheresoftware.b4a.BA _ba,String _sid) throws Exception{
innerInitialize(_ba);
...
_contextmenu._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_id)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("contextmenu");
...
public b4j.Mashy.BANanoWebix.wixcontextmenu  _setautowidth(boolean _b) throws Exception{
...
_contextmenu._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("autowidth",(Object)(_b));
 //BA.debugLineNum = 58;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 59;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _setdata(anywheresoftware.b4a.objects.collections.List _d) throws Exception{
...
_contextmenu._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("data",(Object)(_d.getObject()));
 //BA.debugLineNum = 99;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 100;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Sub SetHeight(h As Object) As WixContextMenu";
 //BA.debugLineNum = 39;BA.debugLine="ContextMenu.SetAttr(\"height\", h)";
_contextmenu._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("height",_h);
 //BA.debugLineNum = 40;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _setlayouty(String _r) throws Exception{
...
_contextmenu._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("layout",(Object)("y"));
 //BA.debugLineNum = 52;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _setmaster(String _pid) throws Exception{
...
_contextmenu._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("master",(Object)(_pid));
 //BA.debugLineNum = 21;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 22;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _setselect(boolean _b) throws Exception{
...
_contextmenu._setproperty /*b4j.Mashy.BANanoWebix.wixelement*/ ("select",(Object)(_b));
 //BA.debugLineNum = 105;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 106;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _setsubmenuposright(String _r) throws Exception{
...
_contextmenu._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("subMenuPos",(Object)("right"));
 //BA.debugLineNum = 33;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 34;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _settemplate(String _t) throws Exception{
...
_contextmenu._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("template",(Object)(_t));
 //BA.debugLineNum = 64;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixcontextmenu)(this);
 //BA.debugLineNum = 65;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixcontextmenu  _setwidth(Object _w) throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub SetWidth(w As object) As WixContextMenu";
 //BA.debugLineNum = 45;BA.debugLine="ContextMenu.SetAttr(\"width\", w)";
_contextmenu._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("width",_w);
