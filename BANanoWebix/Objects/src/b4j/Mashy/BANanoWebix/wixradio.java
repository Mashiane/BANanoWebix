...
public class wixradio extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixradio", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixradio.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _radio = null;
public anywheresoftware.b4a.objects.collections.List _options = null;
public boolean _vertical = false;
public b4j.Mashy.BANanoWebix.main _main = null;
public b4j.Mashy.BANanoWebix.wixradio  _addoption(String _sid,String _svalue) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
...
_radio = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixradio  _initialize(anywheresoftware.b4a.BA _ba,String _iid) throws Exception{
innerInitialize(_ba);
...
_radio._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_iid)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("radio");
...
_radio._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("options",(Object)(_options.getObject()));
 //BA.debugLineNum = 28;BA.debugLine="Radio.SetAttr(\"vertical\", Vertical)";
_radio._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("vertical",(Object)(_vertical));
...
public b4j.Mashy.BANanoWebix.wixradio  _setaligncenter(String _r) throws Exception{
...
_radio._setaligncenter /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 105;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 106;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _setalignleft(String _r) throws Exception{
...
_radio._setalignleft /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 111;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 112;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _setalignright(String _r) throws Exception{
...
_radio._setalignright /*b4j.Mashy.BANanoWebix.wixelement*/ ("");
 //BA.debugLineNum = 99;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 100;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Sub SetLabel(l As String) As WixRadio";
 //BA.debugLineNum = 66;BA.debugLine="Radio.Label.Text = l";
_radio._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Text /*String*/  = _l;
 //BA.debugLineNum = 67;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 68;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _setlabelalign(String _a) throws Exception{
...
_radio._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Align /*String*/  = _a;
 //BA.debugLineNum = 80;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 81;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _setlabelposition(String _p) throws Exception{
...
_radio._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Position /*String*/  = _p;
 //BA.debugLineNum = 86;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 87;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _setlabelwidth(int _w) throws Exception{
...
_radio._label /*b4j.Mashy.BANanoWebix.wixelement._labeltype*/ .Width /*int*/  = _w;
 //BA.debugLineNum = 92;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 93;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _setoptions(anywheresoftware.b4a.objects.collections.List _opt) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixradio  _setstyle(String _prop,String _val) throws Exception{
...
_radio._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 35;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 36;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _settooltip(String _tt) throws Exception{
...
_radio._settooltip /*b4j.Mashy.BANanoWebix.wixelement*/ (_tt);
 //BA.debugLineNum = 22;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixradio)(this);
 //BA.debugLineNum = 23;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixradio  _setvalue(String _v) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixradio  _setvertical(boolean _b) throws Exception{
