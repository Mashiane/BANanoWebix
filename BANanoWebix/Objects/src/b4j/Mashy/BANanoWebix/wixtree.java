...
public class wixtree extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixtree", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixtree.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _tree = null;
public anywheresoftware.b4a.objects.collections.Map _scheme = null;
public anywheresoftware.b4a.objects.collections.List _items = null;
public b4j.Mashy.BANanoWebix.main _main = null;
public b4j.Mashy.BANanoWebix.wixtree  _additem(String _parentid,String _meid,String _mvalue,String _mhref,String _micon,String _badge,String _target,boolean _mopen) throws Exception{
...
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
...
_tree = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixtree  _initialize(anywheresoftware.b4a.BA _ba,String _eid) throws Exception{
innerInitialize(_ba);
...
_tree._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_id)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("tree");
...
_tree._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("scheme",(Object)(_scheme.getObject()));
...
public b4j.Mashy.BANanoWebix.wixtree  _setborderless(boolean _b) throws Exception{
...
_tree._setborderless /*b4j.Mashy.BANanoWebix.wixelement*/ (_b);
 //BA.debugLineNum = 33;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 34;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _setdata(anywheresoftware.b4a.objects.collections.List _data) throws Exception{
 //BA.debugLineNum = 56;BA.debugLine="Sub SetData(data As List) As WixTree";
 //BA.debugLineNum = 57;BA.debugLine="Tree.SetData(data)";
_tree._setdata /*b4j.Mashy.BANanoWebix.wixelement*/ (_data);
 //BA.debugLineNum = 58;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 59;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _setgroupby(String _g) throws Exception{
...
public b4j.Mashy.BANanoWebix.wixtree  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 80;BA.debugLine="Sub SetHeight(h As Object) As WixTree";
 //BA.debugLineNum = 81;BA.debugLine="Tree.SetHeight(h)";
_tree._setheight /*b4j.Mashy.BANanoWebix.wixelement*/ (_h);
 //BA.debugLineNum = 82;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 83;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _setmultiselect(boolean _b) throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub SetMultiSelect(b As Boolean) As WixTree   'ign";
 //BA.debugLineNum = 44;BA.debugLine="Tree.SetAttr(\"select\", \"multiselect\")";
_tree._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("select",(Object)("multiselect"));
 //BA.debugLineNum = 45;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 46;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _setselect(boolean _b) throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Sub SetSelect(b As Boolean) As WixTree";
 //BA.debugLineNum = 38;BA.debugLine="Tree.SetSelect(b)";
_tree._setselect /*b4j.Mashy.BANanoWebix.wixelement*/ (_b);
 //BA.debugLineNum = 39;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 40;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _setstyle(String _prop,String _val) throws Exception{
...
_tree._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 64;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 65;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _settemplate(Object _t) throws Exception{
 //BA.debugLineNum = 68;BA.debugLine="Sub SetTemplate(t As Object) As WixTree";
 //BA.debugLineNum = 69;BA.debugLine="Tree.SetTemplate(t)";
_tree._settemplate /*b4j.Mashy.BANanoWebix.wixelement*/ (_t);
 //BA.debugLineNum = 70;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 71;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 74;BA.debugLine="Sub SetTooltip(tt As String) As WixTree";
 //BA.debugLineNum = 75;BA.debugLine="Tree.SetTooltip(tt)";
_tree._settooltip /*b4j.Mashy.BANanoWebix.wixelement*/ (_tt);
 //BA.debugLineNum = 76;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 77;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _settypelinetree() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub SetTypeLineTree As WixTree";
 //BA.debugLineNum = 51;BA.debugLine="Tree.SetType(\"lineTree\")";
_tree._settype /*b4j.Mashy.BANanoWebix.wixelement*/ ("lineTree");
 //BA.debugLineNum = 52;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixtree)(this);
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixtree  _setwidth(Object _h) throws Exception{
 //BA.debugLineNum = 86;BA.debugLine="Sub SetWidth(h As object) As WixTree";
 //BA.debugLineNum = 87;BA.debugLine="Tree.SetWidth(h)";
_tree._setwidth /*b4j.Mashy.BANanoWebix.wixelement*/ (_h);
