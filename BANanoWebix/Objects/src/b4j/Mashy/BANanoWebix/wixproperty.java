...
public class wixproperty extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("b4j.Mashy.BANanoWebix", "b4j.Mashy.BANanoWebix.wixproperty", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", b4j.Mashy.BANanoWebix.wixproperty.class).invoke(this, new Object[] {null});
        else
...
public String _id = "";
public b4j.Mashy.BANanoWebix.wixelement _property = null;
...
_property = new b4j.Mashy.BANanoWebix.wixelement();
...
public b4j.Mashy.BANanoWebix.wixproperty  _initialize(anywheresoftware.b4a.BA _ba,String _eid) throws Exception{
innerInitialize(_ba);
...
_property._initialize /*b4j.Mashy.BANanoWebix.wixelement*/ (ba,_id)._setview /*b4j.Mashy.BANanoWebix.wixelement*/ ("property");
 //BA.debugLineNum = 12;BA.debugLine="elements.Initialize";
_elements.Initialize();
 //BA.debugLineNum = 13;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
...
_property._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("elements",(Object)(_elements.getObject()));
...
public b4j.Mashy.BANanoWebix.wixproperty  _setborderless(boolean _t) throws Exception{
...
_property._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("borderless",(Object)(_t));
 //BA.debugLineNum = 99;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
 //BA.debugLineNum = 100;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixproperty  _setcomplexdata(boolean _b) throws Exception{
...
_property._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("complexData",(Object)(_b));
 //BA.debugLineNum = 38;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixproperty  _setdata(anywheresoftware.b4a.objects.collections.List _data) throws Exception{
...
_property._setdata /*b4j.Mashy.BANanoWebix.wixelement*/ (_data);
 //BA.debugLineNum = 87;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
 //BA.debugLineNum = 88;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixproperty  _setheight(Object _h) throws Exception{
 //BA.debugLineNum = 116;BA.debugLine="Sub SetHeight(h As Object) As WixProperty";
 //BA.debugLineNum = 117;BA.debugLine="Property.SetHeight(h)";
_property._setheight /*b4j.Mashy.BANanoWebix.wixelement*/ (_h);
 //BA.debugLineNum = 118;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
 //BA.debugLineNum = 119;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixproperty  _setnamewidth(int _w) throws Exception{
...
_property._setattr /*b4j.Mashy.BANanoWebix.wixelement*/ ("nameWidth",(Object)(_w));
 //BA.debugLineNum = 32;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
 //BA.debugLineNum = 33;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixproperty  _setstyle(String _prop,String _val) throws Exception{
...
_property._setstyle /*b4j.Mashy.BANanoWebix.wixelement*/ (_prop,_val);
 //BA.debugLineNum = 93;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
 //BA.debugLineNum = 94;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixproperty  _settemplate(Object _t) throws Exception{
...
_property._settemplate /*b4j.Mashy.BANanoWebix.wixelement*/ (_t);
 //BA.debugLineNum = 106;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
 //BA.debugLineNum = 107;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixproperty  _settooltip(String _tt) throws Exception{
...
_property._settooltip /*b4j.Mashy.BANanoWebix.wixelement*/ (_tt);
 //BA.debugLineNum = 112;BA.debugLine="Return Me";
if (true) return (b4j.Mashy.BANanoWebix.wixproperty)(this);
 //BA.debugLineNum = 113;BA.debugLine="End Sub";
return null;
}
public b4j.Mashy.BANanoWebix.wixproperty  _setwidth(Object _h) throws Exception{
 //BA.debugLineNum = 122;BA.debugLine="Sub SetWidth(h As object) As WixProperty";
 //BA.debugLineNum = 123;BA.debugLine="Property.SetWidth(h)";
_property._setwidth /*b4j.Mashy.BANanoWebix.wixelement*/ (_h);
