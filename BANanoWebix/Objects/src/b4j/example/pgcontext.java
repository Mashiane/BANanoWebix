...
anywheresoftware.b4a.objects.collections.Map _meid = null;
 ...
 //BA.debugLineNum = 9;BA.debugLine="pg.Initialize(\"forms\").SetHeader(\"Lesson 19: Cont";
...
_r1._initialize /*b4j.example.wixrow*/ (ba,"R1");
 //BA.debugLineNum = 15;BA.debugLine="Dim div1 As UOENowHTML";
_div1 = new b4j.example.uoenowhtml();
 //BA.debugLineNum = 16;BA.debugLine="div1.Initialize(\"div1\", \"div\").SetStyle(\"backgrou";
_div1._initialize /*b4j.example.uoenowhtml*/ (ba,"div1","div")._setstyle /*b4j.example.uoenowhtml*/ ("background-color","#ff0000");
 //BA.debugLineNum = 17;BA.debugLine="div1.SetStyle(\"width\", \"200px\").SetStyle(\"height\"";
_div1._setstyle /*b4j.example.uoenowhtml*/ ("width","200px")._setstyle /*b4j.example.uoenowhtml*/ ("height","200px");
 //BA.debugLineNum = 19;BA.debugLine="Dim div2 As UOENowHTML";
_div2 = new b4j.example.uoenowhtml();
 //BA.debugLineNum = 20;BA.debugLine="div2.Initialize(\"div2\", \"div\").SetStyle(\"backgrou";
_div2._initialize /*b4j.example.uoenowhtml*/ (ba,"div2","div")._setstyle /*b4j.example.uoenowhtml*/ ("background-color","#00ff00");
 //BA.debugLineNum = 21;BA.debugLine="div2.SetStyle(\"width\", \"200px\").SetStyle(\"height\"";
...
_sb.Initialize();
 //BA.debugLineNum = 26;BA.debugLine="sb.Append(div1.HTML)";
_sb.Append(_div1._html /*String*/ ());
 //BA.debugLineNum = 27;BA.debugLine="sb.Append(\"<br>\")";
_sb.Append("<br>");
 //BA.debugLineNum = 28;BA.debugLine="sb.Append(div2.html)";
_sb.Append(_div2._html /*String*/ ());
 //BA.debugLineNum = 30;BA.debugLine="R1.SetTemplate(sb.ToString)";
_r1._settemplate /*b4j.example.wixrow*/ (_sb.ToString());
 //BA.debugLineNum = 33;BA.debugLine="pg.AddRow(R1)";
_pg._addrow /*String*/ (_r1);
 //BA.debugLineNum = 35;BA.debugLine="pg.ui";
_pg._ui /*String*/ ();
 //BA.debugLineNum = 38;BA.debugLine="Dim context As WixContext '(popup)";
_context = new b4j.example.wixcontext();
 //BA.debugLineNum = 39;BA.debugLine="context.Initialize(\"context\").SetMaster(\"div1\").S";
_context._initialize /*b4j.example.wixcontext*/ (ba,"context")._setmaster /*b4j.example.wixcontext*/ ("div1")._setwidth /*b4j.example.wixcontext*/ ((int) (250))._setheight /*b4j.example.wixcontext*/ ((int) (150));
 //BA.debugLineNum = 40;BA.debugLine="context.SetTemplate(\"Exterminate the Doctor! Exte";
_context._settemplate /*b4j.example.wixcontext*/ ("Exterminate the Doctor! Exterminate! Exterminate!");
 //BA.debugLineNum = 42;BA.debugLine="pg.AddContext(context)";
_pg._addcontext /*com.ab.banano.BANanoObject*/ (_context);
 //BA.debugLineNum = 44;BA.debugLine="Dim contextmenu As WixContextMenu";
_contextmenu = new b4j.example.wixcontextmenu();
 //BA.debugLineNum = 45;BA.debugLine="contextmenu.Initialize(\"contextmenu\").SetMaster(\"";
_contextmenu._initialize /*b4j.example.wixcontextmenu*/ (ba,"contextmenu")._setmaster /*b4j.example.wixcontextmenu*/ ("div2")._setselect /*b4j.example.wixcontextmenu*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 46;BA.debugLine="contextmenu.AddItem(\"\",\"sendto\",\"Send To...\",\"\",\"";
_contextmenu._additem /*b4j.example.wixcontextmenu*/ ("","sendto","Send To...","","","","");
 //BA.debugLineNum = 47;BA.debugLine="contextmenu.AddItem(\"sendto\", \"clara\", \"Clara\",\"\"";
_contextmenu._additem /*b4j.example.wixcontextmenu*/ ("sendto","clara","Clara","","","","");
 //BA.debugLineNum = 48;BA.debugLine="contextmenu.AddItem(\"sendto\", \"billie\", \"Billie\",";
_contextmenu._additem /*b4j.example.wixcontextmenu*/ ("sendto","billie","Billie","","","","");
 //BA.debugLineNum = 49;BA.debugLine="contextmenu.AddItem(\"sendto\", \"rose\", \"Rose\",\"\",\"";
_contextmenu._additem /*b4j.example.wixcontextmenu*/ ("sendto","rose","Rose","","","","");
 //BA.debugLineNum = 50;BA.debugLine="contextmenu.AddItem(\"\",\"addcompanion\",\"Add Compan";
_contextmenu._additem /*b4j.example.wixcontextmenu*/ ("","addcompanion","Add Companion","","","","");
 //BA.debugLineNum = 51;BA.debugLine="Dim data As List = pg.Unflatten(contextmenu.Items";
...
_data = _pg._unflatten /*anywheresoftware.b4a.objects.collections.List*/ (_contextmenu._items /*anywheresoftware.b4a.objects.collections.List*/ ,"submenu");
 //BA.debugLineNum = 52;BA.debugLine="contextmenu.SetData(data)";
_contextmenu._setdata /*b4j.example.wixcontextmenu*/ (_data);
 //BA.debugLineNum = 54;BA.debugLine="pg.AddContextMenu(contextmenu)";
_pg._addcontextmenu /*com.ab.banano.BANanoObject*/ (_contextmenu);
 //BA.debugLineNum = 56;BA.debugLine="Dim meID As Map";
_meid = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 57;BA.debugLine="pg.onMenuItemClick(\"contextmenu\", BANano.CallBack";
...
public static String  _itemclick(String _meid) throws Exception{
 //BA.debugLineNum = 61;BA.debugLine="Sub itemClick(meid As String)";
 //BA.debugLineNum = 62;BA.debugLine="pg.Message(meid)";
