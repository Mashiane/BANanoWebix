...
public b4j.example.wixdatacolumn  _aligncenter() throws Exception{
 //BA.debugLineNum = 69;BA.debugLine="Sub AlignCenter As WixDataColumn";
 //BA.debugLineNum = 70;BA.debugLine="Column.SetStyle(\"text-align\", \"center\")";
...
public b4j.example.wixdatacolumn  _alignright() throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub AlignRight As WixDataColumn";
 //BA.debugLineNum = 64;BA.debugLine="Column.SetStyle(\"text-align\", \"right\")";
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub Item As Map";
 //BA.debugLineNum = 185;BA.debugLine="Return Column.item";
...
public String  _pop1() throws Exception{
 ...
 //BA.debugLineNum = 41;BA.debugLine="tr.treetable.AddColumns(Item)";
_tr._treetable /*b4j.example.wixelement*/ ._addcolumns /*b4j.example.wixelement*/ (_item());
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return "";
}
public b4j.example.wixdatacolumn  _setadjust(Object _a) throws Exception{
 //BA.debugLineNum = 75;BA.debugLine="Sub SetAdjust(a As Object) As WixDataColumn";
 //BA.debugLineNum = 76;BA.debugLine="Column.SetAttr(\"adjust\", a)";
...
public b4j.example.wixdatacolumn  _setbatch(int _b) throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub SetBatch(b As Int) As WixDataColumn";
 //BA.debugLineNum = 52;BA.debugLine="Column.SetAttr(\"batch\", b)";
...
public b4j.example.wixdatacolumn  _seteditor(String _e) throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Sub SetEditor(e As String) As WixDataColumn";
 //BA.debugLineNum = 94;BA.debugLine="Column.SetAttr(\"editor\", e)";
...
public b4j.example.wixdatacolumn  _seteditorcheckbox(String _r) throws Exception{
 //BA.debugLineNum = 154;BA.debugLine="Sub SetEditorCheckBox(r As String) As WixDataColum";
 //BA.debugLineNum = 155;BA.debugLine="SetEditor(\"checkbox\")";
_seteditor("checkbox");
...
public b4j.example.wixdatacolumn  _seteditorcolor(String _r) throws Exception{
 //BA.debugLineNum = 106;BA.debugLine="Sub SetEditorColor(r As String) As WixDataColumn";
 //BA.debugLineNum = 107;BA.debugLine="SetEditor(\"color\")";
_seteditor("color");
...
public b4j.example.wixdatacolumn  _seteditorcombo(String _r) throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Sub SetEditorCombo(r As String) As WixDataColumn";
 //BA.debugLineNum = 143;BA.debugLine="SetEditor(\"combo\")";
_seteditor("combo");
...
public b4j.example.wixdatacolumn  _seteditordate(String _r) throws Exception{
 //BA.debugLineNum = 124;BA.debugLine="Sub SetEditorDate(r As String) As WixDataColumn";
 //BA.debugLineNum = 125;BA.debugLine="SetEditor(\"date\")";
_seteditor("date");
...
public b4j.example.wixdatacolumn  _seteditorinlinecheckbox(String _r) throws Exception{
 //BA.debugLineNum = 160;BA.debugLine="Sub SetEditorInlineCheckBox(r As String) As WixDat";
 //BA.debugLineNum = 161;BA.debugLine="SetEditor(\"inline-checkbox\")";
...
public b4j.example.wixdatacolumn  _seteditorinlinetext(String _r) throws Exception{
 //BA.debugLineNum = 130;BA.debugLine="Sub SetEditorInlineText(r As String) As WixDataCol";
 //BA.debugLineNum = 131;BA.debugLine="SetEditor(\"inline-text\")";
...
public b4j.example.wixdatacolumn  _seteditorpassword(String _r) throws Exception{
 //BA.debugLineNum = 118;BA.debugLine="Sub SetEditorPassword(r As String) As WixDataColum";
 //BA.debugLineNum = 119;BA.debugLine="SetEditor(\"password\")";
_seteditor("password");
...
public b4j.example.wixdatacolumn  _seteditorpopup(String _e) throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub SetEditorPopUp(e As String) As WixDataColumn";
 //BA.debugLineNum = 100;BA.debugLine="SetEditor(\"popup\")";
_seteditor("popup");
...
public b4j.example.wixdatacolumn  _seteditorrichselect(String _r) throws Exception{
 //BA.debugLineNum = 148;BA.debugLine="Sub SetEditorRichSelect(r As String) As WixDataCol";
 //BA.debugLineNum = 149;BA.debugLine="SetEditor(\"richselect\")";
...
public b4j.example.wixdatacolumn  _seteditorselect(String _r) throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Sub SetEditorSelect(r As String) As WixDataColumn";
 //BA.debugLineNum = 137;BA.debugLine="SetEditor(\"select\")";
_seteditor("select");
...
public b4j.example.wixdatacolumn  _seteditortext(String _r) throws Exception{
 //BA.debugLineNum = 112;BA.debugLine="Sub SetEditorText(r As String) As WixDataColumn";
 //BA.debugLineNum = 113;BA.debugLine="SetEditor(\"text\")";
_seteditor("text");
...
public b4j.example.wixdatacolumn  _setfillspace(boolean _s) throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub SetFillSpace(s As Boolean) As WixDataColumn";
 //BA.debugLineNum = 167;BA.debugLine="Column.SetAttr(\"fillspace\", s)";
...
public b4j.example.wixdatacolumn  _setheader(String _h) throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub SetHeader(h As String) As WixDataColumn";
 //BA.debugLineNum = 82;BA.debugLine="Column.SetAttr(\"header\", h)";
...
public b4j.example.wixdatacolumn  _sethiddent(boolean _b) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub SetHiddent(b As Boolean) As WixDataColumn";
 //BA.debugLineNum = 58;BA.debugLine="Column.SetAttr(\"hidden\", b)";
...
public b4j.example.wixdatacolumn  _setoptions(anywheresoftware.b4a.objects.collections.List _options) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub SetOptions(options As List) As WixDataColumn";
 //BA.debugLineNum = 46;BA.debugLine="Column.SetAttr(\"options\", options)";
...
public b4j.example.wixdatacolumn  _setsort(String _s) throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub SetSort(s As String) As WixDataColumn";
 //BA.debugLineNum = 179;BA.debugLine="Column.SetAttr(\"sort\", s)";
...
public b4j.example.wixdatacolumn  _settemplate(Object _t) throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Sub SetTemplate(t As Object) As WixDataColumn";
 //BA.debugLineNum = 173;BA.debugLine="Column.SetTemplate(t)";
...
public b4j.example.wixdatacolumn  _setwidth(int _w) throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Sub SetWidth(w As Int) As WixDataColumn";
 //BA.debugLineNum = 88;BA.debugLine="Column.SetAttr(\"width\", w)";
