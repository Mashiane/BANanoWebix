...
public b4j.example.uoenowhtml  _setheight(int _h) throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Sub SetHeight(h As Int) As UOENowHTML";
 //BA.debugLineNum = 41;BA.debugLine="AddAttribute(\"height\", h)";
_addattribute("height",BA.NumberToString(_h));
...
public b4j.example.uoenowhtml  _settext(String _stext,boolean _bafter) throws Exception{
...
public b4j.example.uoenowhtml  _setwidth(int _w) throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub SetWidth(w As Int) As UOENowHTML";
 //BA.debugLineNum = 35;BA.debugLine="AddAttribute(\"width\", w)";
_addattribute("width",BA.NumberToString(_w));
