...
public b4j.example.wixelement  _addcells(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 380;BA.debugLine="Sub AddCells(itm As Map) As WixElement";
 //BA.debugLineNum = 381;BA.debugLine="Cells.Add(itm)";
...
public String  _addcolumn(b4j.example.wixcolumn _wxel) throws Exception{
 //BA.debugLineNum = 475;BA.debugLine="Sub AddColumn(wxEL As WixColumn)";
 //BA.debugLineNum = 476;BA.debugLine="AddColumns(wxEL.Item)";
...
public b4j.example.wixelement  _addcolumns(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 374;BA.debugLine="Sub AddColumns(itm As Map) As WixElement";
 //BA.debugLineNum = 375;BA.debugLine="Columns.Add(itm)";
...
anywheresoftware.b4a.objects.collections.Map _opt = null;
 //BA.debugLineNum = 395;BA.debugLine="Sub AddColumnsCells(mCells As List) As WixElement";
 //BA.debugLineNum = 396;BA.debugLine="Dim opt As Map = CreateMap()";
_opt = new anywheresoftware.b4a.objects.collections.Map();
_opt = __c.createMap(new Object[] {});
 //BA.debugLineNum = 397;BA.debugLine="opt.Put(\"cells\", mCells)";
_opt.Put((Object)("cells"),(Object)(_mcells.getObject()));
 //BA.debugLineNum = 398;BA.debugLine="AddColumns(opt)";
_addcolumns(_opt);
...
b4j.example.wixelement _s = null;
 //BA.debugLineNum = 438;BA.debugLine="Sub AddColumnsSpacer()";
...
_s._initialize /*b4j.example.wixelement*/ (ba,"")._setview /*b4j.example.wixelement*/ ("spacer");
 //BA.debugLineNum = 441;BA.debugLine="AddColumns(s.item)";
...
public b4j.example.wixelement  _addelements(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 403;BA.debugLine="Sub AddElements(itm As Map) As WixElement";
 //BA.debugLineNum = 404;BA.debugLine="Elements.Add(itm)";
...
public b4j.example.wixelement  _additem(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 415;BA.debugLine="Sub AddItem(itm As Map) As WixElement";
 //BA.debugLineNum = 416;BA.debugLine="Elements.Add(itm)";
_elements.Add((Object)(_itm.getObject()));
...
b4j.example.wixresizer _r = null;
 //BA.debugLineNum = 360;BA.debugLine="Sub AddResizerToColumns As WixElement";
 //BA.debugLineNum = 361;BA.debugLine="Dim r As WixResizer";
_r = new b4j.example.wixresizer();
 //BA.debugLineNum = 362;BA.debugLine="r.Initialize(\"\")";
_r._initialize /*b4j.example.wixresizer*/ (ba,"");
 //BA.debugLineNum = 363;BA.debugLine="AddColumns(r.Item)";
...
public String  _addrow(b4j.example.wixrow _wxel) throws Exception{
 //BA.debugLineNum = 421;BA.debugLine="Sub AddRow(wxEL As WixRow)";
 //BA.debugLineNum = 422;BA.debugLine="AddRows(wxEL.Item)";
...
public b4j.example.wixelement  _addrows(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 409;BA.debugLine="Sub AddRows(itm As Map) As WixElement";
 //BA.debugLineNum = 410;BA.debugLine="Rows.Add(itm)";
...
anywheresoftware.b4a.objects.collections.Map _opt = null;
 //BA.debugLineNum = 386;BA.debugLine="Sub AddRowsCells(mCells As List) As WixElement";
 //BA.debugLineNum = 387;BA.debugLine="Dim opt As Map = CreateMap()";
_opt = new anywheresoftware.b4a.objects.collections.Map();
_opt = __c.createMap(new Object[] {});
 //BA.debugLineNum = 388;BA.debugLine="opt.Put(\"cells\", mCells)";
_opt.Put((Object)("cells"),(Object)(_mcells.getObject()));
 //BA.debugLineNum = 389;BA.debugLine="AddRows(opt)";
_addrows(_opt);
...
b4j.example.wixelement _s = null;
 //BA.debugLineNum = 431;BA.debugLine="Sub AddRowsSpacer()";
 //BA.debugLineNum = 432;BA.debugLine="Dim s As WixElement";
_s = new b4j.example.wixelement();
 //BA.debugLineNum = 433;BA.debugLine="s.Initialize(\"\").SetView(\"spacer\")";
_s._initialize /*b4j.example.wixelement*/ (ba,"")._setview /*b4j.example.wixelement*/ ("spacer");
 //BA.debugLineNum = 434;BA.debugLine="AddRows(s.item)";
...
public b4j.example.wixelement  _addtocolumns(b4j.example.wixelement _prt) throws Exception{
 //BA.debugLineNum = 445;BA.debugLine="Sub AddToColumns(prt As WixElement) As WixElement";
 //BA.debugLineNum = 446;BA.debugLine="prt.AddColumns(Item)";
...
public b4j.example.wixelement  _addtoelements(b4j.example.wixelement _prt) throws Exception{
 //BA.debugLineNum = 469;BA.debugLine="Sub AddToElements(prt As WixElement) As WixElement";
 //BA.debugLineNum = 470;BA.debugLine="prt.AddElements(Item)";
...
public String  _addtorow(b4j.example.wixrow _r) throws Exception{
 //BA.debugLineNum = 537;BA.debugLine="Sub AddToRow(r As WixRow)";
 //BA.debugLineNum = 538;BA.debugLine="r.AddItem(Item)";
...
public String  _addtorows(b4j.example.wixelement _prt) throws Exception{
 //BA.debugLineNum = 426;BA.debugLine="Sub AddToRows(prt As WixElement)";
 //BA.debugLineNum = 427;BA.debugLine="prt.AddRows(Item)";
...
innerInitialize(_ba);
 //BA.debugLineNum = 63;BA.debugLine="Public Sub Initialize(sID As String) As WixElement";
 //BA.debugLineNum = 64;BA.debugLine="ID = sID.ToLowerCase";
_id = _sid.toLowerCase();
 //BA.debugLineNum = 65;BA.debugLine="Width = 0";
_width = (int) (0);
 //BA.debugLineNum = 66;BA.debugLine="Cells.Initialize";
_cells.Initialize();
 //BA.debugLineNum = 67;BA.debugLine="elementsConfig.Initialize";
_elementsconfig.Initialize();
 //BA.debugLineNum = 68;BA.debugLine="Height = 0";
_height = (int) (0);
 //BA.debugLineNum = 69;BA.debugLine="Styles.Initialize";
_styles.Initialize();
 //BA.debugLineNum = 70;BA.debugLine="Element = CreateMap(\"id\":ID)";
_element = __c.createMap(new Object[] {(Object)("id"),(Object)(_id)});
 //BA.debugLineNum = 71;BA.debugLine="Value = \"\"";
_value = (Object)("");
 //BA.debugLineNum = 72;BA.debugLine="Name = ID";
_name = _id;
 //BA.debugLineNum = 73;BA.debugLine="Container = \"\"";
_container = "";
 //BA.debugLineNum = 74;BA.debugLine="Rows.Initialize";
_rows.Initialize();
 //BA.debugLineNum = 75;BA.debugLine="Elements.Initialize";
_elements.Initialize();
 //BA.debugLineNum = 76;BA.debugLine="Columns.Initialize";
_columns.Initialize();
 //BA.debugLineNum = 77;BA.debugLine="Attributes.Initialize";
_attributes.Initialize();
 //BA.debugLineNum = 78;BA.debugLine="PlaceHolder = \"\"";
_placeholder = "";
 //BA.debugLineNum = 79;BA.debugLine="Align = \"\"";
_align = "";
 //BA.debugLineNum = 80;BA.debugLine="TypeOf = \"\"";
_typeof = "";
 //BA.debugLineNum = 81;BA.debugLine="Container = \"\"";
_container = "";
 //BA.debugLineNum = 82;BA.debugLine="Label.Initialize";
_label.Initialize();
 //BA.debugLineNum = 83;BA.debugLine="Label.Text = \"\"";
_label.Text /*String*/  = "";
 //BA.debugLineNum = 84;BA.debugLine="Label.Width = 0";
_label.Width /*int*/  = (int) (0);
 //BA.debugLineNum = 85;BA.debugLine="inputWidth = 0";
_inputwidth = (int) (0);
 //BA.debugLineNum = 86;BA.debugLine="Gravity = 0";
_gravity = (int) (0);
 //BA.debugLineNum = 87;BA.debugLine="Label.Align = \"\"";
_label.Align /*String*/  = "";
 //BA.debugLineNum = 88;BA.debugLine="Label.Position = \"\"";
_label.Position /*String*/  = "";
 //BA.debugLineNum = 89;BA.debugLine="CSS = \"\"";
_css = "";
 //BA.debugLineNum = 90;BA.debugLine="Header = \"\"";
_header = "";
 //BA.debugLineNum = 91;BA.debugLine="Body = \"\"";
_body = (Object)("");
 //BA.debugLineNum = 92;BA.debugLine="HTMLAttributes.Initialize";
...
String _attr = "";
Object _strval = null;
 //BA.debugLineNum = 302;BA.debugLine="Sub Item As Map";
 //BA.debugLineNum = 303;BA.debugLine="For Each attr As String In Attributes.Keys";
{
...
_attr = BA.ObjectToString(group1.Get(index1));
 //BA.debugLineNum = 304;BA.debugLine="Dim strVal As Object = Attributes.Get(attr)";
_strval = _attributes.Get((Object)(_attr));
 //BA.debugLineNum = 305;BA.debugLine="Element.Put(attr,strVal)";
_element.Put((Object)(_attr),_strval);
 }
};
 //BA.debugLineNum = 307;BA.debugLine="SetOnCondition(Height,\"height\",Height)";
_setoncondition(_height,"height",(Object)(_height));
 //BA.debugLineNum = 308;BA.debugLine="SetOnCondition(Width, \"width\", Width)";
_setoncondition(_width,"width",(Object)(_width));
 //BA.debugLineNum = 309;BA.debugLine="SetOnContent(\"body\", Body)";
_setoncontent("body",BA.ObjectToString(_body));
 //BA.debugLineNum = 310;BA.debugLine="SetOnContent(\"header\", Header)";
_setoncontent("header",_header);
 //BA.debugLineNum = 311;BA.debugLine="SetOnContent(\"container\", Container)";
_setoncontent("container",_container);
 //BA.debugLineNum = 312;BA.debugLine="SetOnContent(\"type\", TypeOf)";
_setoncontent("type",_typeof);
 //BA.debugLineNum = 313;BA.debugLine="SetOnContent(\"view\", View)";
_setoncontent("view",_view);
 //BA.debugLineNum = 314;BA.debugLine="SetOnContent(\"name\", Name)";
_setoncontent("name",_name);
 //BA.debugLineNum = 315;BA.debugLine="SetOnContent(\"css\", CSS)";
_setoncontent("css",_css);
 //BA.debugLineNum = 316;BA.debugLine="SetOnContent(\"value\", Value)";
_setoncontent("value",BA.ObjectToString(_value));
 //BA.debugLineNum = 317;BA.debugLine="SetOnContent(\"align\", Align)";
_setoncontent("align",_align);
 //BA.debugLineNum = 318;BA.debugLine="SetOnContent(\"label\", Label.Text)";
_setoncontent("label",_label.Text /*String*/ );
 //BA.debugLineNum = 319;BA.debugLine="SetOnContent(\"placeholder\", PlaceHolder)";
_setoncontent("placeholder",_placeholder);
 //BA.debugLineNum = 320;BA.debugLine="SetOnContent(\"labelPosition\", Label.Position)";
_setoncontent("labelPosition",_label.Position /*String*/ );
 //BA.debugLineNum = 321;BA.debugLine="SetOnContent(\"labelAlign\", Label.Align)";
_setoncontent("labelAlign",_label.Align /*String*/ );
 //BA.debugLineNum = 322;BA.debugLine="SetOnCondition(Gravity,\"gravity\", Gravity)";
_setoncondition(_gravity,"gravity",(Object)(_gravity));
 //BA.debugLineNum = 323;BA.debugLine="SetOnCondition(Label.Width,\"labelWidth\", Label.Wi";
_setoncondition(_label.Width /*int*/ ,"labelWidth",(Object)(_label.Width /*int*/ ));
 //BA.debugLineNum = 324;BA.debugLine="SetOnCondition(Columns.Size,\"cols\", Columns)";
_setoncondition(_columns.getSize(),"cols",(Object)(_columns.getObject()));
 //BA.debugLineNum = 325;BA.debugLine="SetOnCondition(Rows.Size, \"rows\", Rows)";
_setoncondition(_rows.getSize(),"rows",(Object)(_rows.getObject()));
 //BA.debugLineNum = 326;BA.debugLine="SetOnCondition(Elements.Size, \"elements\", Element";
_setoncondition(_elements.getSize(),"elements",(Object)(_elements.getObject()));
 //BA.debugLineNum = 327;BA.debugLine="SetOnCondition(Cells.Size, \"cells\", Cells)";
_setoncondition(_cells.getSize(),"cells",(Object)(_cells.getObject()));
 //BA.debugLineNum = 328;BA.debugLine="SetOnCondition(inputWidth,\"inputWidth\",inputWidth";
_setoncondition(_inputwidth,"inputWidth",(Object)(_inputwidth));
 //BA.debugLineNum = 329;BA.debugLine="SetOnCondition(HTMLAttributes.Size, \"attributes\",";
_setoncondition(_htmlattributes.getSize(),"attributes",(Object)(_htmlattributes.getObject()));
 //BA.debugLineNum = 330;BA.debugLine="SetOnCondition(elementsConfig.Size, \"elementsConf";
_setoncondition(_elementsconfig.getSize(),"elementsConfig",(Object)(_elementsconfig.getObject()));
 //BA.debugLineNum = 331;BA.debugLine="SetOnCondition(Styles.Size, \"css\", Styles)";
_setoncondition(_styles.getSize(),"css",(Object)(_styles.getObject()));
 //BA.debugLineNum = 332;BA.debugLine="Return Element";
if (true) return _element;
 //BA.debugLineNum = 333;BA.debugLine="End Sub";
return null;
}
public b4j.example.wixelement  _setaligncenter(String _r) throws Exception{
 //BA.debugLineNum = 457;BA.debugLine="Sub SetAlignCenter(r As String) As WixElement 'ign";
 //BA.debugLineNum = 458;BA.debugLine="Align = \"center\"";
_align = "center";
...
public b4j.example.wixelement  _setalignleft(String _r) throws Exception{
 //BA.debugLineNum = 463;BA.debugLine="Sub SetAlignLeft(r As String) As WixElement 'ignor";
 //BA.debugLineNum = 464;BA.debugLine="Align = \"left\"";
_align = "left";
...
public b4j.example.wixelement  _setalignright(String _r) throws Exception{
 //BA.debugLineNum = 451;BA.debugLine="Sub SetAlignRight(r As String) As WixElement 'igno";
 //BA.debugLineNum = 452;BA.debugLine="Align = \"right\"";
_align = "right";
...
public b4j.example.wixelement  _setanimate(boolean _b) throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Sub SetAnimate(b As Boolean) As WixElement";
 //BA.debugLineNum = 159;BA.debugLine="SetProperty(\"animate\",b)";
...
public b4j.example.wixelement  _setattr(String _attrname,Object _attrvalue) throws Exception{
 //BA.debugLineNum = 290;BA.debugLine="Sub SetAttr(attrName As String, attrValue As Objec";
 //BA.debugLineNum = 291;BA.debugLine="SetOnContent(attrName,attrValue)";
...
public b4j.example.wixelement  _setbatch(int _b) throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Sub SetBatch(b As Int) As WixElement";
 //BA.debugLineNum = 153;BA.debugLine="SetProperty(\"batch\",b)";
...
public b4j.example.wixelement  _setbody(Object _b) throws Exception{
 //BA.debugLineNum = 242;BA.debugLine="Sub SetBody(b As Object) As WixElement";
 //BA.debugLineNum = 243;BA.debugLine="Body = b";
_body = _b;
...
public b4j.example.wixelement  _setborderless(boolean _b) throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub SetBorderLess(b As Boolean) As WixElement";
 //BA.debugLineNum = 40;BA.debugLine="SetProperty(\"borderless\", b)";
...
public b4j.example.wixelement  _setclick(com.ab.banano.BANanoObject _c) throws Exception{
 //BA.debugLineNum = 354;BA.debugLine="Sub SetClick(c As BANanoObject) As WixElement";
 //BA.debugLineNum = 355;BA.debugLine="Element.Put(\"click\", c)";
...
public b4j.example.wixelement  _setcollapsed(boolean _c) throws Exception{
 //BA.debugLineNum = 542;BA.debugLine="Sub SetCollapsed(c As Boolean) As WixElement";
 //BA.debugLineNum = 543;BA.debugLine="SetProperty(\"collapsed\", c)";
...
public b4j.example.wixelement  _setcontainer(String _c) throws Exception{
 //BA.debugLineNum = 33;BA.debugLine="Sub SetContainer(c As String) As WixElement";
 //BA.debugLineNum = 34;BA.debugLine="SetAttr(\"container\", c)";
...
public b4j.example.wixelement  _setcss(String _cs) throws Exception{
 //BA.debugLineNum = 284;BA.debugLine="Sub SetCSS(cs As String) As WixElement";
 //BA.debugLineNum = 285;BA.debugLine="CSS = cs";
_css = _cs;
...
public b4j.example.wixelement  _setdata(anywheresoftware.b4a.objects.collections.List _d) throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub SetData(d As List) As WixElement";
 //BA.debugLineNum = 231;BA.debugLine="Element.Put(\"data\", d)";
...
public b4j.example.wixelement  _setdefaultalign(String _a) throws Exception{
 //BA.debugLineNum = 134;BA.debugLine="Sub SetDefaultAlign(a As String) As WixElement";
 //BA.debugLineNum = 135;BA.debugLine="elementsConfig.Put(\"align\", a)";
...
public b4j.example.wixelement  _setdefaultlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 115;BA.debugLine="Sub SetDefaultLabelAlign(a As String) As WixElemen";
 //BA.debugLineNum = 116;BA.debugLine="elementsConfig.Put(\"labelAlign\", a)";
...
public b4j.example.wixelement  _setdefaultlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub SetDefaultLabelPosition(p As String) As WixEle";
 //BA.debugLineNum = 129;BA.debugLine="elementsConfig.Put(\"labelPosition\", p)";
...
public b4j.example.wixelement  _setdefaultlabelwidth(int _a) throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Sub SetDefaultLabelWidth(a As Int) As WixElement";
 //BA.debugLineNum = 122;BA.debugLine="elementsConfig.Put(\"labelWidth\", a)";
...
public b4j.example.wixelement  _setdefaulttype(String _a) throws Exception{
 //BA.debugLineNum = 109;BA.debugLine="Sub SetDefaultType(a As String) As WixElement";
 //BA.debugLineNum = 110;BA.debugLine="elementsConfig.Put(\"type\", a)";
...
public b4j.example.wixelement  _setdefaulttypeicon(String _r) throws Exception{
 //BA.debugLineNum = 566;BA.debugLine="Sub SetDefaultTypeIcon(r As String) As WixElement";
 //BA.debugLineNum = 567;BA.debugLine="TypeOf = \"icon\"";
_typeof = "icon";
...
public b4j.example.wixelement  _setdefaulttypeiconbutton() throws Exception{
 //BA.debugLineNum = 548;BA.debugLine="Sub SetDefaultTypeIconButton() As WixElement";
 //BA.debugLineNum = 549;BA.debugLine="TypeOf = \"iconButton\"";
_typeof = "iconButton";
...
public b4j.example.wixelement  _setdefaulttypeiconbuttontop(String _r) throws Exception{
 //BA.debugLineNum = 572;BA.debugLine="Sub SetDefaultTypeIconButtonTop(r As String) As Wi";
 //BA.debugLineNum = 573;BA.debugLine="TypeOf = \"iconButtonTop\"";
...
public b4j.example.wixelement  _setdefaulttypeimage(String _r) throws Exception{
 //BA.debugLineNum = 560;BA.debugLine="Sub SetDefaultTypeImage(r As String) As WixElement";
 //BA.debugLineNum = 561;BA.debugLine="TypeOf = \"image\"";
_typeof = "image";
...
public b4j.example.wixelement  _setdefaulttypeimagebutton(String _r) throws Exception{
 //BA.debugLineNum = 554;BA.debugLine="Sub SetDefaultTypeImageButton(r As String) As WixE";
 //BA.debugLineNum = 555;BA.debugLine="TypeOf =  \"imageButton\"";
_typeof = "imageButton";
...
public b4j.example.wixelement  _setdefaultview(String _a) throws Exception{
 //BA.debugLineNum = 103;BA.debugLine="Sub SetDefaultView(a As String) As WixElement";
 //BA.debugLineNum = 104;BA.debugLine="elementsConfig.Put(\"view\", a)";
...
public b4j.example.wixelement  _setdefaultwidth(int _w) throws Exception{
 //BA.debugLineNum = 140;BA.debugLine="Sub SetDefaultWidth(w As Int) As WixElement";
 //BA.debugLineNum = 141;BA.debugLine="elementsConfig.Put(\"width\", w)";
...
public b4j.example.wixelement  _setgravity(int _g) throws Exception{
 //BA.debugLineNum = 248;BA.debugLine="Sub SetGravity(g As Int) As WixElement";
 //BA.debugLineNum = 249;BA.debugLine="Gravity = g";
_gravity = _g;
...
public b4j.example.wixelement  _setheader(String _h) throws Exception{
 //BA.debugLineNum = 236;BA.debugLine="Sub SetHeader(h As String) As WixElement";
 //BA.debugLineNum = 237;BA.debugLine="Header = h";
_header = _h;
...
public b4j.example.wixelement  _setheight(int _h) throws Exception{
 //BA.debugLineNum = 272;BA.debugLine="Sub SetHeight(h As Int) As WixElement";
 //BA.debugLineNum = 273;BA.debugLine="Height = h";
_height = _h;
...
public b4j.example.wixelement  _sethtmlattr(String _attrname,Object _attrvalue) throws Exception{
 //BA.debugLineNum = 296;BA.debugLine="Sub SetHTMLAttr(attrName As String, attrValue As O";
 //BA.debugLineNum = 297;BA.debugLine="HTMLAttributes.put(attrName,attrValue)";
...
public b4j.example.wixelement  _seticon(String _i) throws Exception{
 //BA.debugLineNum = 342;BA.debugLine="Sub SetIcon(i As String) As WixElement";
 //BA.debugLineNum = 343;BA.debugLine="SetOnContent(\"icon\", i)";
...
public b4j.example.wixelement  _setinputwidth(int _w) throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub SetInputWidth(w As Int) As WixElement";
 //BA.debugLineNum = 201;BA.debugLine="SetProperty(\"inputWidth\", w)";
...
public b4j.example.wixelement  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 348;BA.debugLine="Sub SetLabel(l As String) As WixElement";
 //BA.debugLineNum = 349;BA.debugLine="SetOnContent(\"label\", l)";
...
public b4j.example.wixelement  _setlabelheight(int _h) throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub SetLabelHeight(h As Int) As WixElement";
 //BA.debugLineNum = 52;BA.debugLine="SetProperty(\"labelHeight\", h)";
...
public b4j.example.wixelement  _setmargin(String _margin) throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub SetMargin(margin As String) As WixElement";
 //BA.debugLineNum = 195;BA.debugLine="Element.Put(\"margin\", margin)";
...
public b4j.example.wixelement  _setmaxheight(int _h) throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub SetMaxHeight(h As Int) As WixElement";
 //BA.debugLineNum = 189;BA.debugLine="Element.Put(\"maxHeight\", h)";
...
public b4j.example.wixelement  _setmaxwidth(int _w) throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub SetMaxWidth(w As Int) As WixElement";
 //BA.debugLineNum = 183;BA.debugLine="Element.Put(\"maxWidth\", w)";
...
public b4j.example.wixelement  _setminheight(int _h) throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Sub SetMinHeight(h As Int) As WixElement";
 //BA.debugLineNum = 177;BA.debugLine="Element.Put(\"minHeight\", h)";
...
public b4j.example.wixelement  _setminwidth(int _w) throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub SetMinWidth(w As Int) As WixElement";
 //BA.debugLineNum = 171;BA.debugLine="Element.put(\"minwidth\",w)";
...
public b4j.example.wixelement  _setmultiview(boolean _b) throws Exception{
 //BA.debugLineNum = 336;BA.debugLine="Sub SetMultiView(b As Boolean) As WixElement";
 //BA.debugLineNum = 337;BA.debugLine="SetProperty(\"multiview\", b)";
...
public b4j.example.wixelement  _setoncondition(int _condition,String _prop,Object _propvalue) throws Exception{
 //BA.debugLineNum = 487;BA.debugLine="Sub SetOnCondition(Condition As Int, Prop As Strin";
 //BA.debugLineNum = 488;BA.debugLine="If Condition <= 0 Then Return Me";
if (_condition<=0) { 
if (true) return (b4j.example.wixelement)(this);};
...
public b4j.example.wixelement  _setoncontent(String _prop,String _propvalue) throws Exception{
 //BA.debugLineNum = 480;BA.debugLine="Sub SetOnContent(Prop As String, PropValue As Stri";
 //BA.debugLineNum = 481;BA.debugLine="If PropValue = \"\" Then Return Me";
if ((_propvalue).equals("")) { 
if (true) return (b4j.example.wixelement)(this);};
 //BA.debugLineNum = 482;BA.debugLine="Element.put(Prop,PropValue)";
...
public b4j.example.wixelement  _setpadding(String _padding) throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub SetPadding(padding As String) As WixElement";
 //BA.debugLineNum = 207;BA.debugLine="Element.Put(\"padding\", padding)";
...
public b4j.example.wixelement  _setpaddingx(String _x) throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub SetPaddingX(x As String) As WixElement";
 //BA.debugLineNum = 213;BA.debugLine="Element.Put(\"paddingX\", x)";
...
public b4j.example.wixelement  _setpaddingy(String _y) throws Exception{
 //BA.debugLineNum = 218;BA.debugLine="Sub SetPaddingY(y As String) As WixElement";
 //BA.debugLineNum = 219;BA.debugLine="Element.Put(\"paddingY\",y)";
...
public b4j.example.wixelement  _setproperty(String _p,Object _v) throws Exception{
 //BA.debugLineNum = 224;BA.debugLine="Sub SetProperty(p As String, v As Object) As WixEl";
 //BA.debugLineNum = 225;BA.debugLine="Element.Put(p,v)";
...
public b4j.example.wixelement  _setrequired(boolean _b) throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Sub SetRequired(b As Boolean) As WixElement";
 //BA.debugLineNum = 98;BA.debugLine="SetProperty(\"required\", b)";
...
public b4j.example.wixelement  _setselect(boolean _b) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub SetSelect(b As Boolean) As WixElement";
 //BA.debugLineNum = 46;BA.debugLine="SetProperty(\"select\", b)";
...
public b4j.example.wixelement  _setstyle(String _prop,String _val) throws Exception{
 //BA.debugLineNum = 164;BA.debugLine="Sub SetStyle(prop As String, val As String) As Wix";
 //BA.debugLineNum = 165;BA.debugLine="Styles.Put(prop,val)";
...
public b4j.example.wixelement  _settemplate(Object _t) throws Exception{
 //BA.debugLineNum = 368;BA.debugLine="Sub SetTemplate(t As Object) As WixElement";
 //BA.debugLineNum = 369;BA.debugLine="Element.Put(\"template\", t)";
...
public b4j.example.wixelement  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub SetTooltip(tt As String) As WixElement";
 //BA.debugLineNum = 58;BA.debugLine="SetProperty(\"tooltip\", tt)";
...
public b4j.example.wixelement  _settype(String _t) throws Exception{
 //BA.debugLineNum = 266;BA.debugLine="Sub SetType(t As String) As WixElement";
 //BA.debugLineNum = 267;BA.debugLine="TypeOf = t";
_typeof = _t;
...
public b4j.example.wixelement  _settypeclean() throws Exception{
 //BA.debugLineNum = 494;BA.debugLine="Sub SetTypeClean As WixElement";
 //BA.debugLineNum = 495;BA.debugLine="SetType(\"clean\")";
_settype("clean");
...
public b4j.example.wixelement  _settypeform() throws Exception{
 //BA.debugLineNum = 524;BA.debugLine="Sub SetTypeForm As WixElement";
 //BA.debugLineNum = 525;BA.debugLine="SetType(\"form\")";
_settype("form");
...
public b4j.example.wixelement  _settypehead() throws Exception{
 //BA.debugLineNum = 518;BA.debugLine="Sub SetTypeHead As WixElement";
 //BA.debugLineNum = 519;BA.debugLine="SetType(\"head\")";
_settype("head");
...
public b4j.example.wixelement  _settypeline() throws Exception{
 //BA.debugLineNum = 500;BA.debugLine="Sub SetTypeLine As WixElement";
 //BA.debugLineNum = 501;BA.debugLine="SetType(\"line\")";
_settype("line");
...
public b4j.example.wixelement  _settypespace() throws Exception{
 //BA.debugLineNum = 512;BA.debugLine="Sub SetTypeSpace As WixElement";
 //BA.debugLineNum = 513;BA.debugLine="SetType(\"space\")";
_settype("space");
...
public b4j.example.wixelement  _settypewide() throws Exception{
 //BA.debugLineNum = 506;BA.debugLine="Sub SetTypeWide As WixElement";
 //BA.debugLineNum = 507;BA.debugLine="SetType(\"wide\")";
_settype("wide");
...
public b4j.example.wixelement  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 260;BA.debugLine="Sub SetValue(v As String) As WixElement";
 //BA.debugLineNum = 261;BA.debugLine="Value = v";
_value = (Object)(_v);
...
public b4j.example.wixelement  _setview(String _v) throws Exception{
 //BA.debugLineNum = 254;BA.debugLine="Sub SetView(v As String) As WixElement";
 //BA.debugLineNum = 255;BA.debugLine="View = v";
_view = _v;
...
public b4j.example.wixelement  _setviewheaderlayout() throws Exception{
 //BA.debugLineNum = 531;BA.debugLine="Sub SetViewHeaderLayout As WixElement";
 //BA.debugLineNum = 532;BA.debugLine="SetView(\"headerlayout\")";
...
public b4j.example.wixelement  _setvisiblebatch(int _b) throws Exception{
 //BA.debugLineNum = 146;BA.debugLine="Sub SetVisibleBatch(b As Int) As WixElement";
 //BA.debugLineNum = 147;BA.debugLine="SetProperty(\"visibleBatch\", b)";
...
public b4j.example.wixelement  _setwidth(int _w) throws Exception{
 //BA.debugLineNum = 278;BA.debugLine="Sub SetWidth(w As Int) As WixElement";
 //BA.debugLineNum = 279;BA.debugLine="Width = w";
_width = _w;
