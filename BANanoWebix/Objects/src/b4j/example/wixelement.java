...
public b4j.example.wixelement  _addcells(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 333;BA.debugLine="Sub AddCells(itm As Map) As WixElement";
 //BA.debugLineNum = 334;BA.debugLine="Cells.Add(itm)";
...
public String  _addcolumn(b4j.example.wixcolumn _wxel) throws Exception{
 //BA.debugLineNum = 428;BA.debugLine="Sub AddColumn(wxEL As WixColumn)";
 //BA.debugLineNum = 429;BA.debugLine="AddColumns(wxEL.Item)";
...
public b4j.example.wixelement  _addcolumns(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 327;BA.debugLine="Sub AddColumns(itm As Map) As WixElement";
 //BA.debugLineNum = 328;BA.debugLine="Columns.Add(itm)";
...
anywheresoftware.b4a.objects.collections.Map _opt = null;
 //BA.debugLineNum = 348;BA.debugLine="Sub AddColumnsCells(mCells As List) As WixElement";
 //BA.debugLineNum = 349;BA.debugLine="Dim opt As Map = CreateMap()";
_opt = new anywheresoftware.b4a.objects.collections.Map();
_opt = __c.createMap(new Object[] {});
 //BA.debugLineNum = 350;BA.debugLine="opt.Put(\"cells\", mCells)";
_opt.Put((Object)("cells"),(Object)(_mcells.getObject()));
 //BA.debugLineNum = 351;BA.debugLine="AddColumns(opt)";
_addcolumns(_opt);
...
b4j.example.wixelement _s = null;
 //BA.debugLineNum = 391;BA.debugLine="Sub AddColumnsSpacer()";
 //BA.debugLineNum = 392;BA.debugLine="Dim s As WixElement";
_s = new b4j.example.wixelement();
 //BA.debugLineNum = 393;BA.debugLine="s.Initialize(\"\").SetView(\"spacer\")";
_s._initialize /*b4j.example.wixelement*/ (ba,"")._setview /*b4j.example.wixelement*/ ("spacer");
 //BA.debugLineNum = 394;BA.debugLine="AddColumns(s.item)";
...
public b4j.example.wixelement  _addelements(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 356;BA.debugLine="Sub AddElements(itm As Map) As WixElement";
 //BA.debugLineNum = 357;BA.debugLine="Elements.Add(itm)";
...
public b4j.example.wixelement  _additem(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 368;BA.debugLine="Sub AddItem(itm As Map) As WixElement";
 //BA.debugLineNum = 369;BA.debugLine="Elements.Add(itm)";
_elements.Add((Object)(_itm.getObject()));
...
b4j.example.wixresizer _r = null;
 //BA.debugLineNum = 313;BA.debugLine="Sub AddResizerToColumns As WixElement";
 //BA.debugLineNum = 314;BA.debugLine="Dim r As WixResizer";
_r = new b4j.example.wixresizer();
 //BA.debugLineNum = 315;BA.debugLine="r.Initialize(\"\")";
_r._initialize /*b4j.example.wixresizer*/ (ba,"");
 //BA.debugLineNum = 316;BA.debugLine="AddColumns(r.Item)";
...
public String  _addrow(b4j.example.wixrow _wxel) throws Exception{
 //BA.debugLineNum = 374;BA.debugLine="Sub AddRow(wxEL As WixRow)";
 //BA.debugLineNum = 375;BA.debugLine="AddRows(wxEL.Item)";
...
public b4j.example.wixelement  _addrows(anywheresoftware.b4a.objects.collections.Map _itm) throws Exception{
 //BA.debugLineNum = 362;BA.debugLine="Sub AddRows(itm As Map) As WixElement";
 //BA.debugLineNum = 363;BA.debugLine="Rows.Add(itm)";
...
anywheresoftware.b4a.objects.collections.Map _opt = null;
 //BA.debugLineNum = 339;BA.debugLine="Sub AddRowsCells(mCells As List) As WixElement";
 //BA.debugLineNum = 340;BA.debugLine="Dim opt As Map = CreateMap()";
_opt = new anywheresoftware.b4a.objects.collections.Map();
_opt = __c.createMap(new Object[] {});
 //BA.debugLineNum = 341;BA.debugLine="opt.Put(\"cells\", mCells)";
_opt.Put((Object)("cells"),(Object)(_mcells.getObject()));
 //BA.debugLineNum = 342;BA.debugLine="AddRows(opt)";
_addrows(_opt);
...
b4j.example.wixelement _s = null;
 //BA.debugLineNum = 384;BA.debugLine="Sub AddRowsSpacer()";
 //BA.debugLineNum = 385;BA.debugLine="Dim s As WixElement";
_s = new b4j.example.wixelement();
 //BA.debugLineNum = 386;BA.debugLine="s.Initialize(\"\").SetView(\"spacer\")";
_s._initialize /*b4j.example.wixelement*/ (ba,"")._setview /*b4j.example.wixelement*/ ("spacer");
 //BA.debugLineNum = 387;BA.debugLine="AddRows(s.item)";
...
public b4j.example.wixelement  _addtocolumns(b4j.example.wixelement _prt) throws Exception{
 //BA.debugLineNum = 398;BA.debugLine="Sub AddToColumns(prt As WixElement) As WixElement";
 //BA.debugLineNum = 399;BA.debugLine="prt.AddColumns(Item)";
...
public b4j.example.wixelement  _addtoelements(b4j.example.wixelement _prt) throws Exception{
 //BA.debugLineNum = 422;BA.debugLine="Sub AddToElements(prt As WixElement) As WixElement";
 //BA.debugLineNum = 423;BA.debugLine="prt.AddElements(Item)";
...
public String  _addtorow(b4j.example.wixrow _r) throws Exception{
 //BA.debugLineNum = 490;BA.debugLine="Sub AddToRow(r As WixRow)";
 //BA.debugLineNum = 491;BA.debugLine="r.AddItem(Item)";
_r._additem /*b4j.example.wixrow*/ (_item());
 //BA.debugLineNum = 492;BA.debugLine="End Sub";
return "";
}
public String  _addtorows(b4j.example.wixelement _prt) throws Exception{
 //BA.debugLineNum = 379;BA.debugLine="Sub AddToRows(prt As WixElement)";
 //BA.debugLineNum = 380;BA.debugLine="prt.AddRows(Item)";
...
innerInitialize(_ba);
 //BA.debugLineNum = 33;BA.debugLine="Public Sub Initialize(sID As String) As WixElement";
 //BA.debugLineNum = 34;BA.debugLine="ID = sID.ToLowerCase";
_id = _sid.toLowerCase();
 //BA.debugLineNum = 35;BA.debugLine="Template = \"\"";
_template = "";
 //BA.debugLineNum = 36;BA.debugLine="Width = 0";
_width = (int) (0);
 //BA.debugLineNum = 37;BA.debugLine="Cells.Initialize";
_cells.Initialize();
 //BA.debugLineNum = 38;BA.debugLine="elementsConfig.Initialize";
_elementsconfig.Initialize();
 //BA.debugLineNum = 39;BA.debugLine="Height = 0";
_height = (int) (0);
 //BA.debugLineNum = 40;BA.debugLine="Styles.Initialize";
_styles.Initialize();
 //BA.debugLineNum = 41;BA.debugLine="Element = CreateMap(\"id\":ID)";
_element = __c.createMap(new Object[] {(Object)("id"),(Object)(_id)});
 //BA.debugLineNum = 42;BA.debugLine="Value = \"\"";
_value = (Object)("");
 //BA.debugLineNum = 43;BA.debugLine="Name = ID";
_name = _id;
 //BA.debugLineNum = 44;BA.debugLine="Container = \"\"";
_container = "";
 //BA.debugLineNum = 45;BA.debugLine="Rows.Initialize";
_rows.Initialize();
 //BA.debugLineNum = 46;BA.debugLine="Elements.Initialize";
_elements.Initialize();
 //BA.debugLineNum = 47;BA.debugLine="Columns.Initialize";
_columns.Initialize();
 //BA.debugLineNum = 48;BA.debugLine="Attributes.Initialize";
_attributes.Initialize();
 //BA.debugLineNum = 49;BA.debugLine="PlaceHolder = \"\"";
_placeholder = "";
 //BA.debugLineNum = 50;BA.debugLine="Align = \"\"";
_align = "";
 //BA.debugLineNum = 51;BA.debugLine="TypeOf = \"\"";
_typeof = "";
 //BA.debugLineNum = 52;BA.debugLine="Container = \"\"";
_container = "";
 //BA.debugLineNum = 53;BA.debugLine="Label.Initialize";
_label.Initialize();
 //BA.debugLineNum = 54;BA.debugLine="Label.Text = \"\"";
_label.Text /*String*/  = "";
 //BA.debugLineNum = 55;BA.debugLine="Label.Width = 0";
_label.Width /*int*/  = (int) (0);
 //BA.debugLineNum = 56;BA.debugLine="inputWidth = 0";
_inputwidth = (int) (0);
 //BA.debugLineNum = 57;BA.debugLine="Gravity = 0";
_gravity = (int) (0);
 //BA.debugLineNum = 58;BA.debugLine="Label.Align = \"\"";
_label.Align /*String*/  = "";
 //BA.debugLineNum = 59;BA.debugLine="Label.Position = \"\"";
_label.Position /*String*/  = "";
 //BA.debugLineNum = 60;BA.debugLine="CSS = \"\"";
_css = "";
 //BA.debugLineNum = 61;BA.debugLine="Header = \"\"";
_header = "";
 //BA.debugLineNum = 62;BA.debugLine="Body = \"\"";
_body = "";
 //BA.debugLineNum = 63;BA.debugLine="HTMLAttributes.Initialize";
...
String _attr = "";
Object _strval = null;
 //BA.debugLineNum = 254;BA.debugLine="Sub Item As Map";
 //BA.debugLineNum = 255;BA.debugLine="For Each attr As String In Attributes.Keys";
{
...
_attr = BA.ObjectToString(group1.Get(index1));
 //BA.debugLineNum = 256;BA.debugLine="Dim strVal As Object = Attributes.Get(attr)";
_strval = _attributes.Get((Object)(_attr));
 //BA.debugLineNum = 257;BA.debugLine="Element.Put(attr,strVal)";
_element.Put((Object)(_attr),_strval);
 }
};
 //BA.debugLineNum = 259;BA.debugLine="SetOnCondition(Height,\"height\",Height)";
_setoncondition(_height,"height",(Object)(_height));
 //BA.debugLineNum = 260;BA.debugLine="SetOnCondition(Width, \"width\", Width)";
_setoncondition(_width,"width",(Object)(_width));
 //BA.debugLineNum = 261;BA.debugLine="SetOnContent(\"body\", Body)";
_setoncontent("body",_body);
 //BA.debugLineNum = 262;BA.debugLine="SetOnContent(\"header\", Header)";
_setoncontent("header",_header);
 //BA.debugLineNum = 263;BA.debugLine="SetOnContent(\"container\", Container)";
_setoncontent("container",_container);
 //BA.debugLineNum = 264;BA.debugLine="SetOnContent(\"type\", TypeOf)";
_setoncontent("type",_typeof);
 //BA.debugLineNum = 265;BA.debugLine="SetOnContent(\"view\", View)";
_setoncontent("view",_view);
 //BA.debugLineNum = 266;BA.debugLine="SetOnContent(\"name\", Name)";
_setoncontent("name",_name);
 //BA.debugLineNum = 267;BA.debugLine="SetOnContent(\"css\", CSS)";
_setoncontent("css",_css);
 //BA.debugLineNum = 268;BA.debugLine="SetOnContent(\"value\", Value)";
_setoncontent("value",BA.ObjectToString(_value));
 //BA.debugLineNum = 269;BA.debugLine="SetOnContent(\"align\", Align)";
_setoncontent("align",_align);
 //BA.debugLineNum = 270;BA.debugLine="SetOnContent(\"template\", Template)";
_setoncontent("template",_template);
 //BA.debugLineNum = 271;BA.debugLine="SetOnContent(\"label\", Label.Text)";
_setoncontent("label",_label.Text /*String*/ );
 //BA.debugLineNum = 272;BA.debugLine="SetOnContent(\"placeholder\", PlaceHolder)";
_setoncontent("placeholder",_placeholder);
 //BA.debugLineNum = 273;BA.debugLine="SetOnContent(\"labelPosition\", Label.Position)";
_setoncontent("labelPosition",_label.Position /*String*/ );
 //BA.debugLineNum = 274;BA.debugLine="SetOnContent(\"labelAlign\", Label.Align)";
_setoncontent("labelAlign",_label.Align /*String*/ );
 //BA.debugLineNum = 275;BA.debugLine="SetOnCondition(Gravity,\"gravity\", Gravity)";
_setoncondition(_gravity,"gravity",(Object)(_gravity));
 //BA.debugLineNum = 276;BA.debugLine="SetOnCondition(Label.Width,\"labelWidth\", Label.Wi";
_setoncondition(_label.Width /*int*/ ,"labelWidth",(Object)(_label.Width /*int*/ ));
 //BA.debugLineNum = 277;BA.debugLine="SetOnCondition(Columns.Size,\"cols\", Columns)";
_setoncondition(_columns.getSize(),"cols",(Object)(_columns.getObject()));
 //BA.debugLineNum = 278;BA.debugLine="SetOnCondition(Rows.Size, \"rows\", Rows)";
_setoncondition(_rows.getSize(),"rows",(Object)(_rows.getObject()));
 //BA.debugLineNum = 279;BA.debugLine="SetOnCondition(Elements.Size, \"elements\", Element";
_setoncondition(_elements.getSize(),"elements",(Object)(_elements.getObject()));
 //BA.debugLineNum = 280;BA.debugLine="SetOnCondition(Cells.Size, \"cells\", Cells)";
_setoncondition(_cells.getSize(),"cells",(Object)(_cells.getObject()));
 //BA.debugLineNum = 281;BA.debugLine="SetOnCondition(inputWidth,\"inputWidth\",inputWidth";
_setoncondition(_inputwidth,"inputWidth",(Object)(_inputwidth));
 //BA.debugLineNum = 282;BA.debugLine="SetOnCondition(HTMLAttributes.Size, \"attributes\",";
_setoncondition(_htmlattributes.getSize(),"attributes",(Object)(_htmlattributes.getObject()));
 //BA.debugLineNum = 283;BA.debugLine="SetOnCondition(elementsConfig.Size, \"elementsConf";
_setoncondition(_elementsconfig.getSize(),"elementsConfig",(Object)(_elementsconfig.getObject()));
 //BA.debugLineNum = 284;BA.debugLine="SetOnCondition(Styles.Size, \"css\", Styles)";
_setoncondition(_styles.getSize(),"css",(Object)(_styles.getObject()));
 //BA.debugLineNum = 285;BA.debugLine="Return Element";
if (true) return _element;
 //BA.debugLineNum = 286;BA.debugLine="End Sub";
return null;
}
public b4j.example.wixelement  _setaligncenter() throws Exception{
 //BA.debugLineNum = 410;BA.debugLine="Sub SetAlignCenter() As WixElement";
 //BA.debugLineNum = 411;BA.debugLine="Align = \"center\"";
_align = "center";
...
public b4j.example.wixelement  _setalignleft() throws Exception{
 //BA.debugLineNum = 416;BA.debugLine="Sub SetAlignLeft() As WixElement";
 //BA.debugLineNum = 417;BA.debugLine="Align = \"left\"";
_align = "left";
...
public b4j.example.wixelement  _setalignright() throws Exception{
 //BA.debugLineNum = 404;BA.debugLine="Sub SetAlignRight() As WixElement";
 //BA.debugLineNum = 405;BA.debugLine="Align = \"right\"";
_align = "right";
...
public b4j.example.wixelement  _setanimate(boolean _b) throws Exception{
 //BA.debugLineNum = 116;BA.debugLine="Sub SetAnimate(b As Boolean) As WixElement";
 //BA.debugLineNum = 117;BA.debugLine="SetProperty(\"animate\",b)";
...
public b4j.example.wixelement  _setattr(String _attrname,Object _attrvalue) throws Exception{
 //BA.debugLineNum = 242;BA.debugLine="Sub SetAttr(attrName As String, attrValue As Objec";
 //BA.debugLineNum = 243;BA.debugLine="SetOnContent(attrName,attrValue)";
...
public b4j.example.wixelement  _setbatch(int _b) throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Sub SetBatch(b As Int) As WixElement";
 //BA.debugLineNum = 111;BA.debugLine="SetProperty(\"batch\",b)";
...
public b4j.example.wixelement  _setbody(String _b) throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub SetBody(b As String) As WixElement";
 //BA.debugLineNum = 195;BA.debugLine="Body = b";
_body = _b;
...
public b4j.example.wixelement  _setclick(com.ab.banano.BANanoObject _c) throws Exception{
 //BA.debugLineNum = 307;BA.debugLine="Sub SetClick(c As BANanoObject) As WixElement";
 //BA.debugLineNum = 308;BA.debugLine="Element.Put(\"click\", c)";
...
public b4j.example.wixelement  _setcollapsed(boolean _c) throws Exception{
 //BA.debugLineNum = 495;BA.debugLine="Sub SetCollapsed(c As Boolean) As WixElement";
 //BA.debugLineNum = 496;BA.debugLine="SetProperty(\"collapsed\", c)";
...
public b4j.example.wixelement  _setcss(String _cs) throws Exception{
 //BA.debugLineNum = 236;BA.debugLine="Sub SetCSS(cs As String) As WixElement";
 //BA.debugLineNum = 237;BA.debugLine="CSS = cs";
_css = _cs;
...
public b4j.example.wixelement  _setdata(anywheresoftware.b4a.objects.collections.List _d) throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub SetData(d As List) As WixElement";
 //BA.debugLineNum = 183;BA.debugLine="Element.Put(\"data\", d)";
...
public b4j.example.wixelement  _setdefaultalign(String _a) throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Sub SetDefaultAlign(a As String) As WixElement";
 //BA.debugLineNum = 93;BA.debugLine="elementsConfig.Put(\"align\", a)";
...
public b4j.example.wixelement  _setdefaultlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 80;BA.debugLine="Sub SetDefaultLabelAlign(a As String) As WixElemen";
 //BA.debugLineNum = 81;BA.debugLine="elementsConfig.Put(\"labelAlign\", a)";
...
public b4j.example.wixelement  _setdefaultlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 86;BA.debugLine="Sub SetDefaultLabelPosition(p As String) As WixEle";
 //BA.debugLineNum = 87;BA.debugLine="elementsConfig.Put(\"labelPosition\", p)";
...
public b4j.example.wixelement  _setdefaulttype(String _a) throws Exception{
 //BA.debugLineNum = 74;BA.debugLine="Sub SetDefaultType(a As String) As WixElement";
 //BA.debugLineNum = 75;BA.debugLine="elementsConfig.Put(\"type\", a)";
...
public b4j.example.wixelement  _setdefaulttypeicon(String _r) throws Exception{
 //BA.debugLineNum = 519;BA.debugLine="Sub SetDefaultTypeIcon(r As String) As WixElement";
 //BA.debugLineNum = 520;BA.debugLine="TypeOf = \"icon\"";
_typeof = "icon";
...
public b4j.example.wixelement  _setdefaulttypeiconbutton() throws Exception{
 //BA.debugLineNum = 501;BA.debugLine="Sub SetDefaultTypeIconButton() As WixElement";
 //BA.debugLineNum = 502;BA.debugLine="TypeOf = \"iconButton\"";
_typeof = "iconButton";
...
public b4j.example.wixelement  _setdefaulttypeiconbuttontop(String _r) throws Exception{
 //BA.debugLineNum = 525;BA.debugLine="Sub SetDefaultTypeIconButtonTop(r As String) As Wi";
 //BA.debugLineNum = 526;BA.debugLine="TypeOf = \"iconButtonTop\"";
...
public b4j.example.wixelement  _setdefaulttypeimage(String _r) throws Exception{
 //BA.debugLineNum = 513;BA.debugLine="Sub SetDefaultTypeImage(r As String) As WixElement";
 //BA.debugLineNum = 514;BA.debugLine="TypeOf = \"image\"";
_typeof = "image";
...
public b4j.example.wixelement  _setdefaulttypeimagebutton(String _r) throws Exception{
 //BA.debugLineNum = 507;BA.debugLine="Sub SetDefaultTypeImageButton(r As String) As WixE";
 //BA.debugLineNum = 508;BA.debugLine="TypeOf =  \"imageButton\"";
_typeof = "imageButton";
...
public b4j.example.wixelement  _setdefaultview(String _a) throws Exception{
 //BA.debugLineNum = 68;BA.debugLine="Sub SetDefaultView(a As String) As WixElement";
 //BA.debugLineNum = 69;BA.debugLine="elementsConfig.Put(\"view\", a)";
...
public b4j.example.wixelement  _setdefaultwidth(int _w) throws Exception{
 //BA.debugLineNum = 98;BA.debugLine="Sub SetDefaultWidth(w As Int) As WixElement";
 //BA.debugLineNum = 99;BA.debugLine="elementsConfig.Put(\"width\", w)";
...
public b4j.example.wixelement  _setgravity(int _g) throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub SetGravity(g As Int) As WixElement";
 //BA.debugLineNum = 201;BA.debugLine="Gravity = g";
_gravity = _g;
...
public b4j.example.wixelement  _setheader(String _h) throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub SetHeader(h As String) As WixElement";
 //BA.debugLineNum = 189;BA.debugLine="Header = h";
_header = _h;
...
public b4j.example.wixelement  _setheight(int _h) throws Exception{
 //BA.debugLineNum = 224;BA.debugLine="Sub SetHeight(h As Int) As WixElement";
 //BA.debugLineNum = 225;BA.debugLine="Height = h";
_height = _h;
...
public b4j.example.wixelement  _sethtmlattr(String _attrname,Object _attrvalue) throws Exception{
 //BA.debugLineNum = 248;BA.debugLine="Sub SetHTMLAttr(attrName As String, attrValue As O";
 //BA.debugLineNum = 249;BA.debugLine="HTMLAttributes.put(attrName,attrValue)";
...
public b4j.example.wixelement  _seticon(String _i) throws Exception{
 //BA.debugLineNum = 295;BA.debugLine="Sub SetIcon(i As String) As WixElement";
 //BA.debugLineNum = 296;BA.debugLine="SetOnContent(\"icon\", i)";
...
public b4j.example.wixelement  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 301;BA.debugLine="Sub SetLabel(l As String) As WixElement";
 //BA.debugLineNum = 302;BA.debugLine="SetOnContent(\"label\", l)";
...
public b4j.example.wixelement  _setmargin(String _margin) throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Sub SetMargin(margin As String) As WixElement";
 //BA.debugLineNum = 153;BA.debugLine="Element.Put(\"margin\", margin)";
...
public b4j.example.wixelement  _setmaxheight(int _h) throws Exception{
 //BA.debugLineNum = 146;BA.debugLine="Sub SetMaxHeight(h As Int) As WixElement";
 //BA.debugLineNum = 147;BA.debugLine="Element.Put(\"maxHeight\", h)";
...
public b4j.example.wixelement  _setmaxwidth(int _w) throws Exception{
 //BA.debugLineNum = 140;BA.debugLine="Sub SetMaxWidth(w As Int) As WixElement";
 //BA.debugLineNum = 141;BA.debugLine="Element.Put(\"maxWidth\", w)";
...
public b4j.example.wixelement  _setminheight(int _h) throws Exception{
 //BA.debugLineNum = 134;BA.debugLine="Sub SetMinHeight(h As Int) As WixElement";
 //BA.debugLineNum = 135;BA.debugLine="Element.Put(\"minHeight\", h)";
...
public b4j.example.wixelement  _setminwidth(int _w) throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub SetMinWidth(w As Int) As WixElement";
 //BA.debugLineNum = 129;BA.debugLine="Element.put(\"minwidth\",w)";
...
public b4j.example.wixelement  _setmultiview(boolean _b) throws Exception{
 //BA.debugLineNum = 289;BA.debugLine="Sub SetMultiView(b As Boolean) As WixElement";
 //BA.debugLineNum = 290;BA.debugLine="SetProperty(\"multiview\", b)";
...
public b4j.example.wixelement  _setoncondition(int _condition,String _prop,Object _propvalue) throws Exception{
 //BA.debugLineNum = 440;BA.debugLine="Sub SetOnCondition(Condition As Int, Prop As Strin";
 //BA.debugLineNum = 441;BA.debugLine="If Condition <= 0 Then Return Me";
if (_condition<=0) { 
if (true) return (b4j.example.wixelement)(this);};
 //BA.debugLineNum = 442;BA.debugLine="Element.put(Prop,PropValue)";
...
public b4j.example.wixelement  _setoncontent(String _prop,String _propvalue) throws Exception{
 //BA.debugLineNum = 433;BA.debugLine="Sub SetOnContent(Prop As String, PropValue As Stri";
 //BA.debugLineNum = 434;BA.debugLine="If PropValue = \"\" Then Return Me";
if ((_propvalue).equals("")) { 
if (true) return (b4j.example.wixelement)(this);};
 //BA.debugLineNum = 435;BA.debugLine="Element.put(Prop,PropValue)";
...
public b4j.example.wixelement  _setpadding(String _padding) throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Sub SetPadding(padding As String) As WixElement";
 //BA.debugLineNum = 159;BA.debugLine="Element.Put(\"padding\", padding)";
...
public b4j.example.wixelement  _setpaddingx(String _x) throws Exception{
 //BA.debugLineNum = 164;BA.debugLine="Sub SetPaddingX(x As String) As WixElement";
 //BA.debugLineNum = 165;BA.debugLine="Element.Put(\"paddingX\", x)";
...
public b4j.example.wixelement  _setpaddingy(String _y) throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub SetPaddingY(y As String) As WixElement";
 //BA.debugLineNum = 171;BA.debugLine="Element.Put(\"paddingY\",y)";
...
public b4j.example.wixelement  _setproperty(String _p,Object _v) throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Sub SetProperty(p As String, v As Object) As WixEl";
 //BA.debugLineNum = 177;BA.debugLine="Element.Put(p,v)";
...
public b4j.example.wixelement  _setstyle(String _prop,String _val) throws Exception{
 //BA.debugLineNum = 122;BA.debugLine="Sub SetStyle(prop As String, val As String) As Wix";
 //BA.debugLineNum = 123;BA.debugLine="Styles.Put(prop,val)";
...
public b4j.example.wixelement  _settemplate(String _t) throws Exception{
 //BA.debugLineNum = 321;BA.debugLine="Sub SetTemplate(t As String) As WixElement";
 //BA.debugLineNum = 322;BA.debugLine="Template = t";
_template = _t;
...
public b4j.example.wixelement  _settype(String _t) throws Exception{
 //BA.debugLineNum = 218;BA.debugLine="Sub SetType(t As String) As WixElement";
 //BA.debugLineNum = 219;BA.debugLine="TypeOf = t";
_typeof = _t;
...
public b4j.example.wixelement  _settypeclean() throws Exception{
 //BA.debugLineNum = 447;BA.debugLine="Sub SetTypeClean As WixElement";
 //BA.debugLineNum = 448;BA.debugLine="SetType(\"clean\")";
_settype("clean");
...
public b4j.example.wixelement  _settypeform() throws Exception{
 //BA.debugLineNum = 477;BA.debugLine="Sub SetTypeForm As WixElement";
 //BA.debugLineNum = 478;BA.debugLine="SetType(\"form\")";
_settype("form");
...
public b4j.example.wixelement  _settypehead() throws Exception{
 //BA.debugLineNum = 471;BA.debugLine="Sub SetTypeHead As WixElement";
 //BA.debugLineNum = 472;BA.debugLine="SetType(\"head\")";
_settype("head");
...
public b4j.example.wixelement  _settypeline() throws Exception{
 //BA.debugLineNum = 453;BA.debugLine="Sub SetTypeLine As WixElement";
 //BA.debugLineNum = 454;BA.debugLine="SetType(\"line\")";
_settype("line");
...
public b4j.example.wixelement  _settypespace() throws Exception{
 //BA.debugLineNum = 465;BA.debugLine="Sub SetTypeSpace As WixElement";
 //BA.debugLineNum = 466;BA.debugLine="SetType(\"space\")";
_settype("space");
...
public b4j.example.wixelement  _settypewide() throws Exception{
 //BA.debugLineNum = 459;BA.debugLine="Sub SetTypeWide As WixElement";
 //BA.debugLineNum = 460;BA.debugLine="SetType(\"wide\")";
_settype("wide");
...
public b4j.example.wixelement  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub SetValue(v As String) As WixElement";
 //BA.debugLineNum = 213;BA.debugLine="Value = v";
_value = (Object)(_v);
...
public b4j.example.wixelement  _setview(String _v) throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub SetView(v As String) As WixElement";
 //BA.debugLineNum = 207;BA.debugLine="View = v";
_view = _v;
...
public b4j.example.wixelement  _setviewheaderlayout() throws Exception{
 //BA.debugLineNum = 484;BA.debugLine="Sub SetViewHeaderLayout As WixElement";
 //BA.debugLineNum = 485;BA.debugLine="SetView(\"headerlayout\")";
...
public b4j.example.wixelement  _setvisiblebatch(int _b) throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub SetVisibleBatch(b As Int) As WixElement";
 //BA.debugLineNum = 105;BA.debugLine="SetProperty(\"visibleBatch\", b)";
...
public b4j.example.wixelement  _setwidth(int _w) throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub SetWidth(w As Int) As WixElement";
 //BA.debugLineNum = 231;BA.debugLine="Width = w";
_width = _w;
