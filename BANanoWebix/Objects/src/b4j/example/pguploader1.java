...
_r2._initialize /*b4j.example.wixrow*/ (ba,"R2");
 //BA.debugLineNum = 21;BA.debugLine="Dim dt As WixDataTable";
_dt = new b4j.example.wixdatatable();
 //BA.debugLineNum = 22;BA.debugLine="dt.Initialize(\"people\")";
_dt._initialize /*b4j.example.wixdatatable*/ (ba,"people");
 //BA.debugLineNum = 24;BA.debugLine="Dim sPhoto As String";
_sphoto = "";
 //BA.debugLineNum = 25;BA.debugLine="Dim img As UOENowHTML";
_img = new b4j.example.uoenowhtml();
 //BA.debugLineNum = 27;BA.debugLine="img.Initialize(\"img\", \"img\").SetStyle(\"cursor\", \"";
_img._initialize /*b4j.example.uoenowhtml*/ (ba,"img","img")._setstyle /*b4j.example.uoenowhtml*/ ("cursor","pointer")._setstyle /*b4j.example.uoenowhtml*/ ("width","80px")._setstyle /*b4j.example.uoenowhtml*/ ("height","80px")._setsrc /*b4j.example.uoenowhtml*/ ("./assets/#photo#",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 28;BA.debugLine="sPhoto = img.HTML";
...
_pg._onitemclick /*String*/ ("people",(com.ab.banano.BANanoObject)(_banano.CallBack(pguploader1.getObject(),"itemClick",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_row.getObject())}))));
 //BA.debugLineNum = 52;BA.debugLine="Dim upload As WixUploader";
_upload = new b4j.example.wixuploader();
 //BA.debugLineNum = 53;BA.debugLine="upload.Initialize(\"upload\").SetUpload(\"./assets/u";
_upload._initialize /*b4j.example.wixuploader*/ (ba,"upload")._setupload /*b4j.example.wixuploader*/ ("./assets/upload.php")._setname /*b4j.example.wixuploader*/ ("uploader")._setapionly /*b4j.example.wixuploader*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 54;BA.debugLine="upload.SetAccept(\"image/png, image/gif, image/jpe";
_upload._setaccept /*b4j.example.wixuploader*/ ("image/png, image/gif, image/jpeg");
...
String _rid = "";
String _col = "";
 //BA.debugLineNum = 59;BA.debugLine="Sub itemClick(row As Map)";
 //BA.debugLineNum = 60;BA.debugLine="Dim rid As String = row.Get(\"row\")";
_rid = BA.ObjectToString(_row.Get((Object)("row")));
 //BA.debugLineNum = 61;BA.debugLine="Dim col As String = row.Get(\"column\")";
_col = BA.ObjectToString(_row.Get((Object)("column")));
 //BA.debugLineNum = 62;BA.debugLine="rid = pg.CStr(rid)";
_rid = _pg._cstr /*String*/ ((Object)(_rid));
 //BA.debugLineNum = 63;BA.debugLine="col = pg.CStr(col)";
_col = _pg._cstr /*String*/ ((Object)(_col));
 //BA.debugLineNum = 65;BA.debugLine="Select Case col";
switch (BA.switchObjectToInt(_col,"photo")) {
case 0: {
 //BA.debugLineNum = 68;BA.debugLine="pg.FileDialog(\"upload\", CreateMap(\"rowid\": rid))";
