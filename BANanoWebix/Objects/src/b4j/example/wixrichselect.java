...
anywheresoftware.b4a.objects.collections.Map _sug = null;
 //BA.debugLineNum = 44;BA.debugLine="Sub AddOption(sID As String, sValue As String) As";
 //BA.debugLineNum = 45;BA.debugLine="Dim sug As Map = CreateMap()";
_sug = new anywheresoftware.b4a.objects.collections.Map();
_sug = __c.createMap(new Object[] {});
 //BA.debugLineNum = 46;BA.debugLine="sug.Put(\"id\", sID)";
_sug.Put((Object)("id"),(Object)(_sid));
 //BA.debugLineNum = 47;BA.debugLine="sug.Put(\"value\", sValue)";
_sug.Put((Object)("value"),(Object)(_svalue));
 //BA.debugLineNum = 48;BA.debugLine="Options.Add(sug)";
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 ...
 //BA.debugLineNum = 26;BA.debugLine="RS.SetOnContent(\"text\",Text)";
_rs._setoncontent /*b4j.example.wixelement*/ ("text",BA.ObjectToString(_text));
 //BA.debugLineNum = 27;BA.debugLine="RS.SetAttr(\"options\", Options)";
_rs._setattr /*b4j.example.wixelement*/ ("options",(Object)(_options.getObject()));
 //BA.debugLineNum = 28;BA.debugLine="Return RS.item";
...
public b4j.example.wixrichselect  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Sub SetLabel(l As String) As WixRichSelect";
 //BA.debugLineNum = 60;BA.debugLine="RS.Label.Text = l";
...
public b4j.example.wixrichselect  _setlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Sub SetLabelAlign(a As String) As WixRichSelect";
 //BA.debugLineNum = 67;BA.debugLine="RS.Label.Align = a";
...
public b4j.example.wixrichselect  _setlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 72;BA.debugLine="Sub SetLabelPosition(p As String) As WixRichSelect";
 //BA.debugLineNum = 73;BA.debugLine="RS.Label.Position = p";
...
public b4j.example.wixrichselect  _setlabelwidth(int _w) throws Exception{
 //BA.debugLineNum = 78;BA.debugLine="Sub SetLabelWidth(w As Int) As WixRichSelect";
 //BA.debugLineNum = 79;BA.debugLine="RS.Label.Width = w";
...
public b4j.example.wixrichselect  _setoptions(anywheresoftware.b4a.objects.collections.List _o) throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Sub SetOptions(o As List) As WixRichSelect";
...
public b4j.example.wixrichselect  _settext(String _t) throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Sub SetText(t As String) As WixRichSelect";
 //BA.debugLineNum = 33;BA.debugLine="Text = t";
_text = (Object)(_t);
...
public b4j.example.wixrichselect  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 53;BA.debugLine="Sub SetValue(v As String) As WixRichSelect";
 //BA.debugLineNum = 54;BA.debugLine="RS.Value = v";
