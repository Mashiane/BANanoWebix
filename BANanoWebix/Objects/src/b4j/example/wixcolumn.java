...
public String  _addtorow(b4j.example.wixrow _r) throws Exception{
 //BA.debugLineNum = 30;BA.debugLine="Sub AddToRow(r As WixRow)";
 //BA.debugLineNum = 31;BA.debugLine="r.Row.AddColumns(Item)";
...
public String  _initialize(anywheresoftware.b4a.BA _ba,String _rid) throws Exception{
innerInitialize(_ba);
 //BA.debugLineNum = 8;BA.debugLine="Public Sub Initialize(rID As String)";
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 //BA.debugLineNum = 14;BA.debugLine="Sub Item As Map";
 //BA.debugLineNum = 15;BA.debugLine="Return Column.item";
