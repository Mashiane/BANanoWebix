...
_e = new com.ab.banano.BANanoEvent();
 //BA.debugLineNum = 17;BA.debugLine="pg.Initialize(\"mylay\").SetView(\"layout\").SetType(";
_pg._initialize /*b4j.example.wixpage*/ (ba,"mylay")._setview /*b4j.example.wixpage*/ ("layout")._settype /*b4j.example.wixpage*/ ("wide");
 //BA.debugLineNum = 20;BA.debugLine="Dim R1 As WixElement";
_r1 = new b4j.example.wixelement();
 //BA.debugLineNum = 21;BA.debugLine="R1.Initialize(\"R1\").SetType(\"header\").SetTemplate";
_r1._initialize /*b4j.example.wixelement*/ (ba,"R1")._settype /*b4j.example.wixelement*/ ("header")._settemplate /*b4j.example.wixelement*/ ("R1: Hello")._addtorows /*String*/ (_pg._page /*b4j.example.wixelement*/ );
 //BA.debugLineNum = 23;BA.debugLine="Dim R2 As WixElement";
_r2 = new b4j.example.wixelement();
 //BA.debugLineNum = 24;BA.debugLine="R2.Initialize(\"R2\").SetTemplate(\"R2: Greetings, h";
_r2._initialize /*b4j.example.wixelement*/ (ba,"R2")._settemplate /*b4j.example.wixelement*/ ("R2: Greetings, human!")._addtorows /*String*/ (_pg._page /*b4j.example.wixelement*/ );
 //BA.debugLineNum = 26;BA.debugLine="Dim R3 As WixElement";
_r3 = new b4j.example.wixelement();
 //BA.debugLineNum = 27;BA.debugLine="R3.Initialize(\"R3\").SetGravity(2)";
...
_r4 = new b4j.example.wixelement();
 //BA.debugLineNum = 45;BA.debugLine="R4.Initialize(\"R4\").SetType(\"header\").SetTemplate";
_r4._initialize /*b4j.example.wixelement*/ (ba,"R4")._settype /*b4j.example.wixelement*/ ("header")._settemplate /*b4j.example.wixelement*/ ("R4: Goodbye")._addtorows /*String*/ (_pg._page /*b4j.example.wixelement*/ );
 //BA.debugLineNum = 47;BA.debugLine="Dim r5 As WixElement";
_r5 = new b4j.example.wixelement();
 //BA.debugLineNum = 48;BA.debugLine="r5.Initialize(\"R5\").SetHeight(50)";
...
public static String  _r5c2_click(com.ab.banano.BANanoEvent _e) throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub r5c2_click(e As BANanoEvent)";
 //BA.debugLineNum = 64;BA.debugLine="pg.ToastError(\"See?<br><br>Wasn't that fun?!\")";
