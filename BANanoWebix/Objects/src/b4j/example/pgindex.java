...
public static String  _clear_form() throws Exception{
 ...
 //BA.debugLineNum = 163;BA.debugLine="myForm.Clear";
...
String _recid = "";
 ...
 //BA.debugLineNum = 152;BA.debugLine="Dim recID As String = myList.GetSelectedID";
_recid = _mylist._getselectedid /*String*/ ();
 //BA.debugLineNum = 153;BA.debugLine="If recID = \"\" Then Return";
if ((_recid).equals("")) { 
if (true) return "";};
 //BA.debugLineNum = 155;BA.debugLine="myList.Remove(recID)";
_mylist._remove /*String*/ (_recid);
 //BA.debugLineNum = 157;BA.debugLine="myForm.Clear";
_myform._clear /*String*/ ();
...
_btnsave = new b4j.example.wixbutton();
 //BA.debugLineNum = 27;BA.debugLine="btnSave.Initialize(\"btnSave\").SetLabel(\"Save\").Is";
...
_btndelete = new b4j.example.wixbutton();
 //BA.debugLineNum = 30;BA.debugLine="btnDelete.Initialize(\"btnDelete\").IsDanger(\"\").Se";
...
_btnup._initialize /*b4j.example.wixicon*/ (ba,"btnUp")._seticon /*b4j.example.wixicon*/ ("wxi-angle-up")._addtotoolbar /*String*/ (_tblbar);
 //BA.debugLineNum = 58;BA.debugLine="tblBar.AddToRow(R1)";
...
_r2c1._initialize /*String*/ (ba,"R2C1");
 //BA.debugLineNum = 70;BA.debugLine="myForm.Initialize(pg, \"myform\").SetWidth(500)";
...
_recid = "";
 //BA.debugLineNum = 98;BA.debugLine="myList.Initialize(pg, \"myList\").SetTemplate(\"#tit";
...
_pg._ui /*String*/ ();
 //BA.debugLineNum = 106;BA.debugLine="myList.AttachAfterSelectEvent";
...
anywheresoftware.b4a.objects.collections.Map _record = null;
 ...
 //BA.debugLineNum = 128;BA.debugLine="Dim record As Map = myList.GetItem(id)";
_record = new anywheresoftware.b4a.objects.collections.Map();
_record = _mylist._getitem /*anywheresoftware.b4a.objects.collections.Map*/ (_id);
 //BA.debugLineNum = 130;BA.debugLine="myForm.SetValues(record)";
...
String _recid = "";
 ...
 //BA.debugLineNum = 137;BA.debugLine="Dim values As Map = myForm.GetValues";
...
if ((_recid).equals("")) { 
 //BA.debugLineNum = 142;BA.debugLine="myList.Add(values)";
_mylist._add /*String*/ (_values);
 }else {
 //BA.debugLineNum = 145;BA.debugLine="myList.Update(recID,values)";
