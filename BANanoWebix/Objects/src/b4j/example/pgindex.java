...
_hdr._header /*b4j.example.wixelement*/ ._settemplate /*b4j.example.wixelement*/ ((Object)("My First Webix App"));
...
_mylist._initialize /*b4j.example.wixlist*/ (ba,"myList")._settemplate /*b4j.example.wixlist*/ ("#title# - #year#")._setselect /*b4j.example.wixlist*/ (anywheresoftware.b4a.keywords.Common.True)._setheight /*b4j.example.wixlist*/ (BA.NumberToString(400))._setdata /*b4j.example.wixlist*/ (_filmset)._addtocolumn /*String*/ (_r2c2);
...
_pg._ui /*String*/ ();
 //BA.debugLineNum = 106;BA.debugLine="pg.OnAfterSelect(\"myList\", BANano.CallBack(Me,\"re";
_pg._onafterselect /*String*/ ("myList",(com.ab.banano.BANanoObject)(_banano.CallBack(pgindex.getObject(),"record_selected",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_recid)}))));
...
_pg._add /*String*/ ("myList",_values);
 ...
 //BA.debugLineNum = 145;BA.debugLine="pg.UpdateItem(\"myList\", recID, values)";
_pg._updateitem /*String*/ ("myList",_recid,_values);
 };
