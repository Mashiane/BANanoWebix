...
_c = new b4j.example.wixcarousel();
 //BA.debugLineNum = 12;BA.debugLine="c.Initialize(\"\").SetNavigationTypeSide(\"\")";
_c._initialize /*b4j.example.wixcarousel*/ (ba,"")._setnavigationtypeside /*b4j.example.wixcarousel*/ ("");
...
_tb._initialize /*b4j.example.wixtabview*/ (ba,"");
 //BA.debugLineNum = 54;BA.debugLine="tb.SetMultiViewAnimate(True)";
_tb._setmultiviewanimate /*b4j.example.wixtabview*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 55;BA.debugLine="tb.SetTabBarClose(True)";
_tb._settabbarclose /*b4j.example.wixtabview*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 56;BA.debugLine="tb.AddTab(\"\",\"Entry\",\"Some form controls here\",Cr";
_tb._addtab /*String*/ ("","Entry","Some form controls here",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("css"),(Object)("entry")}));
 //BA.debugLineNum = 57;BA.debugLine="tb.AddTab(\"\",\"Results\",\"Some results of data entr";
_tb._addtab /*String*/ ("","Results","Some results of data entry here",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("css"),(Object)("results")}));
 //BA.debugLineNum = 58;BA.debugLine="tb.AddTab(\"\", \"<span class='webix_icon fa-film'><";
_tb._addtab /*String*/ ("","<span class='webix_icon fa-film'></span>List","",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {}));
 //BA.debugLineNum = 59;BA.debugLine="pg.Page.AddRows(tb.Item)";
