...
public b4j.example.wixcolorpicker  _setlabel(String _l) throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Sub SetLabel(l As String) As WixColorPicker";
 //BA.debugLineNum = 33;BA.debugLine="ColorPicker.Label.Text = l";
...
public b4j.example.wixcolorpicker  _setlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub SetLabelAlign(a As String) As WixColorPicker";
 //BA.debugLineNum = 45;BA.debugLine="ColorPicker.Label.Align = a";
...
public b4j.example.wixcolorpicker  _setlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub SetLabelPosition(p As String) As WixColorPicke";
 //BA.debugLineNum = 51;BA.debugLine="ColorPicker.Label.Position = p";
...
public b4j.example.wixcolorpicker  _setlabelwidth(int _w) throws Exception{
 //BA.debugLineNum = 56;BA.debugLine="Sub SetLabelWidth(w As Int) As WixColorPicker";
 //BA.debugLineNum = 57;BA.debugLine="ColorPicker.Label.Width = w";
...
public b4j.example.wixcolorpicker  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 26;BA.debugLine="Sub SetValue(v As String) As WixColorPicker";
 //BA.debugLineNum = 27;BA.debugLine="ColorPicker.Value = v";
...
public b4j.example.wixcolorpicker  _setwidth(int _w) throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Sub SetWidth(w As Int) As WixColorPicker";
 //BA.debugLineNum = 39;BA.debugLine="ColorPicker.Width = w";
