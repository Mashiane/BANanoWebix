...
anywheresoftware.b4a.objects.collections.List _data = null;
 ...
 //BA.debugLineNum = 8;BA.debugLine="pg.Initialize(\"forms\").SetHeader(\"Lesson 18: Grou";
_pg._initialize /*b4j.example.wixpage*/ (ba,"forms")._setheader /*b4j.example.wixpage*/ ("Lesson 18: GroupList");
 //BA.debugLineNum = 10;BA.debugLine="Dim gl As WixGroupList";
_gl = new b4j.example.wixgrouplist();
 //BA.debugLineNum = 11;BA.debugLine="gl.Initialize(\"gl\").SetScroll(True).SetWidth(300)";
...
_data = _pg._unflatten /*anywheresoftware.b4a.objects.collections.List*/ (_gl._items /*anywheresoftware.b4a.objects.collections.List*/ ,"data");
 //BA.debugLineNum = 40;BA.debugLine="gl.SetData(data)";
_gl._setdata /*b4j.example.wixgrouplist*/ (_data);
 //BA.debugLineNum = 44;BA.debugLine="pg.Page.AddRows(gl.Item)";
