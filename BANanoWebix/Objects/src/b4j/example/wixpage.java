...
public String  _message(String _msg) throws Exception{
 //BA.debugLineNum = 285;BA.debugLine="Sub Message(msg As String)";
 //BA.debugLineNum = 286;BA.debugLine="webix.RunMethod(\"message\", Array(msg))";
...
String _svalue = "";
 ...
 //BA.debugLineNum = 276;BA.debugLine="webix.RunMethod(\"ui\",Page.item)";
