...
_c3._initialize1 /*b4j.example.wixdatacolumn*/ (_prop,"nutsornot")._setheader /*b4j.example.wixdatacolumn*/ ("Nuts?")._setwidth /*b4j.example.wixdatacolumn*/ ((int) (180))._setsort /*b4j.example.wixdatacolumn*/ ("string")._pop1 /*String*/ ();
 //BA.debugLineNum = 26;BA.debugLine="prop.AddItem(\"\", \"1\", \"Hershey\", CreateMap(), Tru";
_prop._additem /*b4j.example.wixtreetable*/ ("","1","Hershey",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {}),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 27;BA.debugLine="prop.AddItem(\"1\", \"1.1\", \"Almond Joy\", CreateMap(";
_prop._additem /*b4j.example.wixtreetable*/ ("1","1.1","Almond Joy",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("nutsOrNot"),(Object)("Has Nuts")}),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 28;BA.debugLine="prop.AddItem(\"1\", \"1.2\", \"Hershey's Kisses\", Crea";
_prop._additem /*b4j.example.wixtreetable*/ ("1","1.2","Hershey's Kisses",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("nutsOrNot"),(Object)("No Nuts")}),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 29;BA.debugLine="prop.AddItem(\"1.2\", \"1.2.1\", \"Milk Chocolate With";
_prop._additem /*b4j.example.wixtreetable*/ ("1.2","1.2.1","Milk Chocolate With Almonds",anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("nutsOrNot"),(Object)("Oh Yeah, Except These")}),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 31;BA.debugLine="Dim data As List = pg.Unflatten(prop.Items, \"data";
