...
public static b4j.example.wixpager _pgr = null;
...
_r2._addcolumnsspacer /*b4j.example.wixrow*/ ((int) (10));
 //BA.debugLineNum = 23;BA.debugLine="pgr.Initialize(\"moviepager\").SetAnimate(True).Set";
_pgr._initialize /*b4j.example.wixpager*/ (ba,"moviepager")._setanimate /*b4j.example.wixpager*/ (anywheresoftware.b4a.keywords.Common.True)._setsize /*b4j.example.wixpager*/ ((int) (10));
 //BA.debugLineNum = 24;BA.debugLine="R2.AddColumnsItem(pgr.Item)";
_r2._addcolumnsitem /*b4j.example.wixrow*/ (_pgr._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 26;BA.debugLine="R2.AddColumnsSpacer(\"\")";
_r2._addcolumnsspacer /*b4j.example.wixrow*/ ((int)(Double.parseDouble("")));
 //BA.debugLineNum = 28;BA.debugLine="pg.Page.AddRow(R2)";
_pg._page /*b4j.example.wixelement*/ ._addrow /*String*/ (_r2);
 //BA.debugLineNum = 30;BA.debugLine="Dim R3 As WixRow";
_r3 = new b4j.example.wixrow();
 //BA.debugLineNum = 31;BA.debugLine="R3.Initialize(\"R3\")";
_r3._initialize /*b4j.example.wixrow*/ (ba,"R3");
 //BA.debugLineNum = 33;BA.debugLine="R3.AddColumnsSpacer(10)";
_r3._addcolumnsspacer /*b4j.example.wixrow*/ ((int) (10));
 //BA.debugLineNum = 36;BA.debugLine="Dim dummy As UOENowData";
_dummy = new b4j.example.uoenowdata();
 //BA.debugLineNum = 37;BA.debugLine="dummy.Initialize";
_dummy._initialize /*b4j.example.uoenowdata*/ (ba);
 //BA.debugLineNum = 38;BA.debugLine="Dim structure As Map = CreateMap()";
...
_structure = anywheresoftware.b4a.keywords.Common.createMap(new Object[] {});
 //BA.debugLineNum = 39;BA.debugLine="structure.Put(\"id\", \"id\")";
_structure.Put((Object)("id"),(Object)("id"));
 //BA.debugLineNum = 40;BA.debugLine="structure.Put(\"rank\", \"id\")";
_structure.Put((Object)("rank"),(Object)("id"));
 //BA.debugLineNum = 41;BA.debugLine="structure.Put(\"title\", \"name\")";
_structure.Put((Object)("title"),(Object)("name"));
 //BA.debugLineNum = 42;BA.debugLine="structure.Put(\"year\", \"year\")";
_structure.Put((Object)("year"),(Object)("year"));
 //BA.debugLineNum = 43;BA.debugLine="Dim big_film_set As List = dummy.GetRecordsWithSt";
...
_big_film_set = _dummy._getrecordswithstructure /*anywheresoftware.b4a.objects.collections.List*/ (_structure,(int) (50));
 //BA.debugLineNum = 45;BA.debugLine="Dim fList As WixList";
_flist = new b4j.example.wixlist();
 //BA.debugLineNum = 46;BA.debugLine="fList.Initialize(\"fList\").SetWidth(500).SetHeight";
_flist._initialize /*b4j.example.wixlist*/ (ba,"fList")._setwidth /*b4j.example.wixlist*/ (BA.NumberToString(500))._setheight /*b4j.example.wixlist*/ (BA.NumberToString(360))._setborderless /*b4j.example.wixlist*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 47;BA.debugLine="fList.SetTemplate(\"#rank#. #title# (#year#)\").Set";
_flist._settemplate /*b4j.example.wixlist*/ ("#rank#. #title# (#year#)")._setselect /*b4j.example.wixlist*/ (anywheresoftware.b4a.keywords.Common.True)._setmultiselect /*b4j.example.wixlist*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 48;BA.debugLine="fList.SetScroll(False).SetPager(\"moviepager\").Set";
_flist._setscroll /*b4j.example.wixlist*/ (anywheresoftware.b4a.keywords.Common.False)._setpager /*b4j.example.wixlist*/ ("moviepager")._setdata /*b4j.example.wixlist*/ (_big_film_set);
 //BA.debugLineNum = 50;BA.debugLine="R3.AddColumnsItem(fList.item)";
_r3._addcolumnsitem /*b4j.example.wixrow*/ (_flist._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 52;BA.debugLine="pg.Page.AddRow(R3)";
_pg._page /*b4j.example.wixelement*/ ._addrow /*String*/ (_r3);
 //BA.debugLineNum = 54;BA.debugLine="pg.ui";
_pg._ui /*String*/ ();
 //BA.debugLineNum = 56;BA.debugLine="Dim recID As String";
_recid = "";
 //BA.debugLineNum = 57;BA.debugLine="pg.OnAfterSelect(\"fList\", BANano.CallBack(Me, \"mo";
...
anywheresoftware.b4a.objects.collections.Map _record = null;
 //BA.debugLineNum = 61;BA.debugLine="Sub movie_selected(recID As String)";
 //BA.debugLineNum = 63;BA.debugLine="Dim record As Map = pg.GetItem(\"fList\", recID)";
_record = new anywheresoftware.b4a.objects.collections.Map();
_record = _pg._getitem /*anywheresoftware.b4a.objects.collections.Map*/ ("fList",_recid);
 //BA.debugLineNum = 64;BA.debugLine="pg.Message(BANano.ToJson(record))";
...
_banano = new com.ab.banano.BANano();
 //BA.debugLineNum = 7;BA.debugLine="Private pgr As WixPager";
