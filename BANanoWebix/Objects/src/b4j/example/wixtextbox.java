...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 ...
 //BA.debugLineNum = 64;BA.debugLine="TextBox.SetOnContent(\"suggest\",Suggest)";
_textbox._setoncontent /*b4j.example.wixelement*/ ("suggest",_suggest);
 //BA.debugLineNum = 65;BA.debugLine="Return TextBox.Item";
...
public b4j.example.wixtextbox  _setalign(String _a) throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub SetAlign(a As String) As WixTextBox";
 //BA.debugLineNum = 100;BA.debugLine="TextBox.Align = a";
...
public b4j.example.wixtextbox  _setheight(int _h) throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Sub SetHeight(h As Int) As WixTextBox";
 //BA.debugLineNum = 94;BA.debugLine="TextBox.Height = h";
...
public b4j.example.wixtextbox  _setlabel(String _lbl) throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub SetLabel(lbl As String) As WixTextBox";
 //BA.debugLineNum = 82;BA.debugLine="TextBox.Label.Text = lbl";
...
public b4j.example.wixtextbox  _setlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Sub SetLabelAlign(a As String) As WixTextBox";
 //BA.debugLineNum = 106;BA.debugLine="TextBox.Label.Align = a";
...
public b4j.example.wixtextbox  _setlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 111;BA.debugLine="Sub SetLabelPosition(p As String) As WixTextBox";
 //BA.debugLineNum = 112;BA.debugLine="TextBox.Label.Position = p";
...
public b4j.example.wixtextbox  _setlabelwidth(int _w) throws Exception{
 //BA.debugLineNum = 117;BA.debugLine="Sub SetLabelWidth(w As Int) As WixTextBox";
 //BA.debugLineNum = 118;BA.debugLine="TextBox.Label.Width = w";
...
public b4j.example.wixtextbox  _setmaxlength(int _imaxlength) throws Exception{
 //BA.debugLineNum = 69;BA.debugLine="Sub SetMaxLength(imaxlength As Int) As WixTextBox";
 //BA.debugLineNum = 70;BA.debugLine="TextBox.SetHTMLAttr(\"maxlength\", imaxlength)";
...
public b4j.example.wixtextbox  _setplaceholder(String _ph) throws Exception{
 //BA.debugLineNum = 75;BA.debugLine="Sub SetPlaceHolder(ph As String) As WixTextBox";
 //BA.debugLineNum = 76;BA.debugLine="TextBox.PlaceHolder = ph";
...
public b4j.example.wixtextbox  _setsuggest(String _s) throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub SetSuggest(s As String) As WixTextBox";
 //BA.debugLineNum = 40;BA.debugLine="Suggest = s";
_suggest = _s;
...
public b4j.example.wixtextbox  _settype(String _t) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub SetType(t As String) As WixTextBox";
 //BA.debugLineNum = 58;BA.debugLine="TextBox.TypeOf = t";
...
public b4j.example.wixtextbox  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub SetValue(v As String) As WixTextBox";
 //BA.debugLineNum = 46;BA.debugLine="TextBox.Value = v";
...
public b4j.example.wixtextbox  _setview(String _v) throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub SetView(v As String) As WixTextBox";
 //BA.debugLineNum = 52;BA.debugLine="TextBox.view = v";
...
public b4j.example.wixtextbox  _setwidth(int _w) throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Sub SetWidth(w As Int) As WixTextBox";
 //BA.debugLineNum = 88;BA.debugLine="TextBox.Width = w";
