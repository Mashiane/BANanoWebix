...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 ...
 //BA.debugLineNum = 90;BA.debugLine="TextBox.SetOnContent(\"suggest\",Suggest)";
_textbox._setoncontent /*b4j.example.wixelement*/ ("suggest",_suggest);
 //BA.debugLineNum = 91;BA.debugLine="Return TextBox.Item";
...
public b4j.example.wixtextbox  _setalign(String _a) throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Sub SetAlign(a As String) As WixTextBox";
 //BA.debugLineNum = 126;BA.debugLine="TextBox.Align = a";
...
public b4j.example.wixtextbox  _setaligncenter(String _r) throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Sub SetAlignCenter(r As String) As WixTextBox 'ign";
 //BA.debugLineNum = 157;BA.debugLine="TextBox.setAligncenter(\"\")";
...
public b4j.example.wixtextbox  _setalignleft(String _r) throws Exception{
 //BA.debugLineNum = 162;BA.debugLine="Sub SetAlignLeft(r As String) As WixTextBox 'ignor";
 //BA.debugLineNum = 163;BA.debugLine="TextBox.SetAlignleft(\"\")";
...
public b4j.example.wixtextbox  _setalignright(String _r) throws Exception{
 //BA.debugLineNum = 150;BA.debugLine="Sub SetAlignRight(r As String) As WixTextBox 'igno";
 //BA.debugLineNum = 151;BA.debugLine="TextBox.setAlignright(\"\")";
...
public b4j.example.wixtextbox  _setdisabled(boolean _b) throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub SetDisabled(b As Boolean) As WixTextBox";
 //BA.debugLineNum = 55;BA.debugLine="TextBox.setattr(\"disabled\",b)";
...
public b4j.example.wixtextbox  _setheight(int _h) throws Exception{
 //BA.debugLineNum = 119;BA.debugLine="Sub SetHeight(h As Int) As WixTextBox";
 //BA.debugLineNum = 120;BA.debugLine="TextBox.Height = h";
...
public b4j.example.wixtextbox  _sethidden(boolean _b) throws Exception{
 //BA.debugLineNum = 28;BA.debugLine="Sub SetHidden(b As Boolean) As WixTextBox";
 //BA.debugLineNum = 29;BA.debugLine="TextBox.SetAttr(\"hidden\",b)";
...
public b4j.example.wixtextbox  _setlabel(String _lbl) throws Exception{
 //BA.debugLineNum = 107;BA.debugLine="Sub SetLabel(lbl As String) As WixTextBox";
 //BA.debugLineNum = 108;BA.debugLine="TextBox.Label.Text = lbl";
...
public b4j.example.wixtextbox  _setlabelalign(String _a) throws Exception{
 //BA.debugLineNum = 131;BA.debugLine="Sub SetLabelAlign(a As String) As WixTextBox";
 //BA.debugLineNum = 132;BA.debugLine="TextBox.Label.Align = a";
...
public b4j.example.wixtextbox  _setlabelposition(String _p) throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Sub SetLabelPosition(p As String) As WixTextBox";
 //BA.debugLineNum = 138;BA.debugLine="TextBox.Label.Position = p";
...
public b4j.example.wixtextbox  _setlabelwidth(int _w) throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub SetLabelWidth(w As Int) As WixTextBox";
 //BA.debugLineNum = 144;BA.debugLine="TextBox.Label.Width = w";
...
public b4j.example.wixtextbox  _setmaxlength(int _imaxlength) throws Exception{
 //BA.debugLineNum = 95;BA.debugLine="Sub SetMaxLength(imaxlength As Int) As WixTextBox";
 //BA.debugLineNum = 96;BA.debugLine="TextBox.SetHTMLAttr(\"maxlength\", imaxlength)";
...
public b4j.example.wixtextbox  _setplaceholder(String _ph) throws Exception{
 //BA.debugLineNum = 101;BA.debugLine="Sub SetPlaceHolder(ph As String) As WixTextBox";
 //BA.debugLineNum = 102;BA.debugLine="TextBox.PlaceHolder = ph";
...
public b4j.example.wixtextbox  _setreadonly(boolean _b) throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub SetReadOnly(b As Boolean) As WixTextBox";
 //BA.debugLineNum = 49;BA.debugLine="TextBox.SetAttr(\"readonly\",b)";
...
public b4j.example.wixtextbox  _setstyle(String _prop,String _val) throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Sub SetStyle(prop As String, val As String) As Wix";
 //BA.debugLineNum = 43;BA.debugLine="TextBox.SetStyle(prop,val)";
...
public b4j.example.wixtextbox  _setsuggest(String _s) throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Sub SetSuggest(s As String) As WixTextBox";
 //BA.debugLineNum = 66;BA.debugLine="Suggest = s";
_suggest = _s;
...
public b4j.example.wixtextbox  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 35;BA.debugLine="Sub SetTooltip(tt As String) As WixTextBox";
 //BA.debugLineNum = 36;BA.debugLine="TextBox.SetTooltip(tt)";
...
public b4j.example.wixtextbox  _settype(String _t) throws Exception{
 //BA.debugLineNum = 83;BA.debugLine="Sub SetType(t As String) As WixTextBox";
 //BA.debugLineNum = 84;BA.debugLine="TextBox.TypeOf = t";
...
public b4j.example.wixtextbox  _settypeemail(String _r) throws Exception{
 //BA.debugLineNum = 22;BA.debugLine="Sub SetTypeEmail(r As String) As WixTextBox  'igno";
 //BA.debugLineNum = 23;BA.debugLine="TextBox.SetType(\"email\")";
...
public b4j.example.wixtextbox  _settypepassword(String _r) throws Exception{
 //BA.debugLineNum = 16;BA.debugLine="Sub SetTypePassword(r As String) As WixTextBox  'i";
 //BA.debugLineNum = 17;BA.debugLine="TextBox.SetType(\"password\")";
...
public b4j.example.wixtextbox  _setvalue(String _v) throws Exception{
 //BA.debugLineNum = 71;BA.debugLine="Sub SetValue(v As String) As WixTextBox";
 //BA.debugLineNum = 72;BA.debugLine="TextBox.Value = v";
...
public b4j.example.wixtextbox  _setview(String _v) throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Sub SetView(v As String) As WixTextBox";
 //BA.debugLineNum = 78;BA.debugLine="TextBox.view = v";
...
public b4j.example.wixtextbox  _setwidth(int _w) throws Exception{
 //BA.debugLineNum = 113;BA.debugLine="Sub SetWidth(w As Int) As WixTextBox";
 //BA.debugLineNum = 114;BA.debugLine="TextBox.Width = w";
