...
public static String  _backtomain() throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub backtomain";
 //BA.debugLineNum = 100;BA.debugLine="pgIndex.Init";
_pgindex._init /*String*/ ();
 //BA.debugLineNum = 101;BA.debugLine="End Sub";
return "";
}
public static String  _cbo_change(String _newv,String _oldv) throws Exception{
 //BA.debugLineNum = 95;BA.debugLine="Sub cbo_change(newV As String, oldV As String)";
 //BA.debugLineNum = 96;BA.debugLine="pg.Message($\"Combo changed from ${oldV} to ${newV";
...
_hdr._header /*b4j.example.wixelement*/ ._settemplate /*b4j.example.wixelement*/ ("Webix Forms: 1");
...
_fruit.Add((Object)(anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("id"),(Object)(5),(Object)("value"),(Object)("Grapes")}).getObject()));
 //BA.debugLineNum = 32;BA.debugLine="myForm.Initialize(pg, \"mashform\").SetWidth(500)";
...
_cbo = new b4j.example.wixcombo();
 //BA.debugLineNum = 36;BA.debugLine="Dim n, o As String";
_n = "";
_o = "";
 //BA.debugLineNum = 37;BA.debugLine="cbo.Initialize(pg,\"cbo\").SetLabel(\"Combo\").SetVal";
_cbo._initialize /*b4j.example.wixcombo*/ (ba,_pg,"cbo")._setlabel /*b4j.example.wixcombo*/ ("Combo")._setvalue /*b4j.example.wixcombo*/ (BA.NumberToString(3))._setoptions /*b4j.example.wixcombo*/ (_fruit)._settemplate /*b4j.example.wixcombo*/ ("Fresh #value#")._setycount /*b4j.example.wixcombo*/ ((int) (2))._setlabelalign /*b4j.example.wixcombo*/ ("right");
 //BA.debugLineNum = 38;BA.debugLine="cbo.SetOnChange(BANano.CallBack(Me,\"cbo_change\",A";
...
_myform._form /*b4j.example.wixelement*/ ._additem /*b4j.example.wixelement*/ (_txtbox._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 44;BA.debugLine="Dim pwd As WixPassword";
_pwd = new b4j.example.wixpassword();
 //BA.debugLineNum = 45;BA.debugLine="pwd.Initialize(\"pwd\").SetLabel(\"Password\").SetPla";
...
_myform._form /*b4j.example.wixelement*/ ._additem /*b4j.example.wixelement*/ (_cb1._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 62;BA.debugLine="Dim tgl As WixToggle";
_tgl = new b4j.example.wixtoggle();
 //BA.debugLineNum = 63;BA.debugLine="tgl.Initialize(\"tgl\").SetLabel(\"Toggle\").SetOnLab";
_tgl._initialize /*b4j.example.wixtoggle*/ (ba,"tgl")._setlabel /*b4j.example.wixtoggle*/ ("Toggle")._setonlabel /*b4j.example.wixtoggle*/ ("I'm pressed!")._setofflabel /*b4j.example.wixtoggle*/ ("Press Me!");
 //BA.debugLineNum = 64;BA.debugLine="myForm.Form.AddItem(tgl.Item)";
...
_pg._ui /*String*/ ();
 //BA.debugLineNum = 92;BA.debugLine="cbo.AttachOnChangeEvent";
