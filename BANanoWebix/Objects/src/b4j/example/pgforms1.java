...
public static String  _backtomain() throws Exception{
 //BA.debugLineNum = 106;BA.debugLine="Sub backtomain";
 //BA.debugLineNum = 107;BA.debugLine="pgIndex.Init";
_pgindex._init /*String*/ ();
 //BA.debugLineNum = 108;BA.debugLine="End Sub";
return "";
}
public static String  _hideit() throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Sub hideit()";
 //BA.debugLineNum = 103;BA.debugLine="pg.HideIt(\"sect\")";
...
_hdr._header /*b4j.example.wixelement*/ ._settemplate /*b4j.example.wixelement*/ ((Object)("Webix Form 2"));
...
_suggest._ui /*String*/ ();
 //BA.debugLineNum = 60;BA.debugLine="myForm.Initialize(\"mashform1\").SetWidth(500)";
_myform._initialize /*b4j.example.wixform*/ (ba,"mashform1")._setwidth /*b4j.example.wixform*/ ((int) (500));
...
_sect = new b4j.example.wixsection();
 //BA.debugLineNum = 67;BA.debugLine="sect.Initialize(\"sect\")";
_sect._initialize /*b4j.example.wixsection*/ (ba,"sect");
 //BA.debugLineNum = 68;BA.debugLine="sect.Section.SetTemplate(\"This is my section\")";
_sect._section /*b4j.example.wixelement*/ ._settemplate /*b4j.example.wixelement*/ ((Object)("This is my section"));
 //BA.debugLineNum = 69;BA.debugLine="myForm.AddItem(sect.Item)";
_myform._additem /*String*/ (_sect._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 71;BA.debugLine="Dim lbl As WixLabel";
_lbl = new b4j.example.wixlabel();
 //BA.debugLineNum = 72;BA.debugLine="lbl.Initialize(\"lbl\").SetLabel(\"This is my label\"";
_lbl._initialize /*b4j.example.wixlabel*/ (ba,"lbl")._setlabel /*b4j.example.wixlabel*/ ("This is my label");
 //BA.debugLineNum = 73;BA.debugLine="myForm.AddItem(lbl.Item)";
_myform._additem /*String*/ (_lbl._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 75;BA.debugLine="Dim seg As WixSegmented";
_seg = new b4j.example.wixsegmented();
 //BA.debugLineNum = 76;BA.debugLine="seg.Initialize(\"seq\").SetOptions(fruit)";
_seg._initialize /*b4j.example.wixsegmented*/ (ba,"seq")._setoptions /*b4j.example.wixsegmented*/ (_fruit);
 //BA.debugLineNum = 77;BA.debugLine="myForm.AddItem(seg.Item)";
_myform._additem /*String*/ (_seg._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 79;BA.debugLine="Dim dt As WixDateTimePicker";
_dt = new b4j.example.wixdatetimepicker();
 //BA.debugLineNum = 80;BA.debugLine="dt.Initialize(\"dt\").SetLabel(\"Date Picker\").SetTi";
_dt._initialize /*b4j.example.wixdatetimepicker*/ (ba,"dt")._setlabel /*b4j.example.wixdatetimepicker*/ ("Date Picker")._settimepicker /*b4j.example.wixdatetimepicker*/ (anywheresoftware.b4a.keywords.Common.True)._setformat /*b4j.example.wixdatetimepicker*/ ("%d %M %Y at %H:%i")._setlabelwidth /*b4j.example.wixdatetimepicker*/ ((int) (100));
 //BA.debugLineNum = 81;BA.debugLine="myForm.AddItem(dt.Item)";
_myform._additem /*String*/ (_dt._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 83;BA.debugLine="Dim cp As WixColorPicker";
_cp = new b4j.example.wixcolorpicker();
 //BA.debugLineNum = 84;BA.debugLine="cp.Initialize(\"cp\").SetLabel(\"Color Picker\").SetV";
_cp._initialize /*b4j.example.wixcolorpicker*/ (ba,"cp")._setlabel /*b4j.example.wixcolorpicker*/ ("Color Picker")._setvalue /*b4j.example.wixcolorpicker*/ ("#0000ff")._setlabelwidth /*b4j.example.wixcolorpicker*/ ((int) (100));
 //BA.debugLineNum = 85;BA.debugLine="myForm.AddItem(cp.Item)";
_myform._additem /*String*/ (_cp._item /*anywheresoftware.b4a.objects.collections.Map*/ ());
 //BA.debugLineNum = 87;BA.debugLine="Dim txtcountries As WixTextBox";
_txtcountries = new b4j.example.wixtextbox();
 //BA.debugLineNum = 88;BA.debugLine="txtcountries.Initialize(\"txtCountries\").SetSugges";
...
public static String  _showit() throws Exception{
 //BA.debugLineNum = 98;BA.debugLine="Sub showit()";
 //BA.debugLineNum = 99;BA.debugLine="pg.ShowIt(\"sect\")";
