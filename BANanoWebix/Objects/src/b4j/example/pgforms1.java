...
_btnimage._initialize /*b4j.example.wixbutton*/ (ba,"btnImage")._setlabel /*b4j.example.wixbutton*/ ("Image")._settypeimage /*b4j.example.wixbutton*/ ("")._setwidth /*b4j.example.wixbutton*/ ((int) (150))._setheight /*b4j.example.wixbutton*/ ((int) (40))._setimage /*b4j.example.wixbutton*/ ("./assets/icons8-save-as-100.png");
 //BA.debugLineNum = 29;BA.debugLine="tblBar.AddButton(btnImage)";
_tblbar._addbutton /*b4j.example.wixtoolbar*/ (_btnimage);
...
_btnimage1._initialize /*b4j.example.wixbutton*/ (ba,"btnImageButton")._setlabel /*b4j.example.wixbutton*/ ("ImageButton")._settypeimagebutton /*b4j.example.wixbutton*/ ("")._setimage /*b4j.example.wixbutton*/ ("./assets/icons8-compose-40.png")._setwidth /*b4j.example.wixbutton*/ ((int) (40))._setheight /*b4j.example.wixbutton*/ ((int) (40));
 //BA.debugLineNum = 33;BA.debugLine="tblBar.AddButton(btnImage1)";
_tblbar._addbutton /*b4j.example.wixtoolbar*/ (_btnimage1);
 //BA.debugLineNum = 35;BA.debugLine="Dim btnIcon As WixButton";
_btnicon = new b4j.example.wixbutton();
 //BA.debugLineNum = 36;BA.debugLine="btnIcon.Initialize(\"btnIcon\").SetTypeIcon(\"\").Set";
_btnicon._initialize /*b4j.example.wixbutton*/ (ba,"btnIcon")._settypeicon /*b4j.example.wixbutton*/ ("")._seticon /*b4j.example.wixbutton*/ ("wxi-file")._setwidth /*b4j.example.wixbutton*/ ((int) (200))._setlabel /*b4j.example.wixbutton*/ ("File Name");
 //BA.debugLineNum = 37;BA.debugLine="tblBar.AddButton(btnIcon)";
_tblbar._addbutton /*b4j.example.wixtoolbar*/ (_btnicon);
...
_imgt1 = new b4j.example.wixtoggle();
 //BA.debugLineNum = 50;BA.debugLine="imgt1.Initialize(\"imgt1\").SetTypeImageButton(\"\").";
_imgt1._initialize /*b4j.example.wixtoggle*/ (ba,"imgt1")._settypeimagebutton /*b4j.example.wixtoggle*/ ("")._setimage /*b4j.example.wixtoggle*/ ("./assets/icons8-add-row-40.png")._setlabel /*b4j.example.wixtoggle*/ ("Add Row")._setwidth /*b4j.example.wixtoggle*/ ((int) (150));
 //BA.debugLineNum = 51;BA.debugLine="tblBar.AddToggle(imgt1)";
_tblbar._addtoggle /*b4j.example.wixtoolbar*/ (_imgt1);
 //BA.debugLineNum = 53;BA.debugLine="Dim imgt2 As WixToggle";
_imgt2 = new b4j.example.wixtoggle();
 //BA.debugLineNum = 54;BA.debugLine="imgt2.Initialize(\"imgt2\").SetTypeImage(\"\").SetIma";
_imgt2._initialize /*b4j.example.wixtoggle*/ (ba,"imgt2")._settypeimage /*b4j.example.wixtoggle*/ ("")._setimage /*b4j.example.wixtoggle*/ ("./assets/icons8-save-close-40.png")._setlabel /*b4j.example.wixtoggle*/ ("Save")._setheight /*b4j.example.wixtoggle*/ ((int) (50))._setwidth /*b4j.example.wixtoggle*/ ((int) (150))._addtotoolbar /*String*/ (_tblbar);
 //BA.debugLineNum = 56;BA.debugLine="Dim imgt3 As WixToggle";
_imgt3 = new b4j.example.wixtoggle();
 //BA.debugLineNum = 57;BA.debugLine="imgt3.Initialize(\"imgt3\").SetTypeIcon(\"\").SetOffI";
_imgt3._initialize /*b4j.example.wixtoggle*/ (ba,"imgt3")._settypeicon /*b4j.example.wixtoggle*/ ("")._setofficon /*b4j.example.wixtoggle*/ ("wxi-close")._setonicon /*b4j.example.wixtoggle*/ ("wxi-check")._setlabel /*b4j.example.wixtoggle*/ ("Music")._setheight /*b4j.example.wixtoggle*/ ((int) (60))._setwidth /*b4j.example.wixtoggle*/ ((int) (150))._addtotoolbar /*String*/ (_tblbar);
 //BA.debugLineNum = 59;BA.debugLine="Dim imgt4 As WixToggle";
_imgt4 = new b4j.example.wixtoggle();
 //BA.debugLineNum = 60;BA.debugLine="imgt4.Initialize(\"imgt4\").SetTypeIconButtonTop(\"\"";
_imgt4._initialize /*b4j.example.wixtoggle*/ (ba,"imgt4")._settypeiconbuttontop /*b4j.example.wixtoggle*/ ("")._seticon /*b4j.example.wixtoggle*/ ("wxi-sync")._setlabel /*b4j.example.wixtoggle*/ ("Wi-Fi")._setheight /*b4j.example.wixtoggle*/ ((int) (60))._setwidth /*b4j.example.wixtoggle*/ ((int) (100))._addtotoolbar /*String*/ (_tblbar);
