...
String _astr = "";
String _vstr = "";
 //BA.debugLineNum = 45;BA.debugLine="Sub AddTab(iid As String, header As String, templa";
 //BA.debugLineNum = 46;BA.debugLine="Dim i As WixElement";
_i = new b4j.example.wixelement();
 //BA.debugLineNum = 47;BA.debugLine="i.Initialize(iid)";
_i._initialize /*b4j.example.wixelement*/ (ba,_iid);
 //BA.debugLineNum = 48;BA.debugLine="i.SetHeader(header)";
_i._setheader /*b4j.example.wixelement*/ (_header);
 //BA.debugLineNum = 49;BA.debugLine="i.SetTemplate(template)";
_i._settemplate /*b4j.example.wixelement*/ ((Object)(_template));
 //BA.debugLineNum = 50;BA.debugLine="If attributes <> Null Then";
if (_attributes!= null) { 
 //BA.debugLineNum = 51;BA.debugLine="For Each astr As String In attributes.Keys";
{
...
_astr = BA.ObjectToString(group6.Get(index6));
 //BA.debugLineNum = 52;BA.debugLine="Dim vstr As String = attributes.Get(astr)";
_vstr = BA.ObjectToString(_attributes.Get((Object)(_astr)));
 //BA.debugLineNum = 53;BA.debugLine="i.SetProperty(astr,vstr)";
_i._setproperty /*b4j.example.wixelement*/ (_astr,(Object)(_vstr));
 }
};
 };
 //BA.debugLineNum = 56;BA.debugLine="TabView.AddCells(i.Item)";
...
public anywheresoftware.b4a.objects.collections.Map  _item() throws Exception{
 ...
 //BA.debugLineNum = 39;BA.debugLine="TabView.SetAttr(\"tabbar\", tb.Item)";
_tabview._setattr /*b4j.example.wixelement*/ ("tabbar",(Object)(_tb._item /*anywheresoftware.b4a.objects.collections.Map*/ ().getObject()));
 //BA.debugLineNum = 40;BA.debugLine="TabView.SetAttr(\"multiview\", mv.Item)";
_tabview._setattr /*b4j.example.wixelement*/ ("multiview",(Object)(_mv._item /*anywheresoftware.b4a.objects.collections.Map*/ ().getObject()));
 //BA.debugLineNum = 41;BA.debugLine="Return TabView.item";
if (true) return _tabview._item /*anywheresoftware.b4a.objects.collections.Map*/ ();
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return null;
}
public b4j.example.wixtabview  _setmultiviewanimate(boolean _b) throws Exception{
 //BA.debugLineNum = 20;BA.debugLine="Sub SetMultiViewAnimate(b As Boolean) As WixTabVie";
 //BA.debugLineNum = 21;BA.debugLine="mv.SetAnimate(b)";
...
public b4j.example.wixtabview  _settabbarclose(boolean _b) throws Exception{
 //BA.debugLineNum = 26;BA.debugLine="Sub SetTabBarClose(b As Boolean) As WixTabView";
 //BA.debugLineNum = 27;BA.debugLine="tb.SetAttr(\"close\", b)";
...
public b4j.example.wixtabview  _settooltip(String _tt) throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Sub SetTooltip(tt As String) As WixTabView";
 //BA.debugLineNum = 33;BA.debugLine="TabView.SetTooltip(tt)";
